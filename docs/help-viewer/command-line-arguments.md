...
|/productName|Não|Especifica o nome do produto para os livros que serão removidos. O nome do produto é identificado nos arquivos *arquivo HelpContentSetup. msha* ou *books.html* fornecidos com o conteúdo. Você pode remover os livros de apenas um produto de cada vez. Para remover livros de vários produtos, você deve executar várias instalações.|
