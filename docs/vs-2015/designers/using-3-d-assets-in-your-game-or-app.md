...
|---------------|-----------------------|------------------------|
|**Pipeline de conteúdo da imagem**|Formato PNG (.png)<br /><br /> JPEG (.jpg, .jpeg, .jpe, .jfif)<br /><br /> Direct Draw Surface (.dds)<br /><br /> Formato GIF (.gif)<br /><br /> Bitmap (.bmp, .dib)<br /><br /> Tagged Image File Format (.tif, .tiff)<br /><br /> Targa (.tga)|DirectDraw Surface (.dds)|
...
### <a name="using-shaders"></a>Usando sombreadores
 O Direct3D fornece funções para criar recursos do sombreador e associá-los ao pipeline gráfico programável. Para obter mais informações sobre como criar um recurso de sombreador no Direct3D e associá-lo ao pipeline, consulte [Guia de programação para HLSL](https://msdn.microsoft.com/library/windows/desktop/bb509635(v=vs.85).aspx).
