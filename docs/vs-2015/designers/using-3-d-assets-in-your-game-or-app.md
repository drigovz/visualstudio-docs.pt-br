...
## <a name="configuring-your-project"></a>Configurar seu projeto
...
### <a name="using-shaders"></a>Usando sombreadores
 O Direct3D fornece funções para criar recursos do sombreador e associá-los ao pipeline gráfico programável. Para obter mais informações sobre como criar um recurso de sombreador no Direct3D e associá-lo ao pipeline, consulte o [Guia de programação para HLSL](https://msdn.microsoft.com/library/windows/desktop/bb509635(v=vs.85).aspx).
...
|[Como exportar uma textura que tenha a multiplicação de alfa](../designers/how-to-export-a-texture-that-has-premultiplied-alpha.md)|Descreve como usar o Pipeline de Conteúdo da Imagem para exportar uma textura contendo valores alfa pré-multiplicados.|
