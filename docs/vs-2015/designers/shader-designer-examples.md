...
|[Como: criar um sombreador de gradiente baseado em geometria](../designers/how-to-create-a-geometry-based-gradient-shader.md)|Demonstra um sombreador que modula uma cor com base na geometria de um objeto e aplica-a ao objeto.|
