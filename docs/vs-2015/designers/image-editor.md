...
##### <a name="resizing-selections"></a>Redimensionando seleções
 ...
 CTRL copia o conteúdo da região selecionada antes de ser redimensionado. Isso deixa a imagem original intacta enquanto a cópia é redimensionada.

 Shift redimensiona a região selecionada em proporção ao seu tamanho original.

 Alt altera o tamanho da região de seleção. Isso deixa a imagem sem modificações.
