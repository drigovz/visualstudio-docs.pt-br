...
## <a name="see-also"></a>Consulte Também
 <xref:System.Xml.Linq.XElement.Value%2A?displayProperty=fullName>[XML](../designers/xml-xelement-dynamic-property.md) de [propriedades dinâmicas de classe XElement](../designers/xelement-class-dynamic-properties.md)
