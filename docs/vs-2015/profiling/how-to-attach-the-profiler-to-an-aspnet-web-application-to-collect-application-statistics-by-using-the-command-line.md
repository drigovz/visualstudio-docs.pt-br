...
## <a name="ending-the-profiling-session"></a>Encerrando a sessão de criação de perfil  
 Para encerrar uma sessão de criação de perfil, feche o [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] aplicativo Web e use o comando serviços de informações da Internet (IIS) **iisreset** para fechar o [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] processo de trabalho. Chame a opção **VSPerfCmd** [/shutdown](../profiling/shutdown.md) para desligar o criador de perfil e fechar o arquivo de dados de criação de perfil.  
