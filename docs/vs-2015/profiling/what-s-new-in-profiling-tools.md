...
## <a name="diagnostics-without-debugging-ui-and-hotkey-changes"></a>Diagnóstico sem interface de depuração e alteração de atalhos  
 Para executar o diagnóstico sem depuração, acesse **depurar/iniciar ferramentas de diagnóstico sem depuração** ou **depurar/Profiler/desempenho Profiler...**. Em Visual Studio 2013, isso foi encontrado em **analisar/desempenho e diagnóstico** , **depuração/desempenho e diagnóstico**.  
