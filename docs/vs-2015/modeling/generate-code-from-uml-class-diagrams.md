...
## <a name="varying-the-generated-code"></a>Variando o código gerado
 ...
 Para definir essas propriedades adicionais, selecione a classe ou outro elemento no diagrama. No janela Propriedades, expanda **estereótipos**e, em seguida, C# expanda o estereótipo, como  **C# classe**.  Para classes, entre essas propriedades adicionais estão:
...
## <a name="writing"></a>Escrevendo um modelo de texto
