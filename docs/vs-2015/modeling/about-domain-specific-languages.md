---
title: Sobre linguagens específicas de domínio | Microsoft Docs
ms.date: 11/15/2016
...
- Redes de esteiras de transmissão e equipamento de manuseio de bagagem para um aeroporto.
  ...
  Os usuários de sua DSL criam *modelos.* Os modelos são *instâncias* da DSL. Por exemplo, eles descrevem um determinado site ou a fiação de um dispositivo específico ou o sistema de manuseio de bagagem em um aeroporto específico.
...
## <a name="what-you-can-do-with-dsls"></a>O que você pode fazer com DSLs
 ...
 [!INCLUDE[dsl](../includes/dsl-md.md)] permite que você crie uma linguagem específica de domínio que tenha seu próprio designer gráfico e sua própria notação de diagrama e, em seguida, use a linguagem para gerar o código-fonte apropriado para cada projeto.
...
## <a name="aspects-of-graphical-domain-specific-development"></a>Aspectos do desenvolvimento gráfico específico de domínio
...
## <a name="benefits-of-domain-specific-development"></a>Benefícios do desenvolvimento específico de domínio
