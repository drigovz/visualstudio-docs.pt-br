...
Diagramas de modelagem ajudarão-lo a entender, esclarecer e comunicar ideias sobre seu código e os requisitos de usuário que deve oferecer suporte a seu sistema de software. Por exemplo, para descrever e comunicar requisitos do usuário, você pode usar o caso de uso (UML Unified Modeling Language), atividade, classe e diagramas de sequência. Para descrever e comunicar a funcionalidade de seu sistema, você pode usar o componente, classe, atividade e diagramas de sequência UML.  
 ...
 Consulte [vídeo do Channel 9: Melhorar a arquitetura com modelagem](http://go.microsoft.com/fwlink/?LinkID=252078).  
  
 Você pode criar os seguintes diagramas UML nesta versão:  
  
|**Diagrama**|**Shows**|  
|-----------------|---------------|  
|[Diagramas de atividade de UML: referência](../modeling/uml-activity-diagrams-reference.md)|Fluxo de trabalho entre ações e participantes em um processo comercial|  
...
|[Diagramas de sequência de UML: referência](../modeling/uml-sequence-diagrams-reference.md)|Sequências de interações entre objetos, componentes, sistemas ou atores|  
|[Diagrama de casos de uso UML: referência](../modeling/uml-use-case-diagrams-reference.md)|Metas de usuário e tarefas que dá suporte a um sistema|  
