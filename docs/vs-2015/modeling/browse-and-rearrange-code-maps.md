...
|------------|-----------------------------|
|Organize o fluxo de dependência para todo o mapa em uma direção específica. Isso pode ajudá-lo a ver camadas arquitetônicas no código.|Na barra de ferramentas do mapa, escolha **layout**e, em seguida:<br /><br /> -   De **cima para baixo** ![no botão de gráfico inferior](../modeling/media/topbottomgraphbutton.gif "TopBottomGraphButton")<br />-   Botão de **baixo para cima** ![inferior para o gráfico superior](../modeling/media/bottomtopgraphbutton.gif "BottomTopGraphButton")<br />-   Da **esquerda para a direita** da ![esquerda para a direita botão de layout](../modeling/media/leftrightgraphbutton.gif "LeftRightGraphButton")<br />-   Botão da **direita para a esquerda** ![direita para a esquerda do gráfico](../modeling/media/rightleftgraphbutton.gif "RightLeftGraphButton")|
