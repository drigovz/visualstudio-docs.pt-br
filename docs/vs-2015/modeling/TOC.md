# [Análise e modelagem de arquitetura](analyze-and-model-your-architecture.md)
...
### [Diagramas de atividade de UML: referência](uml-activity-diagrams-reference.md)
#### [Propriedades de elementos em diagramas de atividade UML](properties-of-elements-on-uml-activity-diagrams.md)
### [Diagramas de atividade de UML: diretrizes](uml-activity-diagrams-guidelines.md)
...
### [Diagramas de sequência de UML: referência](uml-sequence-diagrams-reference.md)
...
### [Diagramas de sequência de UML: diretrizes](uml-sequence-diagrams-guidelines.md)
### [Diagrama de casos de uso UML: referência](uml-use-case-diagrams-reference.md)
...
### [Diagrama de casos de uso UML: diretrizes](uml-use-case-diagrams-guidelines.md)
...
#### [Responder a alterações em um modelo UML](../misc/how-to-respond-to-changes-in-a-uml-model.md)
...
#### [Como: Abrir um modelo de um arquivo no código do programa](how-to-open-a-model-from-file-in-program-code.md)
...
#### [Como: Adicionar um manipulador do tipo "arrastar e soltar"](how-to-add-a-drag-and-drop-handler.md)
...
#### [Passo a passo: Depurar um modelo de texto que acessa um modelo](walkthrough-debugging-a-text-template-that-accesses-a-model.md)
#### [Passo a passo: Conectar um host a um processador de diretriz gerado](walkthrough-connecting-a-host-to-a-generated-directive-processor.md)
...
#### [Passo a passo: Gerar código usando modelos de texto](walkthrough-generating-code-by-using-text-templates.md)
...
##### [Passo a passo: Criar um processador de diretriz personalizado](walkthrough-creating-a-custom-directive-processor.md)
...
##### [Passo a passo: Criar um host de modelo de texto personalizado](walkthrough-creating-a-custom-text-template-host.md)
