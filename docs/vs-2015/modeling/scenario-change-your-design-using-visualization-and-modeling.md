...
## <a name="understanding-and-communicating-information-about-the-system"></a><a name="UnderstandingCommunicating"></a> Compreendendo e comunicando informações sobre o sistema
...
### <a name="understanding-the-role-of-the-system-in-the-business-process"></a><a name="UnderstandingBPMandSystemDesign"></a> Compreendendo a função do sistema no processo de negócios
...
### <a name="describing-new-or-updated-user-requirements"></a><a name="DescribingURM"></a> Descrevendo os requisitos de usuário novos ou atualizados
...
### <a name="creating-tests-from-models"></a><a name="CreatingTests"></a> Criando testes de modelos
...
### <a name="identifying-changes-to-the-existing-system"></a><a name="DeterminingChanges"></a> Identificando alterações no sistema existente
...
### <a name="keeping-code-consistent-with-the-design"></a><a name="ValidatingCode"></a> Mantendo o código consistente com o design
...
### <a name="planning-and-tracking-work"></a><a name="PlanningTracking"></a> Planejamento e acompanhamento de trabalho
...
### <a name="testing-validating-and-checking-in-code"></a><a name="TestValidateCheckInCode"></a> Testando, validando e verificando o código
...
## <a name="updating-the-system-using-visualization-and-modeling"></a><a name="UpdatingSystem"></a> Atualizando o sistema usando visualização e modelagem
...
### <a name="understand-the-user-requirements-use-case-diagrams"></a><a name="UnderstandUseCases"></a> Entender os requisitos do usuário: diagramas de caso de uso
...
### <a name="understand-the-business-process-activity-diagrams"></a><a name="UnderstandActivities"></a> Entenda o processo comercial: diagramas de atividade
...
### <a name="describe-the-system-structure-component-diagrams"></a><a name="DescribeComponents"></a> Descrever a estrutura do sistema: diagramas de componentes
...
### <a name="describe-the-interactions-sequence-diagrams"></a><a name="DescribeSequence"></a> Descrever as interações: diagramas de sequência
...
### <a name="describe-the-logical-architecture-layer-diagrams"></a><a name="DescribeLayers"></a> Descrever a arquitetura lógica: diagramas de camada
