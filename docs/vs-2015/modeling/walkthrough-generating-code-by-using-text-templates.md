---
title: 'Walkthrough: gerando código usando modelos de texto | Microsoft Docs'
ms.date: 11/15/2016
...
```
 ...
 Na versão com rigidez de tipos, uma alteração no esquema XML resultará em alterações nas classes. O compilador irá destacar as partes do código do aplicativo que devem ser alteradas. Na versão não tipada que usa o código XML genérico, não há esse suporte.
...
### <a name="add-a-text-template-file"></a>Adicionar um arquivo de modelo de texto
 Adicione um arquivo de modelo de texto e defina a extensão de saída como ". cs".
