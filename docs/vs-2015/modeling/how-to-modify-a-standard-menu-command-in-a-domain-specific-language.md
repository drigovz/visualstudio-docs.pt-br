---
title: Como modificar um comando de menu padrão em uma linguagem específica de domínio | Microsoft Docs
ms.date: 11/15/2016
...
3. [Substitua os métodos ProcessOnStatus e ProcessOnMenu](#override) do comando.
