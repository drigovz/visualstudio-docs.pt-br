...
- Itens e guias da caixa de ferramentas
  ...
  Para obter um exemplo de código e mais informações sobre esse recurso, consulte o site Visual [Studio Visualization and Modeling SDK](https://docs.microsoft.com/samples/browse/?redirectedfrom=MSDN-samples) .

## <a name="see-also"></a>Veja também
 [SDK de visualização e modelagem do Visual Studio](https://docs.microsoft.com/samples/browse/?redirectedfrom=MSDN-samples)
