...
> [!NOTE]
> Este tópico é sobre as propriedades de tipos em diagramas de classe UML. Para obter mais informações, consulte estes tópicos:
...
|**Propriedade**|**Default**|Aparece no/na|Descrição|
|------------------|-----------------|----------------|-----------------|
...
|**É Abstrato**|Falso|Classe|Se for true, a classe não poderá ser instanciada e será destinada para uso como uma classe base.|
|**É folha**|Falso|Classe, interface|Se for true, o tipo não se destina a ter tipos derivados.|
|**Está ativo**|Falso|Classe|Se for true, cada instância desse tipo será associada a um thread de controle.|
