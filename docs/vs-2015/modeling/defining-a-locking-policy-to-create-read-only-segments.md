...
> Uma política de bloqueio pode ser contornada usando a reflexão. Ele fornece um limite claro para desenvolvedores de terceiros, mas não fornece segurança forte.
 ...
 Mais informações estão disponíveis no site do [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] [SDK de visualização e modelagem](https://www.microsoft.com/download/details.aspx?id=48148) .
