...
## <a name="installing-and-uninstalling-a-dsl-by-using-the-vsx"></a><a name="Installing"></a> Instalando e desinstalando uma DSL usando o VSX
 Quando o DSL é instalado por esse método, o usuário pode abrir um arquivo DSL de dentro do [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] , mas o arquivo não pode ser aberto no Windows Explorer.
...
2. Copie o arquivo **. vsix** para o computador de destino no qual você deseja instalar a DSL. Este pode ser seu próprio computador ou outro.
    ...
    - O computador de destino deve ter uma das edições do [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] especificadas em **DslPackage\source.Extensions.manifest**.
