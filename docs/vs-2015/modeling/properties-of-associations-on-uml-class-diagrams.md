...
|   **Aggregation**    |             Nenhum              |                                                                        **Nenhum** (4) – representa uma relação geral entre instâncias das classes.<br /><br /> **Composição** (5)-o objeto nessa função contém o objeto na função oposta. Você pode usar a ferramenta **composta** para criar uma associação com agregação composta.<br /><br /> **Compartilhado** (6)-o objeto nesta função contém referências ao objeto na outra função. Você pode usar a ferramenta de **agregação** para criar uma associação com agregação compartilhada.<br /><br /> A interpretação exata está aberta para a Convenção local.                                                                         |
|    **Is Derived**    |             Falso             |                                                                                                                                                                                                                          Se for true, o objeto nessa extremidade do link será calculado de outros atributos e associações. Por exemplo, MyWorkPlace calculada de myempregador. WorkPlace. Os detalhes devem ser digitados na descrição ou em um comentário anexado.                                                                                                                                                                                                                           |
| **É Union derivada** |             Falso             |                                                                                                                                                                                                                                                                                                             Se for true, a função será a União de um conjunto de funções em tipos derivados.                                                                                                                                                                                                                                                                                                             |
...
|   **É somente leitura**   |             Falso             |                                                                                                                                                                                                                                                                                   Se for true, uma instância da associação não poderá ser alterada depois de ser criada. O link é sempre para o mesmo objeto.                                                                                                                                                                                                                                                                                    |
| **Multiplicidade (3)** |               1               | **1** -essa extremidade da Associação sempre se vincula a um objeto. Na figura, cada item de menu tem um menu.<br /><br /> **0.. 1** -essa extremidade da Associação vincula a um objeto ou não há nenhum link.<br /><br /> **\\**\* -cada objeto na outra extremidade da associação é vinculado a uma coleção de objetos nesse final, e a coleção pode estar vazia.<br /><br /> **1.. \\ .** \* -todos os objetos na outra extremidade da associação estão vinculados a pelo menos um objeto neste fim. Na figura, cada menu tem pelo menos um item de menu.<br /><br /> *n* **..** *m* -cada objeto na outra extremidade tem uma coleção de entre *n* e *m* links para objetos neste fim. |
|    **Is Ordered**    |             Falso             |                                                                                                                                                                                                                                                                                                  Se for true, a coleção retornada formará uma lista sequencial. Para multiplicidade maior que 1.                                                                                                                                                                                                                                                                                                   |
|    **É Exclusivo**     |             Falso             |                                                                                                                                                                                                                                                                                              Se for true, não haverá valores duplicados na coleção retornada. Para multiplicidade maior que 1.                                                                                                                                                                                                                                                                                              |
