---
title: Adicionando uma propriedade de rastreamento a uma definição de linguagem específica de domínio | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="creating-files-for-custom-code"></a>Criando arquivos para código personalizado
...
## <a name="adding-helper-classes-to-support-tracking-properties"></a>Adicionando classes auxiliares para dar suporte a propriedades de acompanhamento
...
#### <a name="to-update-the-dsl-package-to-use-your-custom-type-descriptor"></a>Para atualizar o pacote de DSL para usar o descritor de tipo personalizado
...
## <a name="adding-custom-code-for-the-tracking-property"></a>Adicionando código personalizado para a propriedade de rastreamento
...
## <a name="adding-custom-code-to-support-serialization"></a>Adicionando código personalizado para dar suporte à serialização
...
## <a name="testing-the-language"></a>Testando o idioma
 A próxima etapa é criar e executar o designer de DSL em uma nova instância do [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] para que você possa verificar se a propriedade de rastreamento está funcionando corretamente.

#### <a name="to-exercise-the-language"></a>Para exercitar a linguagem
...
## <a name="see-also"></a>Veja também
 ...
 [Como definir uma linguagem específica de domínio](../modeling/how-to-define-a-domain-specific-language.md) [como: criar uma solução de linguagem específica a um domínio](../modeling/how-to-create-a-domain-specific-language-solution.md) [: Personalizando a definição de linguagem específica de domínio](../misc/walkthrough-customizing-the-domain-specific-language-definition.md)
