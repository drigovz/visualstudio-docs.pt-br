...
## <a name="creating-the-dsl-project"></a>Criando o projeto DSL  
 Crie o projeto para sua linguagem específica do domínio.  
...
## <a name="adding-custom-code-for-the-custom-type-descriptor"></a>Adição de código personalizado para o descritor de tipo personalizado  
...
#### <a name="to-update-the-dsl-package-to-use-your-custom-type-descriptor"></a>Para atualizar o pacote DSL para usar seu descritor de tipo personalizado  
...
## <a name="adding-custom-code-for-the-model"></a>Adição de código personalizado para o modelo  
...
## <a name="adding-custom-code-for-the-tracking-property"></a>Adição de código personalizado para a propriedade de controle  
...
## <a name="adding-custom-code-to-support-serialization"></a>Adicionar código personalizado para oferecer suporte à serialização  
...
## <a name="testing-the-language"></a>A linguagem de testes  
 A próxima etapa é criar e executar o designer DSL em uma nova instância de [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] para que você possa verificar se a propriedade de controle está funcionando corretamente.  
...
2.  No menu **Depuração**, clique em **Iniciar Depuração**.  
     ...
     O build experimental do [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] abre o **depuração** solução, que contém um arquivo de teste vazio.  
