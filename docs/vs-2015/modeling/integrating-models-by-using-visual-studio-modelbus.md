...
[!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ModelBus fornece um método para criar links entre modelos e de outras ferramentas em modelos. Por exemplo, você pode vincular modelos de DSL (linguagem específica de domínio) e modelos UML. É possível criar um conjunto integrado de DSLs.
