...
|Expõe cor de preenchimento como Propriedade|Se `True` , o usuário pode definir a cor de preenchimento do diagrama do designer gerado. Para definir isso, clique com o botão direito do mouse na forma do diagrama e clique em **Adicionar explosed**.|Falso|
|Expõe a cor do texto como Propriedade|Se `True` , o usuário pode definir a cor do texto do diagrama no designer gerado. Para definir isso, clique com o botão direito do mouse na forma do diagrama e clique em **Adicionar explosed**.|Falso|
