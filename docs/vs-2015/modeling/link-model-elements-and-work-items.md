...
- [Exibir itens de trabalho vinculados a um elemento de modelo](#OpenWorkItem)

- [Exibir elementos de modelo vinculados a um item de trabalho](#ViewLinkedModels)

- [Excluir links entre elementos de modelo e itens de trabalho](#RemoveLinks)

- [Solução de problemas](#Troubleshooting)

## <a name="ConnectTFS"></a>Conectar-se a um projeto de equipe
...
## <a name="LinkNew"></a>Vincular um elemento de modelo a um novo item de trabalho
...
## <a name="OpenWorkItem"></a>Exibir itens de trabalho vinculados a um elemento de modelo
...
## <a name="ViewLinkedModels"></a>Exibir elementos de modelo vinculados a um item de trabalho
...
3. Em **remover links para itens de trabalho**, desmarque os itens selecionados que você deseja desvincular. Clique em **OK**.
