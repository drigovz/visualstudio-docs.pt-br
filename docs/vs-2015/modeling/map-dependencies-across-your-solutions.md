...
- [Entenda suas dependências de código por meio de visualização](http://go.microsoft.com/fwlink/?LinkID=252065)

- [Visualizar o impacto de uma alteração](http://go.microsoft.com/fwlink/?LinkID=252068)

- [Compreendendo o código complexo com mapas de código](http://go.microsoft.com/fwlink/?LinkID=259869)
...
## <a name="SeeOverviewSource"></a>Ver dependências gerais

### <a name="OverviewSource"></a>Confira dependências em sua solução
...
### <a name="OverviewCompiled"></a>Ver dependências entre assemblies ou binários
...
7. O mapa mostra as relações. Neste exemplo, os métodos chamados pelo método `Find` e sua localização na solução ou externamente.
...
### <a name="Troubleshooting"></a>Solucionar problemas de mapas C++ para C e Code
...
||O chamador não é uma função, e é uma conversão no arquivo binário ou um ponteiro na seção de dados.|Quando o chamador for uma conversão, tente usar `_declspec(dllimport)` para evitá-la.<br /><br /> Consulte:<br /><br /> -   [regras e limitações gerais](https://msdn.microsoft.com/library/6c48902d-4259-4761-95d4-e421d69aa050)<br />-   [importar chamadas de função usando _ declspec (dllimport)](https://msdn.microsoft.com/library/6b53c616-0c6d-419a-8e2a-d2fff20510b3)<br />-   [dllexport, DllImport](https://msdn.microsoft.com/library/ff95b645-ef55-4e72-b848-df44657b3208)|

## <a name="RenderMoreQuickly"></a>Fazer com que os mapas de código sejam renderizados mais rapidamente
...
### <a name="share-the-map-with-other-visual-studio-users"></a>Compartilhar o mapa com outros usuários do Visual Studio
 ...
 Para salvar o mapa como parte do projeto específico, na barra de ferramentas do mapa, escolha **compartilhar**, **mova** \<*CodeMapName* > **. dgml para**e, em seguida, escolha o projeto no qual deseja salvar o mapa.
