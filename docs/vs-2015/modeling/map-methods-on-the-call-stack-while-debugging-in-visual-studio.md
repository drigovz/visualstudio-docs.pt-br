...
- Código que você pode depurar, como Visual C# .net, Visual Basic .net, C++, JavaScript ou X + +
  ...
  Consulte: [vídeo: Depurar visualmente com integração do depurador do mapa de código (canal 9)](http://go.microsoft.com/fwlink/?LinkId=293418) • [mapear a pilha de chamadas](#MapStack) • [fazer observações sobre o código](#MakeNotes) • [atualizar o mapa com a próxima pilha de chamadas](#UpdateMap) • [Adicionar código relacionado ao mapa](#AddRelatedCode) • [encontrar bugs usando o mapa](#FindBugs) • [Q & A](#QA)
