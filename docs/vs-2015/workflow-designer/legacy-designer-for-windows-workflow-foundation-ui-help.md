---
title: Designer herdado para ajuda da interface do usuário do Windows Workflow Foundation | Microsoft Docs
ms.date: 11/15/2016
...
Esta seção contém tópicos da Ajuda contextuais para [!INCLUDE[wfd1](../includes/wfd1-md.md)] herdado em [!INCLUDE[vs2010](../includes/vs2010-md.md)]. Use o designer herdado quando você precisa definir como alvo [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] ou [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)].
 ...
 Você pode acessar esses tópicos na interface do usuário do [!INCLUDE[vs_current_long](../includes/vs-current-long-md.md)] pressionando **F1** quando uma caixa de diálogo herdada [!INCLUDE[wfd2](../includes/wfd2-md.md)] estiver aberta.
