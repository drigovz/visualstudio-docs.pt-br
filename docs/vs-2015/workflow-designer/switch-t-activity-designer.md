---
title: Alternar &lt; &gt; Designer de atividades T | Microsoft Docs
ms.date: 11/15/2016
...
---
# <a name="switchlttgt-activity-designer"></a>Alternar &lt; &gt; Designer de atividades T
A atividade de <xref:System.Activities.Statements.Switch%601> avalia uma expressão especificada e executa a atividade de uma coleção de atividades cuja chave associado corresponde ao valor obtido de avaliação.
 ...
 O designer de atividade **switch \<T> ** é usado para criar e configurar uma <xref:System.Activities.Statements.Switch%601> atividade no [!INCLUDE[wfd1](../includes/wfd1-md.md)] .
...
## <a name="how-to-use-the-switcht-activity-designer"></a>Como usar o designer de \<T> atividade de switch
 O designer de atividade de **switch \<T> ** pode ser encontrado na categoria **fluxo de controle** da caixa de **ferramentas**, que é acessada clicando na guia caixa de **ferramentas** na [!INCLUDE[wfd2](../includes/wfd2-md.md)] (como alternativa, selecione **barra de ferramentas** no menu **Exibir** ou CTRL + ALT + X.) Depois de soltá-lo no [!INCLUDE[wfd2](../includes/wfd2-md.md)] , ele exibe a caixa de diálogo **Selecionar tipos** para permitir que o usuário especifique o tipo genérico *T* usado na <xref:System.Activities.Statements.Switch%601> atividade. O valor padrão é **Int32**. Depois que o tipo genérico *T* tiver sido selecionado, um designer de **comutador \<T> ** será adicionado ao designer de fluxo de trabalho.

 A seguir estão as propriedades **do \<T> switch** designer. Todas essas propriedades podem ser editadas na grade de propriedade. Alguns deless também podem ser editados na superfície de designer.
