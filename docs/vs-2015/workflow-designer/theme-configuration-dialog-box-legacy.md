...
Este tópico descreve como usar a caixa de diálogo **configuração de tema** no herdado [!INCLUDE[wfd1](../includes/wfd1-md.md)] . Use [!INCLUDE[wfd2](../includes/wfd2-md.md)] herdado quando você precisa definir como alvo [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] ou [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)].
...
|**Visualização**|Clique para exibir uma janela para visualizar os efeitos de alterações de propriedade.|
