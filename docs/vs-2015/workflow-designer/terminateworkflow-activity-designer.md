...
## <a name="see-also"></a>Consulte Também
 [Runtime](../workflow-designer/runtime-activity-designers.md) [Persistir](../workflow-designer/persist-activity-designer.md) o tempo de execução