...
ms.locfileid: "58924233"
---
# <a name="how-to-create-an-empty-workflow-project-legacy"></a>Como: Criar um projeto de fluxo de trabalho vazio (herdado)
...
5.  No **modelos** painel, selecione **projeto de fluxo de trabalho vazio**.  
