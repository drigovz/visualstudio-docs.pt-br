...
## <a name="in-this-section"></a>Nesta seção
 ...
 [Como: criar um aplicativo de serviço de fluxo de trabalho WCF](../workflow-designer/how-to-create-a-wcf-workflow-service-application.md) Descreve as etapas necessárias para criar um aplicativo de serviço de fluxo de trabalho [!INCLUDE[indigo2](../includes/indigo2-md.md)].
 ...
 [Como: adicionar um novo item a um projeto de fluxo de trabalho](../workflow-designer/how-to-add-a-new-item-to-a-workflow-project.md) Descreve como adicionar outras atividades de fluxo de trabalho ou designers e outros itens de [!INCLUDE[vsprvs](../includes/vsprvs-md.md)], como atividades de código a um projeto existente.
