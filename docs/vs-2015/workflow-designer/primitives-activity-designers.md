---
title: Designers de atividade de primitivos | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="in-this-section"></a>Nesta seção
 [Atribuir](../workflow-designer/assign-activity-designer.md) Usado para criar e configurar uma atividade de <xref:System.Activities.Statements.Assign>.

 [Atraso](../workflow-designer/delay-activity-designer.md) Usado para criar e configurar uma atividade de <xref:System.Activities.Statements.Delay>.

 [InvokeMethod](../workflow-designer/invokemethod-activity-designer.md) Usado para criar e configurar uma atividade de <xref:System.Activities.Statements.InvokeMethod>.

 [WriteLine](../workflow-designer/writeline-activity-designer.md) Usado para criar e configurar uma atividade de <xref:System.Activities.Statements.WriteLine>.
