---
title: Criando projetos herdados de fluxo de trabalho | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="in-this-section"></a>Nesta seção  
 [Como: criar projetos de fluxo de trabalho (herdado)](../workflow-designer/how-to-create-workflow-projects-legacy.md)  
  
 [Como: criar aplicativos de console de fluxo de trabalho sequencial (herdado)](../workflow-designer/how-to-create-sequential-workflow-console-applications-legacy.md)  
  
 [Como: criar uma biblioteca de fluxo de trabalho sequencial (herdado)](../workflow-designer/how-to-create-a-sequential-workflow-library-legacy.md)  
 ...
 [Como: adicionar um novo item a um projeto de fluxo de trabalho (herdado)](../workflow-designer/how-to-add-a-new-item-to-a-workflow-project-legacy.md)  
  
## <a name="see-also"></a>Consulte também  
 [Modos de exibição do fluxo de trabalho sequencial (herdado)](../workflow-designer/sequential-workflow-views-legacy.md)   
