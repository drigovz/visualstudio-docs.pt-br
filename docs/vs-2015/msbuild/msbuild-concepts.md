...
|Título|Descrição|  
|-----------|-----------------|  
|[Propriedades do MSBuild](../msbuild/msbuild-properties1.md)|Introduz propriedades e coleções de propriedades. As propriedades são pares chave-valor que podem ser usados para configurar builds.|  
