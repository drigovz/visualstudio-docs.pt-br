...
ms.locfileid: "65694106"
---
# <a name="lc-task"></a>Tarefa LC
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Encapsula LC.exe, que gera um arquivo .license de um arquivo .licx. Para obter mais informações sobre LC.exe, consulte [Lc.exe (Compilador de Licença)](https://msdn.microsoft.com/library/2de803b8-495e-4982-b209-19a72aba0460).  
