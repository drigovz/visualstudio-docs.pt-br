...
|NoVBRuntimeReference|Um valor booliano que indica se o runtime [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] (em Microsoft.VisualBasic.dll) deve ser incluído como referência no projeto.|  
