...
Tarefas fornecem o código que é executado durante o processo de build. Quando o Visual C++ é instalado, as tarefas a seguir estão disponíveis, além das que são instaladas com o [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)]. Para obter mais informações, confira [visão geral do MSBuild (Visual C++)](https://msdn.microsoft.com/library/dd258f6f-ab51-48d9-b274-f7ba911d05ca).  
...
|[Vincular tarefa](../msbuild/link-task.md)|Encapsula a ferramenta do vinculador do Visual C++ (link.exe).|  
...
|[Gravação de tarefas](../msbuild/task-writing.md)|Descreve como criar uma tarefa.|
