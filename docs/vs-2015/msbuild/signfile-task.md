...
> [!NOTE]
> A impressão digital do certificado é o hash SHA-1 do certificado. Para obter mais informações, consulte [obter o hash SHA-1 de um certificado de AC raiz confiável](https://msdn.microsoft.com/dd641990-9a88-4228-a245-017797131a87).  
