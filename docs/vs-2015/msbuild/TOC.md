...
#### [Como: referenciar o nome ou o local do arquivo de projeto](how-to-reference-the-name-or-location-of-the-project-file.md)
...
#### [Como: selecionar os arquivos a ser compilados](how-to-select-the-files-to-build.md)
#### [Como: excluir arquivos do build](how-to-exclude-files-from-the-build.md)
#### [Como: exibir uma lista de itens separados por vírgulas](how-to-display-an-item-list-separated-with-commas.md)
...
#### [Como: especificar qual destino será compilado primeiro](how-to-specify-which-target-to-build-first.md)
...
#### [Como: compilar de forma incremental](how-to-build-incrementally.md)
#### [Como: limpar um build](how-to-clean-a-build.md)
### [Tarefas](msbuild-tasks.md)
...
##### [Passo a passo: criar uma tarefa embutida](walkthrough-creating-an-inline-task.md)
...
#### [Como: fazer escape de caracteres especiais no MSBuild](how-to-escape-special-characters-in-msbuild.md)
...
## [Passo a passo: criando um arquivo de projeto do MSBuild do zero](walkthrough-creating-an-msbuild-project-file-from-scratch.md)
...
## [Glossário](msbuild-glossary1.md)
## [Recursos adicionais](additional-msbuild-resources.md)
