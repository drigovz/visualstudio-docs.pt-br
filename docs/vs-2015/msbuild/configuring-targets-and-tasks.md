...
## <a name="installation"></a>Instalação  
 ...
 Se você quiser instalar o MSBuild separadamente do Visual Studio, poderá baixar o pacote de instalação do [download do MSBuild](https://www.microsoft.com/download/details.aspx?id=40760). Você também deve instalar as versões do .NET Framework que deseja usar.  
...
## <a name="targets-and-tasks"></a>Destinos e tarefas  
 ...
 Se quiser criar seu próprio contexto de destino, você deverá definir esses parâmetros e argumentos adequadamente. Examine o arquivo Microsoft.Common.targets do .NET Framework 4.5 e o arquivo Microsoft.Common.Tasks para obter exemplos.  Para obter informações sobre como criar uma tarefa personalizada que pode funcionar com vários contextos de destino ou como modificar tarefas existentes, consulte [como configurar destinos e tarefas](../msbuild/how-to-configure-targets-and-tasks.md).  
