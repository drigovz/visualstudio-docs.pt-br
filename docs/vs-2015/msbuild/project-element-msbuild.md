...
## <a name="see-also"></a>Consulte também  
 [Como: Especificar qual destino a ser compilado primeiro](../msbuild/how-to-specify-which-target-to-build-first.md)   
