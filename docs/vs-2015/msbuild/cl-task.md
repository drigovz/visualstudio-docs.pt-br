...
- **AdditionalIncludeDirectories**  
   ...
   Para obter mais informações, consulte [/I (diretórios de inclusão adicionais)](https://msdn.microsoft.com/library/3e9add2a-5ed8-4d15-ad79-5b411e313a49).  
...
- **AdditionalUsingDirectories** Parâmetro String[] opcional.  
  
   Especifica um diretório em que o compilador pesquisará para resolver referências de arquivo passadas para diretiva **#using**.  
  
   Para obter mais informações, consulte [/AI (Especificar Diretórios de Metadados)](https://msdn.microsoft.com/library/fb9c1846-504c-4a3b-bb39-c8696de32f6f).  
...
- **AssemblerListingLocation**  
   ...
   Para obter mais informações, consulte a opção **/Fa** em [/FA, /Fa (Arquivo de Listagem)](https://msdn.microsoft.com/library/c7507d0e-c69d-44f9-b8e2-d2c398697402).  
...
- **BasicRuntimeChecks**  
   ...
   Habilita e desabilita o recurso de verificações de erro em tempo de execução, em conjunto com o pragma [runtime_checks](https://msdn.microsoft.com/library/ae50b43f-f88d-47ad-a2db-3389e9e7df5b).  
...
- **BrowseInformation**  
   ...
   Para obter mais informações, consulte a opção **/FR** em [/FR, /Fr (criar Arquivo .Sbr)](https://msdn.microsoft.com/library/3fd8f88b-3924-4feb-9393-287036a28896).  
...
- **BrowseInformationFile**  
   ...
   Para obter mais informações, consulte o parâmetro **BrowseInformation** nessa tabela e também consulte [/FR, /Fr (criar Arquivo .Sbr)](https://msdn.microsoft.com/library/3fd8f88b-3924-4feb-9393-287036a28896).  
...
- **BufferSecurityCheck**  
   ...
   Para obter mais informações, consulte [/GS (verificação de segurança do buffer)](https://msdn.microsoft.com/library/8d8a5ea1-cd5e-42e1-bc36-66e1cd7e731e).  
...
- **CreateHotpatchableImage**  
   ...
   Para obter mais informações, consulte [/hotpatch (criar imagem capaz de aplicar patches sob demanda)](https://msdn.microsoft.com/library/aad539b6-c053-4c78-8682-853d98327798).  
...
- **DisableLanguageExtensions**  
   ...
   Para obter mais informações, consulte a opção **/Za** em [/Za, /Ze (Desabilitar Extensões de Idioma)](https://msdn.microsoft.com/library/65e49258-7161-4289-a176-7c5c0656b1a2).  
...
- **DisableSpecificWarnings**  
   ...
   Para obter mais informações, consulte a opção `/wd` em [/w, /W0, /W1, /W2, /W3, /W4, /w1, /w2, /w3, /w4, /Wall, /wd, /we, /wo, /Wv, /WX (Nível de Aviso)](https://msdn.microsoft.com/library/d6bc7bf5-c754-4879-909c-8e3a67e2629f).  
...
- **EnableFiberSafeOptimizations**  
   ...
   Para obter mais informações, consulte [/GT (suporte para armazenamento em fibra-thread safe-local)](https://msdn.microsoft.com/library/071fec79-c701-432b-9970-457344133159).  
...
- **EnablePREfast**  
   ...
   Para obter mais informações, consulte [/analyze (Análise de Código)](https://msdn.microsoft.com/library/81da536a-e030-4bd4-be18-383927597d08).  
...
- **ExpandAttributedSource**  
   ...
   Para obter mais informações, consulte [/Fx (mesclar código injetado)](https://msdn.microsoft.com/library/14f0e301-3bab-45a3-bbdf-e7ce66f20560).  
...
- **FloatingPointExceptions**  
   ...
   Para obter mais informações, consulte a opção o /**fp:except** em [/fp (Especificar Comportamento de Ponto Flutuante)](https://msdn.microsoft.com/library/10469d6b-e68b-4268-8075-d073f4f5d57e).  
...
- **ForceConformanceInForLoopScope**  
   ...
   Se `true`, implementará o comportamento padrão do C++ em loops [for](https://msdn.microsoft.com/library/6c7d01b3-c4c1-4c6a-aa58-e2d198f33d4a) que usem extensões da Microsoft ([/Ze](https://msdn.microsoft.com/library/65e49258-7161-4289-a176-7c5c0656b1a2)).  
  
   Para obter mais informações, consulte [/Zc:forScope (forçar conformidade para escopo de loop)](https://msdn.microsoft.com/library/3031f02d-3b14-4ad0-869e-22b0110c3aed).  
...
- **ForcedIncludeFiles**  
   ...
   Para obter mais informações, consulte [/FI (nomear arquivo de include forçado)](https://msdn.microsoft.com/library/07e79577-8152-4df9-a64c-aae08c603397).  
...
- **ForcedUsingFiles**  
   ...
   Para obter mais informações, consulte [/FU (nome forçado #usando arquivo)](https://msdn.microsoft.com/library/698f8603-457f-435a-baff-5ac9243d6ca1).  
...
- **FunctionLevelLinking**  
   ...
   Para obter mais informações, consulte [/Gy (habilitar vinculação em nível de função)](https://msdn.microsoft.com/library/0d3cf14c-ed7d-4ad3-b4b6-104e56f61046).  
...
- **GenerateXMLDocumentationFiles**  
   ...
   Para obter mais informações, consulte [/doc (processar comentários da documentação) (C/C++)](https://msdn.microsoft.com/library/b54f7e2c-f28f-4f46-9ed6-0db09be2cc63). Consulte também o parâmetro **XMLDocumentationFileName** nesta tabela.  
...
- **IgnoreStandardIncludePath**  
   ...
   Para obter mais informações, consulte [/X (ignorar caminhos de inclusão padrão)](https://msdn.microsoft.com/library/16bdf2cc-c8dc-46e4-bdcc-f3caeba5e1ef).  
...
- **IntrinsicFunctions**  
   ...
   Para obter mais informações, consulte [/Oi (gerar funções intrínsecas)](https://msdn.microsoft.com/library/fa4a3bf6-0ed8-481b-91c0-add7636132b4).  
...
- **MinimalRebuild**  
   ...
   Para obter mais informações, consulte [/Gm (habilitar recompilação mínima)](https://msdn.microsoft.com/library/d8869ce0-d2ea-40eb-8dae-6d2cdb61dd59).  
...
- **MultiProcessorCompilation**  
   ...
   Para obter mais informações, consulte [/MP (compilar com vários processos)](https://msdn.microsoft.com/library/a932b14a-74fe-4b45-84e4-6bf53f0f5e07). Consulte também o parâmetro **ProcessorNumber** nesta tabela.  
...
- **OmitDefaultLibName**  
   ...
   Para obter mais informações, consulte [/Zl (omitir o nome da biblioteca padrão)](https://msdn.microsoft.com/library/b27d39d0-44d6-498c-84ae-27c1326fee59).  
...
- **OmitFramePointers**  
   ...
   Para obter mais informações, consulte [/Oy (omissão do ponteiro de quadro)](https://msdn.microsoft.com/library/c451da86-5297-4c5a-92bc-561d41379853).  
...
- **PrecompiledHeaderFile**  
   ...
   Para obter mais informações, consulte [/Yc (Criar arquivo de cabeçalho pré-compilado)](https://msdn.microsoft.com/library/47c2e555-b4f5-46e6-906e-ab5cf21f0678) e [/Yu (Usar arquivo de cabeçalho pré-compilado)](https://msdn.microsoft.com/library/24f1bd0e-b624-4296-a17e-d4b53e374e1f).  
...
- **PrecompiledHeaderOutputFile**  
   ...
   Para obter mais informações, consulte [/Fp (arquivo .Pch de nome)](https://msdn.microsoft.com/library/0fcd9cbd-e09f-44d3-9715-b41efb5d0be2).  
...
- **PreprocessKeepComments**  
   ...
   Para obter mais informações, consulte [/C (Preservar Comentários Durante o Pré-Processamento)](https://msdn.microsoft.com/library/944567ca-16bc-4728-befe-d414a7787f26).  
...
- **PreprocessorDefinitions**  
   ...
   Para obter mais informações, consulte [/D (definições de pré-processador)](https://msdn.microsoft.com/library/b53fdda7-8da1-474f-8811-ba7cdcc66dba).  
...
- **PreprocessOutputPath**  
   ...
   Para obter mais informações, consulte [/Fi (pré-processar nome de arquivo de saída)](https://msdn.microsoft.com/library/6d0ba983-a8b7-41ec-84f5-b4688ef8efee).  
...
- **PreprocessSuppressLineNumbers**  
   ...
   Para obter mais informações, consulte [/EP (pré-processar para stdout Sem Diretivas #line)](https://msdn.microsoft.com/library/6ec411ae-e33d-4ef5-956e-0054635eabea).  
...
- **PreprocessToFile**  
   ...
   Para obter mais informações, consulte [/P (pré-processar para um arquivo)](https://msdn.microsoft.com/library/123ee54f-8219-4a6f-9876-4227023d83fc).  
...
- **ProgramDataBaseFileName**  
   ...
   Para obter mais informações, consulte [/Fd (nome de arquivo de banco de dados do programa)](https://msdn.microsoft.com/library/3977a9ed-f0ac-45df-bf06-01cedd2ba85a).  
...
- **RuntimeTypeInfo**  
   ...
   Para obter mais informações, consulte [/GR (habilitar informações de tipo de tempo de execução)](https://msdn.microsoft.com/library/d1f9f850-dcec-49fd-96ef-e72d01148906).  
...
- **ShowIncludes**  
   ...
   Para obter mais informações, consulte [/showIncludes (listar arquivos de inclusão)](https://msdn.microsoft.com/library/0b74b052-f594-45a6-a7c7-09e1a319547d).  
...
- **StringPooling**  
   ...
   Para obter mais informações, consulte [/GF (eliminar cadeias de caracteres duplicadas)](https://msdn.microsoft.com/library/bb7b5d1c-8e1f-453b-9298-8fcebf37d16c).  
...
- **SuppressStartupBanner**  
   ...
   Para obter mais informações, consulte [/nologo (suprimir faixa de inicialização) (C/C++)](https://msdn.microsoft.com/library/75930d8b-b11c-4db8-99e5-b52f97da0693).  
...
- **TreatWarningAsError**  
   ...
   Para obter mais informações, consulte a opção **/WX** em [/w, /W0, /W1, /W2, /W3, /W4, /w1, /w2, /w3, /w4, /Wall, /wd, /we, /wo, /Wv, /WX (nível de aviso)](https://msdn.microsoft.com/library/d6bc7bf5-c754-4879-909c-8e3a67e2629f).  
...
- **UndefineAllPreprocessorDefinitions**  
   ...
   Para obter mais informações, consulte a opção **/u** em [/U, /u (Excluir Símbolos)](https://msdn.microsoft.com/library/7bc0474f-6d1f-419b-807d-0d8816763b2a).  
...
- **UseFullPaths**  
   ...
   Para obter mais informações, consulte [/FC (caminho completo do arquivo de código-fonte no diagnóstico)](https://msdn.microsoft.com/library/1f11414e-cb42-421b-be68-9d369aab036b).  
...
- **UseUnicodeForAssemblerListing**  
   ...
   Para obter mais informações, consulte a opção **/FAu** em [/FA, /Fa (Arquivo de Listagem)](https://msdn.microsoft.com/library/c7507d0e-c69d-44f9-b8e2-d2c398697402).  
...
- **WholeProgramOptimization**  
   ...
   Para obter mais informações, consulte [/GL (otimização de programa inteiro)](https://msdn.microsoft.com/library/09d51e2d-9728-4bd0-b5dc-3b8284aca1d1).  
...
- **XMLDocumentationFileName**  
   ...
   Para obter mais informações, consulte o argumento `name` em [/doc ( Comentários da Documentação do Processo) (C/C++)](https://msdn.microsoft.com/library/b54f7e2c-f28f-4f46-9ed6-0db09be2cc63). Consulte também o parâmetro **GenerateXMLDocumentationFiles** nesta tabela.  
