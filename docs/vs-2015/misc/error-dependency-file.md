---
title: 'Erro: o&#39; de arquivo de dependência &#39;no projeto &#39;o&#39; do projeto não pode ser copiado para o diretório de execução porque ele estaria em conflito com dependência &#39;arquivo&#39; | Microsoft Docs'
ms.date: 11/15/2016
...
---
# <a name="error-the-dependency-39file39-in-project-39project39-cannot-be-copied-to-the-run-directory-because-it-would-conflict-with-dependency-39file39"></a>Erro: o&#39; de arquivo de dependência &#39;no projeto &#39;o&#39; do projeto não pode ser copiado para o diretório de execução porque ele estaria em conflito com o arquivo de dependência &#39;&#39;
