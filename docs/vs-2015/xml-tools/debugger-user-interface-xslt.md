...
|`self::node()`|O valor do nó de contexto.|  
 ...
 Para obter mais informações, consulte [como: alterar o contexto do depurador](http://msdn.microsoft.com/library/8a69ea63-2ef0-4b4f-9521-cf8ad2e3ec5e).  
