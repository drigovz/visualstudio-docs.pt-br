...
## <a name="in-this-section"></a>Nesta seção
 [Editor de XML](../xml-tools/xml-editor.md) Apresenta o editor de XML.

 [Designer de esquema XML](../xml-tools/xml-schema-designer.md) Discute o designer de esquema XML e o trabalho com esquemas XSD (linguagem de definição de esquema XML).

## <a name="related-sections"></a>Seções relacionadas
 [Depuração XSLT](../xml-tools/debugging-xslt.md) Discute como depurar folhas de estilo usando o depurador do Visual Studio.
