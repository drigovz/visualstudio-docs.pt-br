...
Este tópico lista os problemas comuns que podem ocorrer quando você está trabalhando com o [!INCLUDE[vsindigo](../includes/vsindigo-md.md)] ou [!INCLUDE[ssAstoria](../includes/ssastoria-md.md)] referências no [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] .
