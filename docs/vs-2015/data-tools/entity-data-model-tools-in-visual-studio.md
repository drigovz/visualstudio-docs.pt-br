...
- Você pode usar o **Assistente de atualização de modelo** para atualizar seu modelo conceitual, o modelo de armazenamento e os mapeamentos quando forem feitas alterações no banco de dados subjacente.
  ...
  > [!NOTE]
  > A partir do Visual Studio 2010, as [!INCLUDE[adonet_edm](../includes/adonet-edm-md.md)] ferramentas não dão suporte ao [!INCLUDE[ss2k](../includes/ss2k-md.md)] .
...
|Título|Descrição|
|-----------|-----------------|
|[ADO.NET Entity Framework](https://msdn.microsoft.com/library/a437041f-6899-4ae7-96ce-aabf528d7205)|Descreve como usar [!INCLUDE[adonet_edm](../includes/adonet-edm-md.md)] ferramentas, que o [!INCLUDE[adonet_ef](../includes/adonet-ef-md.md)] fornece, para criar aplicativos.|
|[Modelo de Dados de Entidade](https://msdn.microsoft.com/library/2dda3d5b-4582-4ba0-a91d-fcd7a1498137)|Fornece links e informações para trabalhar com dados que são usados por aplicativos criados no [!INCLUDE[adonet_ef](../includes/adonet-ef-md.md)] .|
