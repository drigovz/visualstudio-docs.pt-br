...
Os dados XML em um DataSet podem ser acessados chamando os métodos XML disponíveis no conjunto de dados. Para salvar os dados em formato XML, você pode chamar o <xref:System.Data.DataSet.GetXml%2A> método ou o <xref:System.Data.DataSet.WriteXml%2A> método de um <xref:System.Data.DataSet> .
...
- O <xref:System.Data.DataSet.GetXml%2A> método retorna um <xref:System.String> . Isso significa que você declara uma variável do tipo <xref:System.String> e atribui a ela os resultados do <xref:System.Data.DataSet.GetXml%2A> método.
