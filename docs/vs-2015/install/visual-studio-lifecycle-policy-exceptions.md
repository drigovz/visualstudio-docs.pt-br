...
|[Política do Online Services](http://support.microsoft.com/gp/OSSLpolicy)|SDK do Microsoft Ads|  
...
|[Silverlight 5](http://support.microsoft.com/lifecycle/?p1=16278)<br /><br /> <br />> Confira também: [http://support.microsoft.com/gp/lifean45](http://support.microsoft.com/gp/lifean45)|Tempo de execução do Silverlight 5<br /><br /> SDK do Silverlight 5|  
...
|[Serviços RIA do WCF v1.0 SP2](http://go.microsoft.com/fwlink/?LinkId=328955)|WCF RIA Services v1.0 SP2|  
