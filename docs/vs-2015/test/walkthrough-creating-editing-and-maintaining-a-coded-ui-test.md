...
12. Selecione o controle Checkbox. Na janela Propriedades, altere o valor da propriedade **Nome** de \<No Name> para checkBox1 e desmarque a propriedade **IsEnabled**.
     ...
     ![Aplicativo simples do WPF](../test/media/codedui-wpfapp.png "CodedUI_WPFApp")
...
8. Escolha **Iniciar Gravação** no UIMap – Construtor de Teste de IU Codificado.
     ...
     ![Iniciar gravação](../test/media/cuit-builder-record.png "CUIT_Builder_Record")
...
9. Na barra de ferramentas do [!INCLUDE[vsprvs](../includes/vsprvs-md.md)], escolha **Salvar**.
...
### <a name="videos"></a>Vídeos
 ![link para testes de](../data-tools/media/playvideo.gif "PlayVideo") [interface do usuário codificados em vídeo – DeepDive-Episode1-gettingstarted](http://go.microsoft.com/fwlink/?LinkID=230573)

 ![link para testes de](../data-tools/media/playvideo.gif "PlayVideo") [interface do usuário codificados em vídeo – DeepDive-Episode2-MaintainenceAndDebugging](http://go.microsoft.com/fwlink/?LinkID=230574)

 ![link para testes de](../data-tools/media/playvideo.gif "PlayVideo") [interface do usuário codificados em vídeo – DeepDive-Episode3-HandCoding](http://go.microsoft.com/fwlink/?LinkID=230575)
