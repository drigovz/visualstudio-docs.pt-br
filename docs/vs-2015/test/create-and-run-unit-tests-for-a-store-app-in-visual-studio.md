---
title: Criar e executar testes de unidade para um aplicativo da loja
ms.date: 11/15/2016
...
## <a name="in-this-section"></a>Nesta seção
 [Código C# de teste de unidade](../test/unit-testing-visual-csharp-code-in-a-store-app.md)

 [Executar o teste de unidade de DLL do C++](../test/unit-testing-a-visual-cpp-dll-for-store-apps.md)
