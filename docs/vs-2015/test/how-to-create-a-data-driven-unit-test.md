...
## <a name="see-also"></a>Consulte Também
 ...
 [Como criar e executar um](https://msdn.microsoft.com/5e0f43cf-5e51-48e2-9c98-0eb9324bdc48) teste de unidade de teste [da unidade seu código](../test/unit-test-your-code.md) [executa testes de unidade com o Test Explorer](../test/run-unit-tests-with-test-explorer.md) [gravando testes de unidade para o .NET Framework com a estrutura de teste de unidade da Microsoft para código gerenciado](../test/writing-unit-tests-for-the-dotnet-framework-with-the-microsoft-unit-test-framework-for-managed-code.md)
