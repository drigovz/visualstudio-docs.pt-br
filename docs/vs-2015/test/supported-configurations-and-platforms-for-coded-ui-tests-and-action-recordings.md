...
|Windows Forms 2.0 e posterior|Suporte total. **Observação:**  Há suporte completo para os controles NetFx, mas não há suporte para todos os controles de terceiros.|  
