...
|MFC|Suporte parcial. Consulte o [site da Microsoft](https://go.microsoft.com/fwlink/?LinkId=206511) a seguir para obter detalhes dos recursos com suporte.|
|SharePoint|Suporte total.|
|Aplicativos clientes do Office|Não há suporte.|
|Cliente Web do Dynamics CRM|Suporte total.|
|Cliente do Dynamics (Ax) 2012|A gravação e reprodução de ações têm suporte parcial. Consulte o [site da Microsoft](https://go.microsoft.com/fwlink/?LinkId=232677) a seguir para obter detalhes.|
|SAP|Não há suporte.|
