...
3. Na página **Processo**, expanda **Testes Automatizados**, **Fonte de Teste**, **Configurações de Execução**. Selecione o seu arquivo **.runsettings**.
   ...
   - <em>Mas o **assembly de teste</em>* aparece em vez da origem do **teste**. Quando tento definir o campo de **configurações de execução** , só posso selecionar arquivos. testsettings.*
