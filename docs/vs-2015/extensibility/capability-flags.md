...
|`SCC_CAP_SCCFILE`|0x80000000L|Dá suporte ao MSSCCPRJ. Arquivo SCC (sujeito à substituição de usuário/administrador) e [SccWillCreateSccFile](../extensibility/sccwillcreatesccfile-function.md).|  
