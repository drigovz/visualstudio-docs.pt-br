...
## <a name="example"></a>Exemplo  
 O exemplo a seguir ilustra os metadados de um modelo de projeto para um [!INCLUDE[csprcs](../includes/csprcs-md.md)] aplicativo do Windows.  
