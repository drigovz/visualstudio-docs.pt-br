...
# [Perguntas frequentes: conversão de suplementos em extensões VSPackage](faq-converting-add-ins-to-vspackage-extensions.md)
...
### [Passo a passo: estrutura de tópicos](walkthrough-outlining.md)
### [Passo a passo: exibir chaves correspondentes](walkthrough-displaying-matching-braces.md)
### [Passo a passo: exibir dicas de ferramenta Informações Rápidas](walkthrough-displaying-quickinfo-tooltips.md)
### [Passo a passo: exibir a ajuda da assinatura](walkthrough-displaying-signature-help.md)
### [Passo a passo: exibir o preenchimento de declaração](walkthrough-displaying-statement-completion.md)
...
### [Passo a passo: usar um comando do shell com uma extensão do editor](walkthrough-using-a-shell-command-with-an-editor-extension.md)
### [Passo a passo: usar uma tecla de atalho com uma extensão do editor](walkthrough-using-a-shortcut-key-with-an-editor-extension.md)
### [Passo a passo: acessar o objeto DTE em uma extensão do editor](walkthrough-accessing-the-dte-object-from-an-editor-extension.md)
...
#### [Como: anexar exibições a dados de documento](how-to-attach-views-to-document-data.md)
...
## [Como: usar assistentes com modelos de projeto](how-to-use-wizards-with-project-templates.md)
...
### [Passo a passo: adicionar um XAML personalizado à página inicial](walkthrough-adding-custom-xaml-to-the-start-page.md)
...
### [Passo a passo: salvar as configurações de usuário em uma página inicial](walkthrough-saving-user-settings-on-a-start-page.md)
...
## [Como: usar o contexto de interface do usuário baseado em regras para extensões do Visual Studio](how-to-use-rule-based-ui-context-for-visual-studio-extensions.md)
...
## [Como: adicionar uma dependência a um pacote do VSIX](how-to-add-a-dependency-to-a-vsix-package.md)
...
### [Como: criar um feed Atom para uma galeria privada](how-to-create-an-atom-feed-for-a-private-gallery.md)
...
### [Como: registrar os tipos de arquivo do editor](how-to-register-editor-file-types.md)
...
#### [Como: disparar eventos quando o editor perde o foco](how-to-fire-events-when-the-editor-loses-focus.md)
...
### [Atributos condicionais](vsct-xml-schema-conditional-attributes.md)
## [GUIDs e constantes](guids-and-constants-in-the-visual-studio-sdk.md)
