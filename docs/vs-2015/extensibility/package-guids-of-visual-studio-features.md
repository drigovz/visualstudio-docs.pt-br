---
title: Empacotar os GUIDs de recursos do Visual Studio 2015 | Microsoft Docs
titleSuffix: ''
ms.date: 11/15/2016
...
||Pacote de integração de controle de código-fonte do Visual Studio|{53544C4D-E3F8-4AA0-8195-8A8D16019423}|
||Pacote de Build de solução do Visual Studio|{282BD676-8B5B-11D0-8A34-00A0C91E2ACD}|
...
|Help|Pacote de Ajuda do Visual Studio|{4A791146-19E4-11D3-B86B-00C04F79F802}|
...
|Instalador de controles de caixa de ferramentas|Pacote do instalador de controles de caixa de ferramentas|{2C298B35-07DA-45F1-96A3-BE55D91C8d7A}|
...
||Pacote de persistência de projeto do Visual Web Developer|{8FF02D1A-C177-4AC8-A62F-88FC6EA65F57}|
...
|Editor de HTML|Pacote do Editor do Visual Studio HTM|{1B437D20-F8FE-11D2-A6AE-00104BCC7269}|
||Pacote do Editor de origem de HTML do Visual Web Developer|{BFCC0C3C-6F87-4285-A6C8-BB616061800D}|
...
|Editor binário|Pacote do Editor do Visual Studio binário|{5B98C2C0-CD7B-11D0-92DF-00A0C9138C45}|
|Designer de Formulários do Windows|Pacote de hospedagem Designer do Windows Forms|{68939055-38E0-4D17-92CB-8909710D8178}|
||Pacote do Windows Forms Designer|{7494682B-37A0-11D2-A273-00C04F8EF4FF}|
...
||Pacote do Designer de ElementHost|{7EAB3C71-59FF-4571-A5F3-643F255FC2E6}|
...
||Gerenciadores do Visual Studio e Designers de pacote|{8D8529D3-625D-4496-8354-3DAD630ECC1B}|
...
|Snippets de código|Pacote de trechos de código do Visual Studio|{0B680757-2C29-4531-80FA-535A5178AA98}|
|Suporte de projeto de linguagem gerenciados|Enumerador de componente do Visual Studio|{588205E0-66e0-11D3-8600-00C04F6123B3}|
...
|Exporte modelo...|Exportar pacote de modelo|{F1E4CFCA-4573-4345-8718-7BDE2b1F0BE8}|
 ...
 Alguns pacotes nunca devem ser removidos porque muitos outros recursos assumir dependências neles. Por exemplo, aqueles listados em "Core IDE" nunca devem ser removidos.

 Alguns recursos não podem ser completamente removidos. Por exemplo, não há nenhum pacote que pode ser cancelado para remover **modo de exibição de classe** e seus menus associados, opções e serviços. O **modo de exibição de classe** janela é fornecida pelo pacote do ambiente Visual Studio, que também fornece outros recursos importantes do IDE. Se você quiser remover **Class View**, você também precisará remover **localizar e substituir**, o ambiente **opções** páginas, o **a janela de comando**e o **saída** janela.
