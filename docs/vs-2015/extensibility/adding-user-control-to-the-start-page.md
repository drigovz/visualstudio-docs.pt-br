...
1. Crie uma página inicial usando nós criamos na [criação de uma página inicial personalizada](../extensibility/creating-a-custom-start-page.md).  
...
## <a name="adding-the-user-control-to-the-start-page"></a>Adicionando o controle de usuário à página inicial  
...
## <a name="testing-a-manually-created-custom-start-page"></a>Testando uma página inicial personalizada criada manualmente  
