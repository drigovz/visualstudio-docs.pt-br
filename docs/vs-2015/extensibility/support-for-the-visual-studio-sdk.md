...
### <a name="msdn-development-center"></a>Centro de desenvolvimento do MSDN  
 O [Visual Studio Extensibility Developer Center](https://go.microsoft.com/fwlink/?LinkID=84381) no MSDN contém recursos que ajudam a responder perguntas sobre como estender o Visual Studio. Por exemplo, há vários links para Blogs de desenvolvedores do VSIP.  
...
### <a name="msdn-forums"></a>Fóruns do MSDN  
 Os [fóruns do MSDN](https://go.microsoft.com/fwlink/?LinkID=76632) fornecem outra maneira de conversar com colegas e especialistas. A interface gráfica do usuário dos fóruns é projetada para torná-los mais fáceis de usar do que os grupos de notícias. O [Fórum de extensibilidade do Visual Studio](https://go.microsoft.com/fwlink/?LinkID=121964) é um bom lugar para começar a procurar respostas para perguntas de extensibilidade. Sempre pesquise antes de fazer uma pergunta porque outra pessoa pode já ter feito a mesma pergunta.  
...
> O suporte standard não pode ser usado para consulta ou para obter conselhos.  
 ...
 Informações sobre solicitações de suporte individual podem ser encontradas em [solicitações de suporte individuais](https://go.microsoft.com/fwlink/?LinkID=82385).  
