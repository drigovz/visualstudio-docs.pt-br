...
## <a name="adding-an-icon-to-a-command"></a>Adicionando um ícone a um comando  
...
4. Adicione um `GuidSymbol` elemento com um nome de **testIcon**. Crie um GUID (**Ferramentas/Criar GUID**, em seguida, selecione **formato do registro** e clique em copiar) e cole-o no `value` atributo. O resultado deve ser assim:  
