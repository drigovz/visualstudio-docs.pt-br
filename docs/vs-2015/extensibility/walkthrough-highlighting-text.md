---
title: 'Passo a passo: Realce de texto | Microsoft Docs'
ms.date: 11/15/2016
...
7. No construtor para HighlightWordTag, passe no nome de definição de formato que você acabou de criar.  
