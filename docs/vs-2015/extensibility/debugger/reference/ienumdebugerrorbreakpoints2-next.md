...
#### <a name="parameters"></a>Parâmetros  
 ...
 `rgelt`  
 [entrada, saída] Matriz de elementos [IDebugErrorBreakpoint2](../../../extensibility/debugger/reference/idebugerrorbreakpoint2.md) a ser preenchida.  
