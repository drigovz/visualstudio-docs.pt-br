...
#### <a name="parameters"></a>Parâmetros  
 `pAddress`  
 no Endereço que representa a função.  
  
 `dwLine`  
 no Deslocamento de linha do início da função.  
  
 `ppNewAddress`  
 fora Novo endereço que representa o deslocamento de linha do início da função.  
