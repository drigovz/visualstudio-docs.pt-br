...
```  
 ...
 Uma chamada para [GetPortSupplier](../../../extensibility/debugger/reference/idebugcoreserver2-getportsupplier.md) retorna essa interface, representando o fornecedor de porta atual que está sendo usado pelo [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] .  
