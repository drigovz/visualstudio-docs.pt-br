...
#### <a name="parameters"></a>Parâmetros  
 `pMachine`  
 no Um objeto [IDebugCoreServer2](../../../extensibility/debugger/reference/idebugcoreserver2.md) que representa o servidor de depuração (há um para cada instância do [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] ) em que o evento ocorreu.  
