...
ms.locfileid: "90838751"
---
# <a name="registering-a-project-type"></a>Registrando um tipo de projeto
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Ao criar um novo tipo de projeto, você deve criar entradas de registro que habilitam [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] o para reconhecer e trabalhar com o tipo de projeto. Normalmente, você cria essas entradas de registro usando um arquivo de script do registro (. rgs).  
