...
- Pesquise o sistema para localizar as versões do [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] seu VSPackage dão suporte (usando Windows Installer tabelas que incluem AppSearch, CompLocator, RegLocator, DrLocator e Signature).  
...
- Integre o VSPackage no [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] chamando **devenv.exe/setup** (usando a tabela CustomAction).  
...
- Conjunto de Ferramentas XML do Windows Installer  
   ...
   O conjunto de ferramentas cria pacotes de Windows Installer de arquivos de origem XML. O conjunto de ferramentas é um projeto de código-fonte aberto da Microsoft. Você pode baixar o código-fonte e os executáveis do [http://sourceforge.net/projects/wix](https://sourceforge.net/projects/wix/) .  
