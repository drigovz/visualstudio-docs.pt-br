...
### [Lista de verificação: criação de um serviço de linguagem herdado](checklist-creating-a-legacy-language-service.md)
...
##### [Como: dar suporte a estrutura de tópicos em um serviço de linguagem herdado](how-to-support-outlining-in-a-legacy-language-service.md)
...
##### [Como: fornecer suporte expandido a estrutura de tópicos em um serviço de linguagem herdado](how-to-provide-expanded-outlining-support-in-a-legacy-language-service.md)
...
### [Passo a passo: criação de um serviço de linguagem herdado](walkthrough-creating-a-legacy-language-service.md)
### [Passo a passo: obter uma lista de snippets de código instalados (implementação herdada)](walkthrough-getting-a-list-of-installed-code-snippets-legacy-implementation.md)
...
## [Geração de novo projeto: bastidores, parte um](new-project-generation-under-the-hood-part-one.md)
## [Geração de novo projeto: bastidores, parte dois](new-project-generation-under-the-hood-part-two.md)
...
#### [Lista de verificação: criação de novos tipos de projeto](checklist-creating-new-project-types.md)
...
#### [Detalhes de tempo de execução](source-control-runtime-details.md)
...
#### [Área de teste 1: adicionar e abrir do controle do código-fonte](test-area-1-add-to-open-from-source-control.md)
#### [Área de teste 2: obter do controle do código-fonte](test-area-2-get-from-source-control.md)
#### [Área de teste 3: fazer e desfazer check-out](test-area-3-check-out-undo-checkout.md)
...
### [Arquitetura](source-control-vspackage-architecture.md)
...
## [Como: gerar informações de registro de um instalador](how-to-generate-registry-information-for-an-installer.md)
