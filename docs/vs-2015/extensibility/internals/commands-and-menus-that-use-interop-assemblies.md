...
- Informe o [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ambiente de desenvolvimento integrado (IDE) sobre os comandos que ele suporta e se eles estão habilitados no momento.  
...
- Implemente explicitamente o tratamento de comandos usando <xref:Microsoft.VisualStudio.OLE.Interop.IOleCommandTarget> a <xref:Microsoft.VisualStudio.Shell.Interop.IVsUIHierarchy> interface ou.  
  ...
  O a seguir descreve como executar essas tarefas.  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Fornece uma definição do contrato de comando básico usado por todos os comandos de implementação de VSPackages usando assemblies de interoperabilidade  
 ...
 [Registrando manipuladores de comando de assembly de interoperabilidade](../../extensibility/internals/registering-interop-assembly-command-handlers.md)  
...
## <a name="related-sections"></a>Seções relacionadas  
 ...
 Fornece detalhes sobre como criar uma interface do usuário que usa o [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] suporte a comandos.  
