...
Um comando é roteado [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] com base no contexto no qual ele é executado. Ele é roteado do contexto inicial para fora para o contexto global.  
