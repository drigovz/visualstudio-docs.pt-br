...
Os desenvolvedores de aplicativos empresariais que usam o pacote do VS podem, de forma conveniente, agrupar tipos semelhantes de projetos no [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] usando o *aninhamento de projetos*. Por exemplo, o projeto de modelo empresarial usa projetos aninhados para agrupar projetos em categorias. Projetos de fachada de negócios, projetos de interface do usuário da Web e assim por diante são agrupados em uma categoria.  
 ...
 Você pode encontrar um exemplo de projetos aninhados no exemplo do C#. exemplo de projeto aninhado.  
