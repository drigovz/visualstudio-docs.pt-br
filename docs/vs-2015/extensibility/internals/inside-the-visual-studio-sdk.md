...
## <a name="projects"></a>Projetos  
 ...
 Os projetos também podem ser coletados em uma solução, que é um agrupamento de um ou mais projetos que trabalham juntos para criar um aplicativo. As informações de projeto e status relacionadas à solução são armazenadas em dois arquivos de solução, no arquivo da solução baseada em texto (. sln) e no arquivo da opção de usuário da solução binária (. suo). Esses arquivos são semelhantes aos arquivos de grupo (. VBG) que foram usados em versões anteriores do [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] e do espaço de trabalho (. DSW) e dos arquivos de opções de usuário (. opt) que foram usados em versões anteriores do [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] .  
...
> [!NOTE]
> Não há suporte para essa arquitetura de modelo em [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] projetos. Para obter informações sobre como criar [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] modelos de projeto, consulte [criando um assistente](https://msdn.microsoft.com/library/a7c0be7e-9297-4fed-83e3-5645c896d56b).  
