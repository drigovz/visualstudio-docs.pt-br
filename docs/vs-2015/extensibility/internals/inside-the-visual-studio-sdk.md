...
> [!NOTE]
> Não há suporte para essa arquitetura de modelo para [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] projetos. Para obter informações sobre como criar [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] modelos de projeto, consulte [Projetando um assistente](https://msdn.microsoft.com/library/a7c0be7e-9297-4fed-83e3-5645c896d56b).  
