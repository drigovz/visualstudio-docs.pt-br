...
|Ação|Etapas de teste|Resultados esperados para verificar|  
|------------|----------------|--------------------------------|  
|Enquanto estiver desconectado, confira um arquivo e conecte-se para sincronização|1. Desconecte um projeto controlado usando a caixa de diálogo Alterar controle do código-fonte (**arquivo**, **controle do código-fonte**, **Alterar fonte controle**l).<br />2. Verifique um arquivo.<br />3. clique em fazer check-out (desconectado) na caixa de diálogo de aviso.<br />4. Edite o arquivo.<br />5. Conecte-se usando a caixa de diálogo Alterar controle do código-fonte.<br />6. obter a versão mais recente do arquivo editado.|Comportamento comum esperado|  
