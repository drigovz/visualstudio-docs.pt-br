...
## <a name="command-menu-access"></a>Acesso ao menu de comando  
 O [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] caminho de menu do ambiente de desenvolvimento integrado a seguir é usado nos casos de teste.  
