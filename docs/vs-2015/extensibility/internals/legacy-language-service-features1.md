...
## <a name="related-sections"></a>Seções relacionadas  
 ...
 Descreve as etapas necessárias para registrar um serviço de linguagem baseado em MPF com o [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] .  
