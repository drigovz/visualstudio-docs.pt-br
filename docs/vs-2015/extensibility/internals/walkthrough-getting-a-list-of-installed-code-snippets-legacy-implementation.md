---
title: 'Walkthrough: obtendo uma lista de trechos de código instalados (implementação herdada) | Microsoft Docs'
ms.date: 11/15/2016
...
> [!NOTE]
> A `expansionsList` lista de matrizes armazena em cache por motivos de desempenho. As alterações nos trechos de código não são refletidas na lista até que o serviço de idioma seja interrompido e recarregado (por exemplo, interrompendo e reiniciando [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ).  
