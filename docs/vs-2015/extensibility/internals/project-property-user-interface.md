...
- Um subtipo de projeto pode determinar as CATIDs apropriadas para os vários objetos extensíveis do projeto base em tempo de execução, recuperando os seguintes <xref:Microsoft.VisualStudio.Shell.Interop.__VSHPROPID2> valores:  
