...
## <a name="see-also"></a>Consulte também
 [Adicionando um controlador de Menu a uma barra de ferramentas](../../extensibility/adding-a-menu-controller-to-a-toolbar.md) [adicionando uma barra de ferramentas para uma janela de ferramentas](../../extensibility/adding-a-toolbar-to-a-tool-window.md) [GUIDs e IDs de Menus do Visual Studio](../../extensibility/internals/guids-and-ids-of-visual-studio-menus.md)
