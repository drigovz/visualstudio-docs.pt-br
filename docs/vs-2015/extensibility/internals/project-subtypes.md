...
ms.locfileid: "90838290"
---
# <a name="project-subtypes"></a>Subtipos de projeto
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Os subtipos de projeto permitem que você personalize ou represente o comportamento dos sistemas de projeto do [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] . As personalizações incluem salvar dados adicionais no arquivo de projeto, adicionar ou filtrar itens na caixa de diálogo **Adicionar novo item** , controlar como os assemblies são depurados e implantados e estender a caixa de diálogo **páginas de propriedades** do projeto. VSPackages implementar subtipos de projeto usando agregação COM.  
  
> [!NOTE]
> O sistema de projeto Visual C++ não oferece suporte a subtipos de projeto. [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] Ele usa subtipos de projeto para implementar SQL Server e projetos de dispositivo inteligente.  
...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Descreve a sequência de inicialização de subtipo de projeto programático por [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ambiente.  
...
## <a name="related-sections"></a>Seções relacionadas  
 ...
 Fornece links para tópicos que detalham [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] projetos.
