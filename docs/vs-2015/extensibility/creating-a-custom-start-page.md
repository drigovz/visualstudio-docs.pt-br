...
## <a name="see-also"></a>Consulte também  
 ...
 [Passo a passo: Salvando as configurações de usuário em uma página inicial](../extensibility/walkthrough-saving-user-settings-on-a-start-page.md)   
