---
title: 'Como: Configurar análise de código para um projeto de código gerenciado | Microsoft Docs'
ms.date: 11/15/2016
...
## <a name="see-also"></a>Consulte também  
 [Passo a passo: Configurando e usando uma regra personalizada definida](../code-quality/walkthrough-configuring-and-using-a-custom-rule-set.md)
