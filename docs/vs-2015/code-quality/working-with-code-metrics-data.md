...
## <a name="BKMK_AddingRemovingandRearrangingDataColumns"></a>Adicionando, removendo e reorganizando colunas de dados
...
## <a name="BKMK_Copying_Data_to_the_Clipboard_or_Excel"></a>Copiando dados para a área de transferência ou Excel
...
## <a name="BKMK_Creating_a_Work_Item_Based_on_Code_Metric_Results"></a>Criando um item de trabalho com base nos resultados da métrica de código
 Você pode criar um [!INCLUDE[esprfound](../includes/esprfound-md.md)] item de trabalho com base nos resultados na janela **resultados da métrica de código** . Quando o item de trabalho é criado, [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] insere automaticamente um título no campo **título** e dados de métricas de código na guia **histórico** .
