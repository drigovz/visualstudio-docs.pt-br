...
> Este tópico aplica-se somente ao Visual Studio 2015 atualização 3 RC e posterior.
 ...
 A *análise de solução completa* é um recurso do Visual Studio que permite escolher se você vê problemas de análise de código somente em arquivos abertos do Visual c# ou Visual Basic em sua solução ou em arquivos do Visual c# ou Visual Basic abertos e fechados em sua solução.
...
2. Na caixa de diálogo **Opções** , escolha **Editor de texto** &#124; **C#** ou **Basic** &#124; **avançado**.
...
## <a name="additional-details"></a>Detalhes adicionais
 Por padrão, a análise de solução completa é habilitada para Visual Basic e desabilitada para o Visual C#.
