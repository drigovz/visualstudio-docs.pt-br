...
- O modo de baixa latência de GC ( [coleta](https://msdn.microsoft.com/library/22b6cb97-0c80-4eeb-a2cf-5ed7655e37f9) de lixo C# ) para Visual e Visual Basic estão desabilitados.
