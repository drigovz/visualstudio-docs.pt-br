...
## <a name="cause"></a>Causa
 Um tipo público ou protegido contém campos públicos e é protegido por um [demandas de Link](https://msdn.microsoft.com/library/a33fd5f9-2de9-4653-a4f0-d9df25082c4d).
