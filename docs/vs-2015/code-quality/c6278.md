...
Aviso C6278: \<variável > é alocado com new [] de matriz, mas excluída com scalar delete. Destruidores não serão chamados  
 ...
 Esse aviso será exibida apenas na C++ de código e indica que a função de chamada atribuiu memória com a matriz **new []** operador, mas foi liberada com o escalar **excluir** operador. Isso é um comportamento indefinido de acordo com o padrão C++ e a implementação do Microsoft Visual C++. Há pelo menos três motivos que podem causar problemas:  
