...
## <a name="in-this-section"></a>Nesta seção
 ...
 [Compatibilidade de versão para políticas de check-in de análise de código](../code-quality/version-compatibility-for-code-analysis-check-in-policies.md) Explica os problemas de compatibilidade de verificação de análise de código entre as versões do [!INCLUDE[vstsLong](../includes/vstslong-md.md)].
...
## <a name="related-sections"></a>Seções relacionadas
 [Definir e impor Gates de qualidade](https://msdn.microsoft.com/library/bdc5666e-6cf0-45b2-a0a1-133c3f61e852)
