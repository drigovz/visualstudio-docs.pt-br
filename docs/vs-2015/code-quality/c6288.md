...
aviso C6288: operador incorreto: a inclusão mútua em && é sempre zero. Você tentou usar &#124;&#124; em vez disso?  
 ...
 Esse problema é geralmente causado pelo uso `&&` de; no lugar de `||` , mas também pode ser causado pelo uso de `==` onde `!=` foi pretendido.  
