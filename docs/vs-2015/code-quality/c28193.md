...
aviso C28193: a variável contém um valor que deve ser examinado  
 ...
 Use um `#pragma` aviso para suprimir o aviso – se, ao reordenar o código, você tornaria o código muito complexo ou, de outra forma, menos útil.  
