...
A análise de código usa um dicionário interno para verificar identificadores em seu código em busca de erros de ortografia, caso gramatical e outras convenções de nomenclatura das [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] diretrizes. Você pode criar um arquivo XML de dicionário personalizado para adicionar, remover ou modificar termos, abreviações e acrônimos para o dicionário interno.
