...
|[Usando os verificadores de diretrizes de núcleo do C++](../code-quality/using-the-cpp-core-guidelines-checkers.md)|Adicione os verificadores de diretrizes principais do C++ ao seu projeto.|  
...
|[Instruções passo a passo: analisando o código do C/C++ em busca de defeitos](../code-quality/walkthrough-analyzing-c-cpp-code-for-defects.md)|Obter experiência prática pela execução de análise de código em um projeto C/C++.|  
