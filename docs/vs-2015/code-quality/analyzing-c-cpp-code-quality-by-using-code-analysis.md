...
|[Passo a passo: Analisando código C/C++ em busca de defeitos](../code-quality/walkthrough-analyzing-c-cpp-code-for-defects.md)|Obter experiência prática pela execução de análise de código em um projeto C/C++.|  
