...
aviso C6333: parâmetro inválido: não é permitido passar MEM_RELEASE e um parâmetro de dwSize diferente de zero para \<function> . Isso resulta na falha dessa chamada  
