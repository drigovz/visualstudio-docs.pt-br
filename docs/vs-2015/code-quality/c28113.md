...
warning C28113: Acessando uma variável local por meio de uma função sincronizada  
 ...
 O driver está usando uma rotina de suporte executivo Interlocked, tais como [InterlockedDecrement](https://msdn.microsoft.com/library/windows/hardware/ff547871.aspx), para acessar uma variável local.  
