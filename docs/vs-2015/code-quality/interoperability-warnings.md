...
|[CA1415: declarar P/Invokes corretamente](../code-quality/ca1415-declare-p-invokes-correctly.md)|Essa regra procura declarações de método de invocação de plataforma que se destinam a [!INCLUDE[TLA2#tla_win32](../includes/tla2sharptla-win32-md.md)] funções que têm um ponteiro para um parâmetro de estrutura SOBREPOSTA e o parâmetro gerenciado correspondente não é um ponteiro para uma estrutura de <xref:System.Threading.NativeOverlapped?displayProperty=fullName>.|
