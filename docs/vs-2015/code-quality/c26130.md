...
ms.locfileid: "51751799"
---
# <a name="c26130"></a>C26130
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Aviso C26130: anotação ausente \_Requires_lock_held\_(\<bloqueio >) ou \_No_competing_thread\_ na função \<func >. Caso contrário, ele pode ser uma condição de corrida. Variável \<var > devem ser protegidos pelo bloqueio \<bloqueio >.  
