...
ms.locfileid: "62577535"
---
# <a name="c26130"></a>C26130
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

warning C26130: Anotação ausente \_Requires_lock_held\_(\<bloqueio >) ou \_No_competing_thread\_ na função \<func >. Caso contrário, ele pode ser uma condição de corrida. Variável \<var > devem ser protegidos pelo bloqueio \<bloqueio >.  
