...
- Na janela **resultados de métricas de código** , clique no botão **métricas de CalculateCode para solução** .
     ...
     Os resultados são gerados e a janela **resultados de métricas de código** é exibida.
...
### <a name="to-view-the-results-details"></a>Para exibir os detalhes dos resultados
