...
Para a documentação mais recente do Visual Studio, consulte [CA1500: Nomes de variáveis não devem corresponder aos nomes de campo](https://docs.microsoft.com/visualstudio/code-quality/ca1500-variable-names-should-not-match-field-names) em docs.microsoft.com.  
