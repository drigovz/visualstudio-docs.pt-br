...
## <a name="configure-rule-sets-for-a-project"></a><a name="BKMK_ConfigureRuleSets"></a> Configurar conjuntos de regras para um projeto  
...
2. As etapas a seguir são opcionais:  
    ...
    2. Por padrão, a análise de código não relata avisos do código que é gerado automaticamente por ferramentas externas. Para exibir avisos do código gerado, desmarque a caixa de seleção **suprimir resultados do código gerado** .  
...
4. Na lista **executar este conjunto de regras** , siga um destes procedimentos:  
    ...
    - Escolha **\<Browse...>** especificar um conjunto de regras personalizadas existente que não esteja na lista.  
...
### <a name="standard-cc-rule-sets"></a>Conjuntos de regras padrão do C/C++  
...
## <a name="run-code-analysis"></a><a name="BKMK_Run"></a> Executar análise de código  
...
## <a name="analyze-and-resolve-code-analysis-warnings"></a><a name="BKMK_Analyze"></a> Analisar e resolver avisos de análise de código  
...
## <a name="creating-work-items-for-code-analysis-warnings"></a><a name="BKMK_Creating_work_items_for_code_analysis_warnings"></a> Criando itens de trabalho para avisos de análise de código  
 ...
 **Para criar um item de trabalho para um ou mais avisos de código do C/C++**  
