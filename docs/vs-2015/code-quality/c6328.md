...
```  
 ...
 `c` seria estendido com sinal para com um sinal `int` com um valor de -37, que está fora do intervalo válido para [isspace](https://msdn.microsoft.com/library/3ac254c4-92aa-4238-882a-3a3fb576cdf5).  
