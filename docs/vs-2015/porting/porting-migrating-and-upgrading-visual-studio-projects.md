...
## <a name="projects"></a><a name="project"></a> Projeto
...
|Outro|É possível abrir a maioria dos outros tipos de projetos no Visual Studio 2012, no Visual Studio 2013 e no Visual Studio 2010 SP1.|
...
## <a name="files"></a><a name="file"></a> Arquivos
...
## <a name="integration-assets"></a><a name="integration"></a> Ativos de integração
