---
title: Configurações de projeto para uma configuração de depuração de Visual Basic | Microsoft Docs
ms.date: 11/15/2016
...
|**Usar computador remoto**|Quando a caixa de seleção está marcada, a depuração remota é habilitada. Na caixa de texto, digite o nome de um computador remoto no qual o aplicativo será executado para fins de depuração ou um [Nome do servidor Msvsmon](https://msdn.microsoft.com/library/55b60ce7-834b-4e83-a10e-fe4248260a4c). O local do EXE no computador remoto é especificado pela propriedade caminho de saída na guia compilar. O local deve ser um diretório compartilhável no computador remoto.|  
