...
> [!IMPORTANT]
> Se você acredita ter recebido esta mensagem devido a um bug do produto, relate esse problema para o Visual Studio [enviar um Smiley](https://msdn.microsoft.com/library/5cc9b67a-54d0-41b0-aa8f-80dff4475a6b). Se você precisar de mais ajuda, consulte [Fale conosco](../ide/talk-to-us.md) maneiras de entrar em contato com a Microsoft.  
