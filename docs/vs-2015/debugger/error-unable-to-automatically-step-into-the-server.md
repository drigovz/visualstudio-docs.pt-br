...
- Uma versão do [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] foi instalada depois que o Visual Studio foi instalado. [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] deve ser instalado antes do Visual Studio. Para corrigir esse problema, use o **painel de controle**do Windows, **programas e recursos** para reparar a instalação do Visual Studio.  
