...
Essa caixa de diálogo aparece quando você fez alterações no código nativo que **Editar e Continuar** não pôde aplicar imediatamente. Como resultado, alguns códigos nativos no quadro de pilhas atual agora está expirado, ou seja, obsoleto. Para obter mais informações, confira [Como: Trabalhar com código obsoleto](https://msdn.microsoft.com/c7536e95-66a6-44a0-995d-3fe5035250b4).  
