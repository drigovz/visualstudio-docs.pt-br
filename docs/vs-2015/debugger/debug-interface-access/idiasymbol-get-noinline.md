...
Recupera um sinalizador que especifica se a função foi marcada como não sendo embutido (usando o [noinline](https://msdn.microsoft.com/library/f259d55b-dec7-4bde-8cf9-14521e4fdc42) atributo).  
