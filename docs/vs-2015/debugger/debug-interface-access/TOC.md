# [SDK de Acesso à Interface de Depuração](debug-interface-access-sdk.md)
## [Introdução](getting-started-debug-interface-access-sdk.md)
### [Visão geral](overview-debug-interface-access-sdk.md)
### [Consultando o arquivo .Pdb](querying-the-dot-pdb-file.md)
## [Símbolos e marcações de símbolos](symbols-and-symbol-tags.md)
### [Locais de símbolos](symbol-locations.md)
### [Hierarquia lexical de tipos de símbolo](lexical-hierarchy-of-symbol-types.md)
#### [Anotação](annotation.md)
#### [Bloco](block.md)
#### [Compiland](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [Custom (SDK de Acesso à Interface de Depuração)](custom-debug-interface-access-sdk.md)
#### [Dados (SDK de Acesso à Interface de Depuração)](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [Função (SDK de Acesso à Interface de Depuração)](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [Rótulo (SDK de Acesso à Interface de Depuração)](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [Conversão](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [Hierarquia de classes de tipos de símbolo](class-hierarchy-of-symbol-types.md)
...
#### [Typedef (SDK de Acesso à Interface de Depuração)](typedef-debug-interface-access-sdk.md)
#### [UDT](udt.md)
#### [VTable](vtable.md)
#### [VTableShape](vtableshape.md)
## [Referência](debug-interface-access-sdk-reference.md)
### [Interfaces (SDK de Acesso à Interface de Depuração)](interfaces-debug-interface-access-sdk.md)
...
### [Enumerações e estruturas](enumerations-and-structures.md)
#### [Enumeração BasicType](basictype.md)
#### [Enumeração CV_access_e](cv-access-e.md)
#### [Enumeração CV_call_e](cv-call-e.md)
#### [Enumeração CV_CFL_LANG](cv-cfl-lang.md)
#### [Enumeração CV_CPU_TYPE_e](cv-cpu-type-e.md)
#### [Enumeração CV_HREG_e](cv-hreg-e.md)
#### [Enumeração DataKind](datakind.md)
#### [Estrutura DiaAddressMapEntry](diaaddressmapentry.md)
#### [Enumeração LocationType](locationtype.md)
#### [Enumeração MemoryTypeEnum](memorytypeenum.md)
#### [Enumeração NameSearchOptions](namesearchoptions.md)
#### [Enumeração StackFrameTypeEnum](stackframetypeenum.md)
#### [Enumeração SymTagEnum](symtagenum.md)
#### [Enumeração THUNK_ORDINAL](thunk-ordinal.md)
#### [Enumeração UdtKind](udtkind.md)
