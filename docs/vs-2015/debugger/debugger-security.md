...
### <a name="remote-debugging-security"></a>Segurança de depuração remota  
 ...
 ![Diálogo de erro](../debugger/media/dbg-err-remotepermissionschanged.png "DBG_ERR_RemotePermissionsChanged")  
