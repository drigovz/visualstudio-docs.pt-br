...
|**Window**|**Tecla de atalho**|**Confira o tópico**|  
|-|-|-|  
...
|Auto|CTRL+ALT+V, A|[Janelas de Variáveis](https://msdn.microsoft.com/library/ce0a67f6-2502-4b7a-ba45-cc32f8aeba3e)|  
...
|Interativo de depuração do Python|SHIFT + ALT + I|[Introdução ao PTVS: Python interativo](../python/getting-started-with-ptvs-interactive-python.md)|  
