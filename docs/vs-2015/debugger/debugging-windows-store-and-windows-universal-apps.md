---
title: Depuração da Windows Store e de aplicativos do Windows universal | Microsoft Docs
ms.date: 11/15/2016
...
O depurador do Visual Studio fornece suporte completo para depuração de aplicativos da Windows Store.  
 ...
 Para depurar Windows Phone aplicativos, consulte [depuração de aplicativos para Windows Phone 8](https://msdn.microsoft.com/library/windows/apps/ff402572\(v=vs.105\).aspx).  
