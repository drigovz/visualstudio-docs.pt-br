...
## <a name="see-also"></a>Consulte Também  
 ...
 [Iniciar a depuração de GPU no Visual Studio](https://docs.microsoft.com/archive/blogs/nativeconcurrency/start-gpu-debugging-in-visual-studio-2012)
