...
Define por sua presença se uma instância padrão da classe de [classe VsgDbg](../debugger/vsgdbg-class.md) , que fornece a interface de captura programática, é fornecida.  
