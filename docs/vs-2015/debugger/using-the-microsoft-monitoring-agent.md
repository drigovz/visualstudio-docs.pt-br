...
1.  Verifique se:  
    ...
    -   Seu servidor web está em execução [suporte para versões do Internet Information Services (IIS)](http://technet.microsoft.com/library/dn465154.aspx).  
