...
A janela Histórico de pixels de gráficos no Analisador de Gráficos do Visual Studio ajuda a entender como um pixel específico é afetado pelos eventos do Direct3D que ocorrem durante um quadro de seu jogo ou aplicativo.  
 ...
 ![Um pixel com três eventos do Direct3D em seu histórico.](../debugger/media/gfx-diag-demo-pixel-history-orientation.png "gfx_diag_demo_pixel_history_orientation")  
...
## <a name="see-also"></a>Consulte Também  
 [Walkthrough: objetos ausentes devido ao estado do dispositivo](../debugger/walkthrough-missing-objects-due-to-device-state.md)   
