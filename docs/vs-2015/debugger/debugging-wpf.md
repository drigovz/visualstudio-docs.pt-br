...
|[Como: Exibir informações de rastreamento do WPF](../debugger/how-to-display-wpf-trace-information.md)|O [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] pode receber informações de rastreamento de depuração de aplicativos do WPF e exibir essas informações na janela de **Saída**. Este tópico descreve como habilitar e personalizar a exibição de informações de rastreamento do WPF.|  
