...
> [!NOTE]
> Clique aqui para obter notas de lançamento para [visual studio 2015 atualização 3](https://docs.microsoft.com/visualstudio/releasenotes/vs2015-update3-vs).
>
> Clique aqui para obter as notas de versão do [Visual Studio 2017](https://www.visualstudio.com/news/releasenotes/vs2017-relnotes).
 ...
 Baixe [Visual Studio Community 2015](https://visualstudio.microsoft.com/vs/older-downloads/) gratuitamente para começar a codificação imediatamente. Se desejar fazer desenvolvimento multiplataforma, não deixe de instalar os pacotes opcionais. Você pode obter mais recursos com visual studio professional ou Visual Studio Enterprise.

 Pule, crie um novo projeto e comece a escrever código. Escolha o tipo de aplicativo que você deseja criar. Ou você pode fazer um tour pelo [Visual Studio IDE](./ide/visual-studio-ide.md) para se familiarizar com as ferramentas.

 E não se esqueça de explorar nossa [galeria de códigos](https://code.msdn.microsoft.com/) para encontrar amostras para ajudá-lo a escrever seu aplicativo mais rapidamente!

 É possível instalar o Visual Studio 2015 baixando-o em [Downloads do Visual Studio](https://visualstudio.microsoft.com/vs/older-downloads/). Para saber mais sobre o processo de instalação, consulte [Install Visual Studio 2015](./install/install-visual-studio-2015.md).
...
## <a name="extend-visual-studio"></a>Estenda o Visual Studio
 ...
 Você pode usar a [Plataforma de Compilação .NET (Roslyn)](https://github.com/dotnet/Roslyn) para escrever seus próprios analisadores de código e geradores de código. 

 Encontre extensões para o Visual Studio IDE no [Visual Studio Marketplace](https://visualstudiogallery.msdn.microsoft.com/). As extensões no Marketplace são criadas por desenvolvedores da Microsoft, bem como por nossa comunidade de desenvolvimento.

## <a name="build-apps-for-android-ios-and-windows"></a>Crie aplicativos para Android, iOS e Windows
 Você pode usar o Visual Studio para compilar aplicativos para dispositivos Android, iOS e Windows. Saiba mais sobre [o Desenvolvimento Móvel Multiplataforma no Visual Studio](./cross-platform/cross-platform-mobile-development-in-visual-studio.md).

 Para obter informações sobre o Universal Windows Apps (UWP), consulte [o que é um aplicativo universal da Plataforma Windows (UWP) ?](https://docs.microsoft.com/windows/uwp/get-started/universal-application-platform-guide).
...
- [Apache Cordova com Visual Studio](https://msdn.microsoft.com/library/db446f2c-6ba4-4c76-aac5-4c66f43b8c42): Uma base de código comum para HTML, CSS e JavaScript ou Typescript

- [Visual Studio Tools for Unity](./cross-platform/visual-studio-tools-for-unity.md): desenvolvimento de jogos 2D/3D em C #

- [C++ para Desenvolvimento Móvel Multiplataforma](./cross-platform/visual-cpp-for-cross-platform-mobile-development.md): Bibliotecas e aplicativos de código compartilhado em C++

- [Visual Studio Emulador para Android](./cross-platform/visual-studio-emulator-for-android.md): Visual Studio Emmulator para Android: Depurar e testar seus aplicativos android não importa o IDE

## <a name="connect-your-apps-to-services"></a>Conecte aplicativos a serviços
 Você pode se conectar a esses serviços fora da caixa (assumindo que você tenha uma conta para cada serviço):

- [Aplicativos Móveis do Azure](https://azure.microsoft.com/documentation/services/mobile-services/)

- [Armazenamento do Azure](https://azure.microsoft.com/documentation/services/storage/)

- Integre as APIs do Office 365 REST em seu próprio aplicativo para se conectar aos dados armazenados na nuvem. Para obter mais informações, confira [estes exemplos](https://docs.microsoft.com/samples/browse/?products=office-365&term=REST).

## <a name="write-great-web-apps-with-aspnet"></a>Escreva ótimos aplicativos web com ASP.NET
 [ASP.NET 5](https://docs.microsoft.com/aspnet/core/?view=aspnetcore-3.0) é uma grande atualização para MVC, WebAPI e SignalR, e é executada no Windows, Mac e Linux.  ASP.NET foi projetado do zero para fornecer uma pilha .NET enxuta e compostável para a construção de aplicativos e serviços web modernos baseados em nuvem.
...
### <a name="test-your-app"></a>Testar seu aplicativo
 ...
 Planeje, crie e execute testes manuais e automatizados para o seu aplicativo. Os planos, os conjuntos, os casos e os resultados de teste são armazenados na nuvem com o Visual Studio Team Services ou localmente com o Team Foundation Server. Saiba mais sobre como [testar o aplicativo](https://msdn.microsoft.com/library/73baa961-c21f-43fe-bb92-3f59ae9b5945).
...
|||||
|-|-|-|-|
|[Novidades do Visual Studio 2015](./what-s-new-in-visual-studio-2015.md)|[O que há de novo para C #](https://msdn.microsoft.com/library/9f18dc26-27fa-4603-a639-b573f07a117b)|[O que há de novo no .NET Framework](https://msdn.microsoft.com/library/1d971dd7-10fc-4692-8dac-30ca308fc0fa)|[O que há de novo para o Azure DevOps Server](/azure/devops/server/whats-new)|
|[O que há de novo para C++](https://docs.microsoft.com/previous-versions/hh409293(v=vs.140))|[O que há de novo no Visual Basic](https://msdn.microsoft.com/library/d7e97396-7f42-4873-a81c-4ebcc4b6ca02)|[O que há de novo para JavaScript](https://docs.microsoft.com/visualstudio/javascript/javascript-in-visual-studio?view=vs-2015#whats-new-in-javascript)||
