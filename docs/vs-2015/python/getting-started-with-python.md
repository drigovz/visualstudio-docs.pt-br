...
[Introdução com PTVS: Configurando o Visual Studio](../python/getting-started-with-ptvs-setting-up-visual-studio.md) 
 [Introdução com PTVS: iniciar codificação (projetos)](../python/getting-started-with-ptvs-start-coding-projects.md) 
 [Introdução com PTVS: código](../python/getting-started-with-ptvs-editing-code.md) 
 de edição [Introdução com PTVS: Debugging](../python/getting-started-with-ptvs-debugging.md) 
 [Introdução com PTVS: Python interativo](../python/getting-started-with-ptvs-interactive-python.md) 
 [Introdução com PTVS: Criando um site no Azure](../python/getting-started-with-ptvs-building-a-website-in-azure.md)
