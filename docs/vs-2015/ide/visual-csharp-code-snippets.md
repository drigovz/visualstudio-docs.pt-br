...
|para|Cria um loop [for](https://msdn.microsoft.com/library/34041a40-2c87-467a-9ffb-a0417d8f67a8).|Dentro de um método, um indexador, um acessador de propriedade ou um acessador de evento.|
...
|lock|Cria um bloco [lock](https://msdn.microsoft.com/library/656da1a4-707e-4ef6-9c6e-6d13b646af42).|Dentro de um método, um indexador, um acessador de propriedade ou um acessador de evento.|
...
|sim|Cria uma declaração de método principal [static](https://msdn.microsoft.com/library/5509e215-2183-4da3-bab4-6b7e607a4fdf)[int](https://msdn.microsoft.com/library/212447b4-5d2a-41aa-88ab-84fe710bdb52).|Dentro de uma classe ou um struct.|
...
|svm|Cria uma declaração de método principal [static](https://msdn.microsoft.com/library/5509e215-2183-4da3-bab4-6b7e607a4fdf)[void](https://msdn.microsoft.com/library/0d2d8a95-fe20-4fbd-bf5d-c1e54bce71d4).|Dentro de uma classe ou um struct.|
...
|experimentar|Cria um bloco [try-catch](https://msdn.microsoft.com/library/cb5503c7-bfa1-4610-8fc2-ddcd2e84c438).|Dentro de um método, um indexador, um acessador de propriedade ou um acessador de evento.|
...
## <a name="see-also"></a>Consulte Também
 [Code Snippet Functions](../ide/code-snippet-functions.md) [Trechos](../ide/code-snippets.md) de código de códigos de funções de trecho de código [como: criar um novo trecho com parâmetros de](https://msdn.microsoft.com/8d56d43c-097a-475b-aa85-cae1554b6338) [modelo](../ide/template-parameters.md) de substituição [como: usar trechos de código surround](../ide/how-to-use-surround-with-code-snippets.md) como [: restaurar trechos de refatoração de C#](../ide/how-to-restore-csharp-refactoring-snippets.md)
