...
### <a name="add-using"></a>Adicionar usando
 ...
 ![Adicionar usando imagem de marca inteligente](../ide/media/addusesmart.gif "AddUseSmart")
 ...
 ![Adicionar usando, imagem expandida de marca inteligente](../ide/media/addusesmartexp.gif "AddUseSmartExp")
