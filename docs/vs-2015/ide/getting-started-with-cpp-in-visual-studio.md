...
## <a name="sign-in-to-visual-studio"></a><a name="BKMK_Configure"></a> Entrar no Visual Studio
 ...
 ![Configurações do IDE com o Visual C&#43;&#43; aplicadas](../ide/media/c-ide-defaultenvironmentlayout.png "IDE_DefaultEnvironmentLayout c++")
...
2. Na categoria **Visual C++**, escolha o modelo **Aplicativo do Console Win32** e nomeie o projeto como `GreetingsConsoleApp`.
    ...
    ![Modelo Aplicativo do Console Win32](../ide/media/c-ide-newprojectdlg.png "IDE_NewProjectDlg c++")

3. Quando o Assistente de Aplicativo Win32 aparecer, escolha o botão **Finalizar**.

    ![Assistente de aplicativo de console do Win32](../ide/media/c-ide-win32consoleappwizard.png "IDE_Win32ConsoleAppWizard c++")
   ...
   ![Arquivos para a solução no Gerenciador de Soluções](../ide/media/c-ide-solutioncontents.png "IDE_SolutionContents c++")

## <a name="add-code-to-the-application"></a><a name="BKMK_AddCode"></a> Adicionar código ao aplicativo
...
1. No arquivo GreetingsConsoleApp.cpp, insira uma linha em branco antes da linha `return 0;` e então insira o código a seguir:
    ...
    ```
     ...
     ![Texto de erro para o cout](../ide/media/c-ide-couterror.png "IDE_CoutError c++")
     ...
     [cout](https://msdn.microsoft.com/library/d87db6c3-e4e1-4d09-9ec5-458f55018257) está incluído no \<iostream\> arquivo de cabeçalho.
...
3. Salve as alterações no arquivo.
     ...
     ![Código que corrige o erro cout](../ide/media/c-ide-coutfix.png "IDE_CoutFix c++")
...
2. Pressione a tecla F5 para iniciar a depuração.
    ...
    ![Texto de saudação na janela do prompt de comando do Windows](../ide/media/c-ide-hellocommandwindow.png "IDE_HelloCommandWindow c++")
...
## <a name="build-a-release-version-of-the-app"></a><a name="BKMK_BuildRelease"></a> Criar uma versão de lançamento do aplicativo
...
2. Altere a configuração de build para GreetingsConsoleApp de **Depuração** para **Versão**.
    ...
    ![Criar uma versão de lançamento do aplicativo](../ide/media/c-ide-changingbuildtorelease.png "IDE_ChangingBuildtoRelease c++")
