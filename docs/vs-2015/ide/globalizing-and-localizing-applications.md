...
## <a name="related-sections"></a>Seções relacionadas
 [Globalizando seu aplicativo (aplicativos da Windows Store usando JavaScript e HTML)](https://msdn.microsoft.com/library/windows/apps/hh465006.aspx) Contém tópicos de instruções e diretrizes para ajudá-lo a globalizar e localizar seu [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] aplicativo criado usando JavaScript e HTML.

 [Globalizando seu aplicativo (aplicativos da Windows Store usando C#/VB/C + + e XAML)](https://msdn.microsoft.com/library/windows/apps/xaml/Hh965328(v=win.10).aspx) Contém tópicos de instruções e diretrizes para ajudá-lo a globalizar e localizar seu [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] aplicativo criado usando XAML e Visual C#, Visual Basic ou Visual C++.
 ...
 <xref:System.Resources> Indica as classes e interfaces neste namespace, que permite aos desenvolvedores criar, armazenar e gerenciar vários recursos específicos de cultura usados em um aplicativo.
