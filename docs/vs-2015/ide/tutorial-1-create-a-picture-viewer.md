...
- Escrever métodos de manipulador de eventos.
  ...
  ![link para vídeo](../data-tools/media/playvideo.gif "PlayVideo") Para obter uma versão de vídeo deste tópico, consulte [como faço para: criar um visualizador de imagem no Visual Basic?](https://msdn.microsoft.com/vstudio/gg315352) ou como faço para [: criar um visualizador de imagem em C#?](https://msdn.microsoft.com/vcsharp/gg278960.aspx).
...
>
> Para ver o código para Visual Basic, escolha a guia **VB** na parte superior dos blocos de código e para ver o código do Visual C#, escolha a guia **C#** . Se você estiver interessado em aprender sobre o Visual C++, consulte o [tutorial de linguagem](http://www.cplusplus.com/doc/tutorial/)do [introdução](../misc/getting-started-with-visual-cpp-in-visual-studio-2015.md) e do C++.
>
...
|[Etapa 3: definir suas propriedades de formulário](../ide/step-3-set-your-form-properties.md)|Altere a aparência do seu formulário usando a janela **Propriedades**.|
|[Etapa 4: dispor o formulário com um controle TableLayoutPanel](../ide/step-4-lay-out-your-form-with-a-tablelayoutpanel-control.md)|Adicione um controle `TableLayoutPanel` ao seu formulário.|
...
|[Etapa 7: adicionar componentes de caixa de diálogo ao formulário](../ide/step-7-add-dialog-components-to-your-form.md)|Adicione um componente **OpenFileDialog** e um componente **ColorDialog** ao seu formulário.|
...
|[Etapa 9: revisar, comentar e testar seu código](../ide/step-9-review-comment-and-test-your-code.md)|Revise e teste seu código. Adicionar comentários quando necessário.|
