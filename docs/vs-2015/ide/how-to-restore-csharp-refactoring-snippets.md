...
## <a name="see-also"></a>Veja também
 [C# ](../ide/visual-csharp-code-snippets.md) [Trechos de código](../ide/code-snippets.md) [de refatoraçãoC#() de](../csharp-ide/refactoring-csharp.md) trechos de código Visual
