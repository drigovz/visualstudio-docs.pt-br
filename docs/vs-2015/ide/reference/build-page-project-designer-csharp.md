 ...
 **Símbolos de compilação condicional** Especifica os símbolos nos quais a compilação condicional deve ser executada. Separe símbolos com um ponto-e-vírgula (“;”). Para obter mais informações, consulte [/define (opções do compilador C#)](https://msdn.microsoft.com/library/f17d7b4d-82d0-4133-8563-68cced1cac6e).
 ...
 **CPU de destino** Especifica o processador a ser direcionado pelo arquivo de saída. Escolha **x86** para qualquer processador compatível com Intel de 32 bits, **x64** para qualquer processador compatível com Intel de 64 bits, **ARM** para processadores ARM ou **Qualquer CPU** para especificar que qualquer processador é aceitável. **Qualquer CPU** é o valor padrão para projetos, pois permite que o aplicativo seja executado em uma ampla variedade de hardwares.
...
- Na **Página Aplicativo**, a lista **Estrutura de destino** especifica o .NET Framework 4.5.
  ...
  **Permitir código inseguro** Permite que o código que usa palavra-chave [unsafe](https://msdn.microsoft.com/library/7e818009-1c6e-4b9e-b769-3728a01586a0) seja compilado. Para obter mais informações, consulte [/unsafe (opções do compilador C#)](https://msdn.microsoft.com/library/fdb77ed9-da03-45bd-bb7f-250704da1bcc).
 ...
 **Suprimir avisos** Bloqueia a capacidade do compilador de gerar um ou mais avisos. Separe vários números de aviso com uma vírgula ou um ponto-e-vírgula. Para obter mais informações, consulte [/nowarn (opções do compilador C#)](https://msdn.microsoft.com/library/6dcbc5e8-ae67-4566-9df3-f63cfdd9c4e4).
 ...
 **Arquivo da documentação XML** Especifica o nome de um arquivo no qual os comentários da documentação serão processados. Para obter mais informações, consulte [/doc (opções do compilador C#)](https://msdn.microsoft.com/library/849eea59-c936-4311-bad8-d07404480f2a).
