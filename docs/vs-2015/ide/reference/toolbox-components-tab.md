 ...
 **Timer**  
 Cria uma instância do componente <xref:System.Windows.Forms.Timer>, que pode ser usada para adicionar funcionalidade baseada em tempo aos aplicativos baseados no Windows. Para obter mais informações, consulte [Componente de temporizador](https://msdn.microsoft.com/library/6700e534-6382-43d5-98ed-14205435fff7).  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Passo a passo da programação de componentes](https://msdn.microsoft.com/library/373cacf7-479e-4b05-991c-5cb18824e913)   
