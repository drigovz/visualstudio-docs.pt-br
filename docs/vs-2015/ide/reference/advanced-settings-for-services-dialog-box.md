...
## <a name="task-list"></a>Lista de Tarefas
 ...
 [Como: Trabalhar offline com Serviços de Aplicativos de cliente ](https://msdn.microsoft.com/f792cb16-8520-4a0f-9dc9-07bfbc454e38)

## <a name="uielement-list"></a>Lista UIElement
 **Salvar hash de senha localmente para habilitar logon offline** Especifica se um formato criptografado da senha do usuário será armazenado em cache localmente para permitir que o usuário faça logon quando o aplicativo estiver no modo offline. Para obter mais informações, confira [Como: Trabalhe offline com o cliente Serviços de Aplicativos ](https://msdn.microsoft.com/f792cb16-8520-4a0f-9dc9-07bfbc454e38). Essa opção é habilitada por padrão.
...
## <a name="see-also"></a>Consulte também
 [Página de serviços, Designer de projeto](../../ide/reference/services-page-project-designer.md) [de serviços de aplicativos de cliente](https://msdn.microsoft.com/library/1487d8df-089e-4f21-abfb-a791a652b58e) [How para: Configurar [How de ](https://msdn.microsoft.com/library/34a8688a-a32c-40d3-94be-c8e610c6a4e8) de cliente Serviços de Aplicativos para: Trabalhar offline com Serviços de Aplicativos de cliente](https://msdn.microsoft.com/f792cb16-8520-4a0f-9dc9-07bfbc454e38)
