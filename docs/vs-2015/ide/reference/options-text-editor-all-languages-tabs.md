...
## <a name="tabs"></a>Tabulações
 Tamanho da tabulação Define a distância em espaços entre paradas de tabulação. O padrão é quatro espaços.

 Tamanho do recuo Define o tamanho em espaços de um recuo automático. O padrão é quatro espaços. Caracteres de tabulação, caracteres de espaço ou ambos serão inseridos para preencher o tamanho especificado.
