 ...
 **Namespace padrão** Especifica o namespace base para os arquivos adicionados ao projeto.
 ...
 **Estrutura de destino** Especifica a versão do .NET Framework de destino do aplicativo. Essa opção pode ter valores diferentes dependendo de quais versões do .NET Framework estão instaladas em seu computador.
 ...
 **Ícone e manifesto** Por padrão, esse botão de opção é selecionado e as opções **Ícone** e **Manifesto** são habilitadas. Isso permite selecionar seu próprio ícone ou diferentes opções de geração de manifesto. Deixe esse botão de opção selecionado, a menos que você esteja fornecendo um arquivo de recurso para o projeto.
