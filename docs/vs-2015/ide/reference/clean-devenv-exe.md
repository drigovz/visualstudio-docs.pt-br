...
## <a name="arguments"></a>Argumentos
 `FileName` Necessário. O caminho completo e o nome do arquivo da solução ou do arquivo de projeto.
 ...
 /projectconfig `ProjConfigName` Opcional. O nome de uma configuração de build do projeto a ser usado ao limpar o `/project` nomeado.
...
## <a name="see-also"></a>Consulte Também
 [Opções de linha de comando do devenv](../../ide/reference/devenv-command-line-switches.md) [/Build (devenv.exe)](../../ide/reference/build-devenv-exe.md) [/Rebuild (devenv.exe)](../../ide/reference/rebuild-devenv-exe.md) [/out (devenv.exe)](../../ide/reference/out-devenv-exe.md)
