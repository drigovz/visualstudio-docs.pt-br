...
- **default**  
  ...
  **Verificar estouro/estouro negativo aritmético**  
  Especifica se uma instrução de aritmética de inteiros que não está no escopo das palavras-chave [marcadas](https://msdn.microsoft.com/library/718a1194-988d-48a3-b089-d6ee8bd1608d) ou [desmarcadas](https://msdn.microsoft.com/library/0c021f7c-923f-4b3d-a58f-55336f5ac27e) e que resulta em um valor fora do intervalo do tipo de dados causará uma exceção de tempo de execução. Para obter mais informações, consulte [/checked (opções do compilador do C#)](https://msdn.microsoft.com/library/fb7475d3-e6a6-4e6d-b86c-69e7a74c854b).  
...
## <a name="see-also"></a>Consulte também  
 [Opções do compilador do C#](https://msdn.microsoft.com/library/d3403556-1816-4546-a782-e8223a772e44)   
