...
> [!TIP]
> Executar o Assistente de configuração de fonte de dados cria e configura automaticamente a maioria dos itens de dados. Para obter mais informações, consulte [Criando aplicativos de dados usando Visual Studio](https://msdn.microsoft.com/28edce21-220a-484c-b461-a75b0232d293).
...
## <a name="see-also"></a>Consulte Também
 Os [passo a passos de dados](https://msdn.microsoft.com/library/15a88fb8-3bee-4962-914d-7a1f8bd40ec4) [associam controles de Windows Forms a dados no Visual Studio](../../data-tools/bind-windows-forms-controls-to-data-in-visual-studio.md) [preparando seu aplicativo para receber](https://msdn.microsoft.com/library/c17bdb7e-c234-4f2f-9582-5e55c27356ad) [controles de ligação de dados para dados no Visual Studio](../../data-tools/bind-controls-to-data-in-visual-studio.md) [Validando dados](https://msdn.microsoft.com/library/b3a9ee4e-5d4d-4411-9c56-c811f2b4ee7e)