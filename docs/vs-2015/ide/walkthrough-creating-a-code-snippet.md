...
> [!TIP]
> Para obter informações sobre como escrever snippets de código mais facilmente, pesquise o site da CodePlex para ferramentas da comunidade, como [Editor de Snippet](https://snippeteditor.codeplex.com/).
