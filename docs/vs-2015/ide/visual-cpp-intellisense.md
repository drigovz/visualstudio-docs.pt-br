...
## <a name="intellisense-features-in-c"></a>Recursos do IntelliSense em C++
 ...
 ![Menu do IntelliSense do Visual C&#43;&#43; ](../ide/media/vs2015-cpp-intellisense-menu.png "vs2015_cpp_intellisense_menu")
...
## <a name="error-squiggles"></a>Linhas onduladas de erro
 ...
 ![Visual C&#43;&#43; rabiscos de erro](../ide/media/vs2015-cpp-error-quiggles.png "vs2015_cpp_error_quiggles")
...
- O #else Branch na linha 8 está esmaecido para indicar a região inativa, pois `__ANDROID__` está definido para o projeto Android.
...
- A Linha 12 tem linha ondulada vermelha no identificador BYE; esse identificador não está definido no projeto ativo atualmente selecionado.
  ...
  ![O iOS está selecionado como o projeto ativo.](../ide/media/intellisensecppcrossplatform2.png "IntelliSenseCppCrossPlatform2")

  Observe o seguinte:

- O #ifdef Branch na linha 6 está esmaecido para indicar a região inativa, porque *_ANDROID \\ * \_ não está definido para o projeto do Ios.
...
## <a name="single-file-intellisense"></a>IntelliSense de arquivo único
 ...
 ![Visual C&#43;&#43; o IntelliSense de arquivo único](../ide/media/vs2015-cpp-single-file-intellisense.png "vs2015_cpp_single_file_intellisense")
 ...
 ![Adicionando um caminho ao arquivo de cabeçalho.](../ide/media/intellisensedebugyourcode.jpg "IntelliSenseDebugYourCode")
