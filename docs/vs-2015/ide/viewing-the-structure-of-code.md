...
É possível examinar objetos e membros em projetos do Visual Studio e objetos e membros em componentes do .NET Framework, componentes COM, DLLs (bibliotecas de vínculo dinâmico) e TLBs (bibliotecas de tipos).
 ...
 [Hierarquia de chamadas (Visual Basic, C#, C++)](#BKMK_CallHierarchy)

 [Pesquisador de objetos](#BKMK_ObjectBrowser)

 [Janela de definição de código (C#, C++)](#BKMK_CodeDefinition)

 Você também pode usar **Gerenciador de soluções** para procurar os tipos e membros em seus projetos, procurar por símbolos, exibir a hierarquia de chamada de um método, localizar referências de símbolo e muito mais sem precisar alternar entre as várias janelas de ferramentas listadas anteriormente.
...
## <a name="class-view-visual-basic-c-c"></a><a name="BKMK_ClassView"></a> Modo de Exibição de Classe (Visual Basic, C#, C++)
...
## <a name="call-hierarchy-visual-basic-c-c"></a><a name="BKMK_CallHierarchy"></a> Hierarquia de Chamada (Visual Basic, C#, C++)
...
## <a name="code-definition-window-c-c"></a><a name="BKMK_CodeDefinition"></a> Janela de Definição de Código (C#, C++)
...
|**Cópia**|Copia a linha selecionada.|
...
## <a name="see-also"></a>Consulte Também
 [Ícones de pesquisador de objetos e Modo de Exibição de Classe](../ide/class-view-and-object-browser-icons.md)
