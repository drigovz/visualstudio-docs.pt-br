...
## <a name="in-this-section"></a>Nesta seção
 [Classes específicas de cultura para Windows Forms global e Web Forms](../ide/culture-specific-classes-for-global-windows-forms-and-web-forms.md) Discute classes que formatam datas, horas, números, moedas e outras informações de acordo com a configuração de cultura.

## <a name="related-sections"></a>Seções relacionadas
 [Globalizando Windows Forms](https://msdn.microsoft.com/library/72f6cd92-83be-45ec-aa37-9cb8e3ebc3c5) Fornece links para páginas de ajuda sobre a globalização de Windows Forms.
