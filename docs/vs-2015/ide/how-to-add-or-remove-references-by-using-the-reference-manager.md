...
- > [!NOTE]
    > No Visual Studio 2015, uma referência de arquivo em vez de uma referência de projeto será criada se a versão de destino do .NET Framework de um projeto for a versão 4,5, e a versão de destino do outro projeto for a versão 2, 3, 3,5 ou 4,0.
...
### <a name="core-subgroup"></a>Subgrupo Núcleo
 O subgrupo Núcleo lista todos os WinMDs (para elementos de Windows Runtime) no SDK para a versão de destino do Windows.
