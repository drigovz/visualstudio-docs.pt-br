...
## <a name="determining-intellisense-context"></a><a name="DeterminingIntelliSenseContext"></a> Determinando o contexto do IntelliSense
...
## <a name="processing-intellisense-information"></a><a name="ProcessingIntelliSenseInformation"></a> Processando informações do IntelliSense
...
## <a name="javascript-intellisense-features"></a><a name="Features"></a> Recursos do JavaScript IntelliSense
...
### <a name="html-dom-elements"></a><a name="HTMLDom"></a> Elementos HTML DOM
...
### <a name="user-defined-variables-functions-and-objects"></a><a name="UserDefined"></a> Variáveis, funções e objetos definidos pelo usuário
...
### <a name="external-file-references"></a><a name="External"></a> Referências de arquivo externo
...
#### <a name="script-references"></a><a name="Script"></a> Referências de script
...
#### <a name="reference-directives"></a><a name="ReferenceDirectives"></a> Diretivas de referência
...
#### <a name="reference-groups"></a><a name="ReferenceGroups"></a> Grupos de referência
...
### <a name="xml-documentation-comments"></a><a name="XMLDocComments"></a> Comentários de documentação XML
...
### <a name="aspnet-ajax-objects"></a><a name="ASPNet"></a> Objetos ASP.NET AJAX
...
## <a name="javascript-intellisense-extensibility"></a><a name="Extensibility"></a> Extensibilidade do IntelliSense do JavaScript
...
## <a name="javascript-validation"></a><a name="Validation"></a> Validação de JavaScript
...
- **Lista de erros** janela. A janela **Lista de Erros** exibe a descrição do erro, o arquivo onde o erro ocorreu, o número da linha e da coluna e o projeto. Para exibir a janela **Lista de Erros**, no menu **Exibir**, clique em **Lista de Erros**.
...
- [Estendendo JavaScript IntelliSense](../ide/extending-javascript-intellisense.md)
