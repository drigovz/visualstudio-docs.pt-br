...
### <a name="access_azure"></a> Acessar o Azure Active Directory em um projeto Web
 ...
 Para obter mais informações sobre os diferentes tipos de autenticação no ASP.NET, consulte [Creating ASP.NET Web Projects in Visual Studio 2013](http://www.asp.net/visual-studio/overview/2013/creating-web-projects-in-visual-studio#orgauth) (as informações sobre autenticação ainda são relevantes para o Visual Studio 2015).
