...
O Visual Studio tem um sistema de notificação que alerta você sobre vários eventos:

1. Uma atualização está disponível para um componente no Visual Studio

2. O próprio Visual Studio tem uma atualização disponível

3. Houve um evento de ambiente no qual você pode estar interessado
