...
- Para ir para a próxima etapa do tutorial, confira [Etapa 4: Adicione o método checktheanswer ()](../ide/step-4-add-the-checktheanswer-parens-method.md).  
