...
3. Agora experimente. Abra um arquivo de código grande e substitua algo que ocorra em vários lugares no arquivo. A barra de rolagem mostra o efeito das substituições, de modo que você pode desfazer suas alterações se tiver substituído algo que não deveria.
     ...
     ![A barra de rolagem depois de procurar uma cadeia de caracteres.](../ide/media/enhancedscrollbarsearch.png "EnhancedScrollbarSearch")
     ...
     ![A barra de rolagem após substituir uma cadeia de caracteres por erros](../ide/media/enhancedscrollbarreplace.png "EnhancedScrollbarReplace")
...
2. No modo de mapa, para habilitar visualizações do código quando você move o cursor para cima e para baixo na barra de rolagem, selecione a opção **Mostrar Dica de Ferramenta de Visualização**. Veja como deve ser sua aparência:
     ...
     ![O ScrollBar com uma dica de ferramenta](../ide/media/enhancedscrollbarsearchtooltip.png "EnhancedScrollbarSearchTooltip")
