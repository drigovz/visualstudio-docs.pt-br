...
## <a name="create-a-new-native-activity-project"></a><a name="Create"></a> Criar um novo projeto de atividade nativa  
...
## <a name="build-and-run-the-default-android-native-activity-app"></a><a name="BuildHello"></a> Compilar e executar o aplicativo de atividade nativa do Android padrão  
...
1. Se ainda não estiver selecionado, escolha **x86** na lista suspensa **Plataformas da Solução**.  
     ...
     ![Seleção do menu suspenso de plataformas de solução x86](../cross-platform/media/cppmdd-rc-na-solution-x86.png "CPPMDD_RC_NA_Solution_x86")  
...
4. Pressione F5 para iniciar a depuração ou Shift+F5 para iniciar sem depuração.  
     ...
     ![O emulador que executa seu aplicativo](../cross-platform/media/cppmdd-emulator-running-app.PNG "CppMDD_Emulator_Running_App")  
