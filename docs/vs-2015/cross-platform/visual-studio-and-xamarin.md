...
> [!NOTE]
> Se você estiver procurando uma solução de desenvolvimento de plataforma cruzada baseada em HTML e CSS, confira o Ferramentas do Visual Studio para Apache Cordova, conforme descrito em [desenvolvimento de plataforma cruzada no Visual Studio](../cross-platform/cross-platform-mobile-development-in-visual-studio.md#HTML).
