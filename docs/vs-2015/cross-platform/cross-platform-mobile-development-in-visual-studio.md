...
- [Criar um aplicativo para Android, iOS e Windows (.NET Framework)](#NET)

  - [Direcione o Android, iOS e Windows de uma única base de código](../cross-platform/cross-platform-mobile-development-in-visual-studio.md#AndroidHTML)
...
### <a name="target-android-ios-and-windows-from-a-single-code-base"></a><a name="AndroidHTML"></a> Ter o Android, iOS e Windows como destino por meio de uma única base de código
 ...
 Quando terminar, os modelos de projeto aparecerão na caixa de diálogo **novo projeto** . A maneira mais fácil de encontrar modelos do Xamarin é simplesmente pesquisar em “Xamarin”.
...
## <a name="build-an-app-for-android-ios-and-windows-htmljavascript"></a><a name="HTML"></a> Criar um aplicativo para Android, iOS e Windows (HTML/JavaScript)
 ![Dispositivos](../cross-platform/media/homedevices.png "HomeDevices")
...
## <a name="build-an-app-for-android-and-windows-c"></a><a name="CPP"></a> Criar um aplicativo para Android e Windows (C++)
 ![Use o C&#43;&#43; para compilar para Android, iOS e Windows](../cross-platform/media/cross-plat-cpp-intro-image.png "Cross_Plat_CPP_Intro_Image")
 ...
 ![Modelo de projeto de atividade nativa](../cross-platform/media/cross-plat-cpp-native.png "Plat_CPP_Native cruzado")
...
|**Saiba mais**|
|--------------------|
|[Baixe o Visual Studio.](https://visualstudio.microsoft.com/vs/community/) (VisualStudio.com)|
...
## <a name="build-a-cross-platform-game-for-android-ios-and-windows-by-using-visual-studio-tools-for-unity"></a><a name="Unity"></a> Crie um jogo de plataforma cruzada para Android, iOS e Windows usando as ferramentas do Visual Studio para Unity
 O Ferramentas do Visual Studio para Unity é uma extensão gratuita para o Visual Studio que integra ferramentas de edição, produtividade e depuração de código poderosas do Visual Studio com o *Unity*, o popular mecanismo de jogos/gráficos entre plataformas e o ambiente de desenvolvimento para aplicativos de imersão direcionados para o Windows, Ios, Android e outras plataformas, incluindo a Web.
