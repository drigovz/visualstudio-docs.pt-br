...
## <a name="example"></a>Exemplo  
 O exemplo de código a seguir define pacotes para o [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] pacote redistribuível e suas dependências, como o Windows Installer.  
