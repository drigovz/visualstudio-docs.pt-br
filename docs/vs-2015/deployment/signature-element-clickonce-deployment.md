...
## <a name="example"></a>Exemplo  
 O exemplo de código a seguir ilustra um `Signature` elemento em um manifesto de implantação usado em uma [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] implantação.  
