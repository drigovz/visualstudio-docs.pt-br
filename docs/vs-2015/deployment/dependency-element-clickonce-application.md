...
## <a name="example"></a>Exemplo  
 O exemplo de código a seguir ilustra os `dependency` elementos em um [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] manifesto do aplicativo. Este exemplo de código é parte de um exemplo maior fornecido para o tópico [manifesto do aplicativo ClickOnce](../deployment/clickonce-application-manifest.md) .  
