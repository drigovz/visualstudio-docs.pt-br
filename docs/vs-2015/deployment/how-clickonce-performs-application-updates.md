...
## <a name="file-patching"></a>Aplicação de patch de arquivo  
 ...
 A aplicação de patches de arquivo não funciona para arquivos marcados como dados e armazenados no diretório de dados. Eles são sempre baixados, independentemente da assinatura de hash do arquivo. Para obter mais informações sobre o diretório de dados, consulte [acessando dados locais e remotos em aplicativos ClickOnce](../deployment/accessing-local-and-remote-data-in-clickonce-applications.md).  
