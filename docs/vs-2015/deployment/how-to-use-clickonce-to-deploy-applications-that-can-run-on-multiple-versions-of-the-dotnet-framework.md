...
> [!NOTE]
> Antes de alterar o aplicativo para direcionar várias versões do .NET Framework, você deve garantir que seu aplicativo seja executado com várias versões do .NET Framework. A versão Common Language Runtime é diferente entre [!INCLUDE[net_v40_short](../includes/net-v40-short-md.md)] versus .NET Framework 2,0, .NET Framework 3,0 e .NET Framework 3,5.  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Esquema do arquivo de configuração](https://msdn.microsoft.com/library/69003d39-dc8a-460c-a6be-e6d93e690b38)
