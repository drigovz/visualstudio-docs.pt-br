...
4. Na página **Como os usuários instalarão o aplicativo?**, selecione a localização em que os usuários acessarão para instalar o aplicativo:  
   ...
   - Se os usuários forem instalar o aplicativo diretamente do compartilhamento de arquivos, clique em **De um caminho UNC ou compartilhamento de arquivos** e clique em **Avançar**. (Isso é para locais de publicação do formato c:\deploy\myapp ou \\ \server\myapp.)  
...
3. Na página **onde deseja publicar o aplicativo?** , insira o caminho do arquivo ou o local do FTP onde o aplicativo será publicado, por exemplo, d:\Deploy. Em seguida, clique em **Avançar** para continuar.  
