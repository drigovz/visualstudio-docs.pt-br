...
description: Saiba como alterar o tipo de retorno de um método DataContext quando você remove um procedimento armazenado ou uma função no Object Relational Designer (O/R Designer).
