...
description: Aviso-foram feitas alterações na caixa de diálogo comportamento de configuração que não foram aplicadas. Exibir informações sobre esta mensagem do Visual Studio O/R Designer.
