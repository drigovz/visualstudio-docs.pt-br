...
description: Conheça diferentes ferramentas para desenvolver soluções de dados no Visual Studio, incluindo as ferramentas do .NET, o SQL Server Data Tools, o Azure Data Lake, o Azure HDInsight e o Azure Streaming Analytics.
layout: LandingPage
ms.date: 01/01/2018
author: jillre
ms.author: jillfra
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre as ferramentas do .NET e Visual Studio e sobre o suporte de API para desenvolvimento de aplicativos de dados</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre como desenvolver aplicativos de Big Data com U-SQL e .NET usando o Azure Data Lake</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre como executar consultas do Hive com o Hadoop no HDInsight do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre como desenvolver soluções de big data quase em tempo real com o Azure Streaming Analytics</h3>
                    </div>
                </div>
            </div>
        </div>
