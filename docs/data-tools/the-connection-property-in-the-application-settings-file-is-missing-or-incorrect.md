...
Para responder a essa mensagem, selecione **Okey**. Informações de conexão que está contida no arquivo *.dbml* é adicionada às configurações do aplicativo.
