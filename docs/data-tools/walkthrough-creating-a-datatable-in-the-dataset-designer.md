...
description: Neste tutorial, crie uma DataTable (sem um TableAdapter) usando o Designer de Conjunto de Dados. Crie um novo aplicativo Windows Forms e adicione um novo conjunto de um.
