...
> [!NOTE]
> Para obter informações específicas para o Visual Studio 2017, consulte a página [abrir um projeto de um repositório no visual studio 2017](tutorial-open-project-from-repo-visual-studio-2017.md) .
