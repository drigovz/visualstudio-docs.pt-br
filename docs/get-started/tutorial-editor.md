...
Os snippets de código disponíveis variam em linguagens de programação diferentes. Você pode olhar os trechos de código disponíveis para o seu idioma escolhendo **Editar** > **intestar** > **snippet**e, em seguida, escolher a pasta do seu idioma. Para o C#, a lista tem este aspecto:
