...
1. Abra o Visual Studio e, no menu **Arquivo** na barra de menus, escolha **Novo Arquivo**.

1. Na caixa de diálogo **Novo Arquivo**, na categoria **Geral**, escolha **Classe do Visual Basic** e, em seguida, escolha **Abrir**.
