...
ms.locfileid: "55139062"
---
# <a name="debugging-apps-in-a-local-docker-container"></a>Depuração de aplicativos em um contêiner local do Docker
...
## <a name="1-create-a-web-app"></a>1. Como criar um aplicativo Web
...
6. Alterne para o Visual Studio para exibir o ponto de interrupção e inspecionar o valor da mensagem.
   ...
   ![Ponto de Interrupção](media/vs-azure-tools-docker-edit-and-refresh/breakpoint.png)
...
* [Steve Lasker: VS Live Las Vegas 2016 – Docker e2e](https://github.com/SteveLasker/Presentations/blob/master/VSLive2016/Vegas/) (VS ao vivo em Las Vegas, 2016 – Docker e2e)
