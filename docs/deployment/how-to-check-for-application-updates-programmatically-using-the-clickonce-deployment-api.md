...
## <a name="see-also"></a>Consulte também  
 [Como: Especificar uma localização alternativa para as atualizações de implantação](../deployment/how-to-specify-an-alternate-location-for-deployment-updates.md)   
