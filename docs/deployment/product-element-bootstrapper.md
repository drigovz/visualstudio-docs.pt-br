...
description: O elemento Product é o elemento XML de nível superior dentro de um arquivo de produto. O elemento Product é necessário em um arquivo de produto.
