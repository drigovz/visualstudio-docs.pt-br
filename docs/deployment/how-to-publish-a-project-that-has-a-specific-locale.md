---
title: Publicar um projeto que tem uma localidade específica
description: Saiba como usar uma macro para publicar o primeiro projeto em uma solução que contém projetos para várias localidades diferentes.
