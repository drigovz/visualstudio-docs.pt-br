...
> [!NOTE]
> Para projetos node.js existentes, use o modelo de solução **de código Node.js existente** para habilitar npm em seu projeto.

## <a name="nodejs-projects"></a>Projetos node.js

Para projetos Node.js, use um dos seguintes métodos:
...
Se o seu projeto ainda não incluir um arquivo *package.json,* você pode adicionar um suporte ao npm, adicionando um arquivo package.json ao projeto.

1. Para adicionar o arquivo, clique com o botão direito do mouse no projeto no Solution Explorer e escolha **Adicionar** > **novo item**. Escolha o **arquivo de configuração npm,** use o nome padrão e clique **em Adicionar**.
...
Quando você salva o arquivo, o Visual Studio adiciona o pacote o nó **Dependências / npm** no Solution Explorer. Se você não ver o nó, clique com o botão direito do **mouse em package.json** e escolha **Restaurar pacotes**.
...
![Pesquisar pacote do npm](../javascript/media/npm-add-package-intellisense.png)
