...
Para saber como configurar outras partes do projeto do Azure no Visual Studio, confira [Configurar um projeto do Azure](vs-azure-tools-cloud-service-retain-a-constant-virtual-ip-address.md).
