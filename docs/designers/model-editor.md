...
description: Saiba como trabalhar com o editor de modelos do Visual Studio para exibir, criar e modificar modelos 3D do zero ou de modelos 3D mais complexos criados por ferramentas de modelagem.
...
|**Panorâmica**|Habilita a movimentação de uma cena 3D em relação ao quadro da janela. Para obter uma panorâmica, selecione um ponto na cena e movimente-o ao redor.<br /><br /> No modo de **seleção** , você pode pressionar e manter a **tecla CTRL** para ativar o modo **panorâmico** temporariamente.|
|**Aplicar zoom**|Permite a exibição de mais ou menos detalhes da cena em relação ao quadro da janela. No modo **Zoom** , selecione um ponto na cena e mova-o para a direita ou para baixo para ampliar ou para a esquerda ou para cima para reduzir.<br /><br /> No modo de **seleção** , você pode ampliar ou reduzir usando a roda do mouse enquanto pressiona e mantém a **tecla CTRL** pressionada.|
...
|**Exibir**|Define a orientação da exibição. Veja as orientações disponíveis:<br /><br /> **Front**<br /> Posiciona a exibição na frente da cena.<br /><br /> **Voltar**<br /> Posiciona a exibição atrás da cena.<br /><br /> **Mantida**<br /> Posiciona a exibição à esquerda da cena.<br /><br /> **Certo**<br /> Posiciona a exibição à direita da cena.<br /><br /> **Top**<br /> Posiciona a exibição acima da cena.<br /><br /> **Inferior**<br /> Posiciona a exibição abaixo da cena. **Nota:** essa é a única maneira de alterar a direção da exibição quando a projeção **Ortográfica** estiver habilitada.|
...
|**Dimensionar**|Altera o tamanho da seleção.|
...
|Mudar para o modo **Panorâmico**|**Ctrl** + **G** , **Ctrl** + **P**<br /><br /> **C**|
|Selecionar tudo|**Ctrl** + **Um**|
|Excluir a seleção atual|**Excluir**|
|Cancelar a seleção atual|**Escape** ( **Esc** )|
|Ampliar|**Botão de rolagem do mouse para frente**<br /><br /> **Ctrl** + **Avanço da roda do mouse**<br /><br /> **Shift** + **Avanço da roda do mouse**<br /><br /> **Ctrl** + **PageUp**<br /><br /> Sinal de adição ( **+** )|
|Reduzir|**Botão de rolagem do mouse para trás**<br /><br /> **Ctrl** + **Rolagem do mouse para trás**<br /><br /> **Shift** + **Rolagem do mouse para trás**<br /><br /> **Ctrl** + **PageDown**<br /><br /> Sinal de subtração ( **-** )|
...
|Alternar para modo de translação|**Ctrl** + **P** , **Ctrl +** + **W**<br /><br /> **W**|
...
|Selecionar objeto anterior na cena|**Shift** + **Guia**|
|Manipular o objeto selecionado com base na ferramenta atual.|As teclas de **direção**|
|Desativar o manipulador atual|**Perguntas**|
