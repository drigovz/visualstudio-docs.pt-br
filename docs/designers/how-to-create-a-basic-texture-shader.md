...
description: Use o designer de sombreador e a linguagem direcionada de sombreador de grafo para criar um sombreador de textura única que define a cor final como valores RGB e alfa da textura.
