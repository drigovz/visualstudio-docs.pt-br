...
|[Como: Criar um sombreador de textura básica](../designers/how-to-create-a-basic-texture-shader.md)|Demonstra um sombreador que aplica uma textura a um objeto.|
...
|[Passo a passo: Criando uma bola de bilhar 3D realista](../designers/walkthrough-creating-a-realistic-3-d-billiard-ball.md)|Demonstra como combinar técnicas de sombreador e recursos de textura para criar um sombreador de bola de bilhar realista.|
