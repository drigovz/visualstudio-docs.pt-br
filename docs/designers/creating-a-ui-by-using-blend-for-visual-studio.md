...
![Painel Ferramentas no Blend para Visual Studio](../designers/media/blend-tools-panel.png)
...
![Janela Ativos no Blend para Visual Studio](../designers/media/blend-assets-window.png)
...
![Janela Objetos e Linha do Tempo no modo de animação](../designers/media/storyboard-timeline.png)
