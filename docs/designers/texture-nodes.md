...
description: Saiba mais sobre os nós de textura que exemplificam vários tipos de textura e geometrias e, em seguida, produzem ou transforma coordenadas de textura no designer de sombreador.
