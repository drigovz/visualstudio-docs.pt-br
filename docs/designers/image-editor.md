...
description: Saiba como trabalhar com o editor de imagem do Visual Studio para exibir e modificar os recursos de textura e imagem usados no desenvolvimento de aplicativos DirectX.
...
|||**Pressionando**|Redimensiona a região selecionada. Isso define uma nova região de seleção.|
||**Shift**|**Pressionando**|Redimensiona proporcionalmente a região selecionada. Isso define uma nova região de seleção.|
...
|Mudar para o modo **Panorâmico**|**C**|
...
|Mudar para a ferramenta Seleção Irregular|**Debug**|
...
|Mudar para a ferramenta Seleção de Cor (conta-gotas)|**Encontrei**|
