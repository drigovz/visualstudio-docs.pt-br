...
Para usuários avançados, é possível até mesmo [personalizar o Designer XAML](../extensibility/xaml-designer-extensibility-migration.md).
...
![Comandos do modo de exibição de Design](../designers/media/xaml-design-view-controls.png)
...
![Exibição XAML](../designers/media/xaml-editor.png)
...
- Selecionar elementos para que você possa modificá-los (por exemplo, para movê-los na hierarquia ou definir suas propriedades na janela Propriedades). Para obter mais informações, confira [Trabalhar com elementos no Designer XAML](../designers/working-with-elements-in-xaml-designer.md).
...
- [Passo a passo: Associar dados no Designer XAML](../designers/walkthrough-binding-to-data-in-xaml-designer.md)