...
description: Saiba como usar o editor de imagem para criar uma textura básica, incluindo a definição do tamanho da textura, a definição de propriedades da ferramenta e outras atividades.
