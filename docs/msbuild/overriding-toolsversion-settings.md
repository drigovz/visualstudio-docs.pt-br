...
```
 ...
 Neste exemplo, todos os projetos são compilados usando ToolsVersion 12.0. (No entanto, consulte a seção [ordem de precedência](#order-of-precedence) mais adiante neste tópico.)
