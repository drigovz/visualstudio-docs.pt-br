...
description: Saiba como usar MSBuild.exe linha de comando para criar um arquivo de projeto ou de solução e várias opções que podem ser incluídas.
...
|Alternar|Formato curto|Description|
|------------|----------------|-----------------|
