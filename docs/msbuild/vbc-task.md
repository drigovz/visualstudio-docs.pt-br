...
| `BaseAddress` | Parâmetro `String` opcional.<br /><br /> Especifica o endereço básico do DLL. Esse parâmetro corresponde à opção [-BaseAddress](/dotnet/visual-basic/reference/command-line-compiler/baseaddress) do compilador de *vbc.exe* . |
