...
description: Saiba como especificar componentes e processos de compilação usando propriedades, itens, tarefas e destinos do MSBuild.
...
| [tarefas MSBuild](../msbuild/msbuild-tasks.md) | Mostra como criar uma unidade de código executável que pode ser usada pelo MSBuild para executar operações de compilação atômicas. |
