...
description: Saiba mais sobre vários ganchos de extensibilidade que você pode usar para personalizar projetos do MSBuild que usam o processo de compilação padrão.
