...
description: Saiba como o MSBuild usa a tarefa MarkupCompilePass1 para converter arquivos de projeto XAML não localizáveis em formato binário compilado.
