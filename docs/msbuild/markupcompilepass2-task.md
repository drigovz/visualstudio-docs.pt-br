...
description: Saiba como o MSBuild usa a tarefa MarkupCompilePass2 para executar a compilação de marcação de segundo passo em arquivos XAML que fazem referência a tipos no mesmo projeto.
