...
ms.locfileid: "77631699"
---
# <a name="taskextension-base-class"></a>Classe base TaskExtension

Muitas tarefas são herdadas da classe <xref:Microsoft.Build.Tasks.TaskExtension>, que é herdada da classe <xref:Microsoft.Build.Utilities.Task>. Esta cadeia de herança adiciona vários parâmetros para as tarefas que derivam deles. Esses parâmetros são listados neste documento.
