...
| `SuiteNamel` | Parâmetro `String` opcional.<br /><br /> Especifica o nome da pasta no menu **Iniciar**, na qual o aplicativo está localizado após a implantação ClickOnce. |
