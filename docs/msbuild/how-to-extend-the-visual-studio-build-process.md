...
description: Conheça várias maneiras de modificar o processo de compilação para que você possa controlar e personalizar como seus projetos são criados.
