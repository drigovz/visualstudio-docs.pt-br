...
description: Saiba como definir as tarefas do MSBuild selecionadas para execução no ambiente de destino, independentemente do ambiente do computador de desenvolvimento.
