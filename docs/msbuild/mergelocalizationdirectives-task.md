...
| Parâmetro | DESCRIÇÃO |
|------------------------------| - |
| `GeneratedLocalizationFiles` | Parâmetro obrigatório **ITaskItem[]** .<br /><br /> Especifica a lista de arquivos de diretivas de localização para arquivos individuais no formato binário XAML. |
