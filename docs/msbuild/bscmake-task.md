...
|**OutputFile**|Parâmetro de **cadeia de caracteres** opcional.<br /><br /> Especifica um nome de arquivo que substitui o nome de arquivo de saída padrão.<br /><br /> Para obter mais informações, confira a opção **/o** em [Opções do BSCMAKE](/cpp/build/reference/bscmake-options).|
