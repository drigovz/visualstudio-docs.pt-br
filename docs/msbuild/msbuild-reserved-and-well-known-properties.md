...
description: Saiba mais sobre as propriedades predefinidas e conhecidas do MSBuild que armazenam informações sobre o arquivo de projeto e os binários do MSBuild.
