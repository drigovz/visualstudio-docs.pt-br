...
description: Saiba como usar o MSBuild para compilar de forma incremental, por isso os componentes já compilados que ainda estão atualizados não são recriados.
