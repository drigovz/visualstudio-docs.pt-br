...
description: Saiba mais sobre os metadados do MSBuild atribuídos a cada item após a criação e alguns metadados opcionais do MSBuild que você pode definir para controlar o comportamento da compilação.
