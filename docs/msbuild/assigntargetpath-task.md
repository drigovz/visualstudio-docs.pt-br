...
description: Use a tarefa MSBuild AssignTargetPath para aceitar uma lista de arquivos e adicionar atributos TargetPath se eles ainda não estiverem especificados.
