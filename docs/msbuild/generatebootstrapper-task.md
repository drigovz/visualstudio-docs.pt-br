...
description: Use a tarefa MSBuild GenerateBootstrapper para uma maneira automatizada de detectar, baixar e instalar um aplicativo e seus pré-requisitos.
