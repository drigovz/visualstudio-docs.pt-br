...
4. Arraste o nó `USAddress` do **XML Schema Explorer** para a exibição de gráfico. Clique com o botão direito do mouse no nó `USAddress` no modo de exibição de gráfico e selecione **Mostrar no modo de exibição de modelo de conteúdo** no menu de contexto.
