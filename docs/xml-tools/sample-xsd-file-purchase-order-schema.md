...
description: Exiba o arquivo XSD de exemplo para um esquema de ordem de compra que é usado em vários exemplos na documentação do designer de esquema XSD.
