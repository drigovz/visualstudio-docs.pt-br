...
Depois de adicionar nós ao espaço de trabalho, a lista de nós aparecerá na **espaço de trabalho** painel da exibição de modelo de conteúdo. Quando você seleciona nós na **espaço de trabalho** do painel, eles aparecem na superfície de design de exibição do modelo de conteúdo. Para excluir nós de espaço de trabalho, use a barra de ferramentas do Designer XSD, o **espaço de trabalho** menu de atalho do painel, ou o **excluir** chave.
...
Use o menu de atalho (contexto) para abrir inicialmente a **propriedades** janela. Por padrão, o **propriedades** janela é exibida no canto inferior direito do Visual Studio. Quando você clica em um nó que é renderizado no modo de modelo de conteúdo, as propriedades de nó são exibidas na **propriedades** janela.
