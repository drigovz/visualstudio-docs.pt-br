...
Resposta: Sim, é possível usar quantos decoradores você desejar se a mesma função fornece várias rotas. Por exemplo, para usar a função `hello` para "/" e "/hello", use o seguinte código:
