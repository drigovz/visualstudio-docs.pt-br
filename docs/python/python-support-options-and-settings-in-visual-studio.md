...
| **Colar prompts REPL removidos** | Por | Remove **>>>** e **...** do texto colado, permitindo a transferência fácil de código da janela **interativa** para o editor. Desmarque essa opção se você precisar manter esses caracteres ao colar de outras fontes. |
