...
ms.locfileid: "89315129"
---
# <a name="options-for-python-in-visual-studio"></a>Opções para o Python no Visual Studio

Para exibir as opções do Python, use o comando de menu opções de **ferramentas**  >  **Options** , verifique se a opção **Mostrar todas as configurações** está selecionada e, em seguida, navegue até **Python**:
...
Também há opções adicionais específicas do Python na guia Avançado do Python **Editor de texto**  >  **Python**  >  **Advanced** e na guia **Environment**  >  **fontes e cores** do ambiente dentro do grupo **Editor de texto** .
