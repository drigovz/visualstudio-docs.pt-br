...
- [Visual Studio 2017 e Visual Studio de 2019](#visual-studio-2017-and-2019)
- [Visual Studio 2015](#visual-studio-2015)
- [Visual Studio 2013 e anterior](#visual-studio-2013-and-earlier)

Para testar rapidamente o suporte ao Python após seguir as etapas `2+2`de instalação, abra a janela Python **Interactive** pressionando **Alt**+**I** e digitando . Se você não vir a saída de `4`, verifique as etapas novamente.
...
1. Baixe e execute o Instalador do Visual Studio mais recente. Se já tiver o Visual Studio instalado, execute o Instalador do Visual Studio, selecione a opção **Modificar** (consulte [Modificar o Visual Studio](../install/modify-visual-studio.md)) e vá para a etapa 2.
    ...
    > [Instale a comunidade do Visual Studio 2019](https://visualstudio.microsoft.com/thank-you-downloading-visual-studio/?sku=Community&rel=15&rid=34347&utm_source=docs&utm_medium=clickbutton&utm_campaign=python_gettingstarted)
...
1. No lado direito do instalador, escolha opções adicionais se desejado. Ignore essa etapa para aceitar as opções padrão.
    ...
    ::: moniker range=">=vs-2019"
    ![Opções de desenvolvimento do Python no instalador do Visual Studio 2019](media/installation-python-options-2019.png)
    ::: moniker-end

    ::: moniker range="<=vs-2017"
    | Opção | Descrição |
    | --- | --- |
    | Distribuições do Python | Escolha qualquer combinação de opções disponíveis, como variantes de 32 bits e de 64 bits das distribuições do Python 2, do Python 3, do Miniconda, do Anaconda2 e do Anaconda3 com as quais planeja trabalhar. Cada uma delas inclui o interpretador, o runtime e as bibliotecas da distribuição. O Anaconda, especificamente, é uma plataforma de ciência de dados aberta que inclui uma grande variedade de pacotes pré-instalados. (Você pode retornar ao instalador do Visual Studio a qualquer momento para adicionar ou remover distribuições.)  **Nota**: Se você instalou uma distribuição fora do instalador do Visual Studio, não há necessidade de verificar a opção equivalente aqui. O Visual Studio automaticamente detecta as instalações existentes do Python. Confira [A janela Ambientes do Python](managing-python-environments-in-visual-studio.md#the-python-environments-window). Além disso, se uma versão mais nova que a mostrada no instalador do Python estiver disponível, você poderá instalar essa versão separadamente, e o Visual Studio a detectará. |
    ...
    | **Principais ferramentas dos Serviços de Nuvem do Azure** | Fornece suporte adicional para os Serviços de Nuvem do Azure do desenvolvedor no Python. Veja [os projetos de serviços em nuvem do Azure](python-azure-cloud-service-project-template.md). |
    ::: moniker-end
...
- Use a opção [**Reparo**](../install/repair-visual-studio.md) no instalador do Visual Studio.
- Reparar ou reinstalar o Python através **de configurações** > **aplicativos & recursos** no Windows.
...
1. Selecione **linguagens de** > programação**ferramentas python para visual studio** e, em seguida, a **seguir**:
...
1. Instale a versão apropriada das Ferramentas Python para Visual Studio para sua versão do Visual Studio:
    ...
    - Visual Studio 2013: [PTVS 2.2.2 para Visual Studio 2013](https://github.com/Microsoft/PTVS/releases/v2.2.2). A **caixa de** > diálogo Arquivo**Novo Projeto** no Visual Studio 2013 oferece um atalho para esse processo.
    - Visual Studio 2010 e 2012: [PTVS 2.1.1 para Visual Studio 2010 e 2012](https://github.com/Microsoft/PTVS/releases/v2.1.1)
...
Para o Visual Studio 2019 e Visual Studio 2017, a carga de trabalho do Python é instalada em *%ProgramFiles(x86)%\Microsoft Visual Studio\\<VS_version>\\<VS_edition>Common7\IDE\Extensions\Microsoft\Python*, em que &lt;version&gt; é 2019 ou 2017 e &lt;VS_edition&gt; é Community, Professional ou Enterprise.
...
- 32 bits:
  ...
  - Local do caminho no Registro: **HKEY_LOCAL_MACHINE\Software\Microsoft\PythonTools\\<VS_ver>\InstallDir**
- 64 bits:
  ...
  - Local do caminho no Registro: **HKEY_LOCAL_MACHINE\Software\Wow6432Node\Microsoft\PythonTools\\<VS_ver>\InstallDir**
