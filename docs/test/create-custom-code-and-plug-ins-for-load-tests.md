...
description: Saiba como usar a API de teste de carga e a API de teste de desempenho da Web para criar plug-ins personalizados para testes expandirem para a funcionalidade interna.
