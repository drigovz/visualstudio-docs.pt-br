...
description: Saiba como alterar as portas de entrada padrão usadas pelo controlador de teste, o agente de teste e o cliente para evitar conflitos com outros softwares.
