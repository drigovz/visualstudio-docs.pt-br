...
## <a name="create-the-solution-and-the-unit-test-project"></a>{1&gt;Criar a solução e o projeto de teste de unidade&lt;1}
...
## <a name="verify-that-the-tests-run-in-test-explorer"></a>{1&gt;Verificar se o testes são executados no Gerenciador de Testes&lt;1}
...
## <a name="add-the-rooter-class-to-the-maths-project"></a>{1&gt;Adicionar a classe Rooter ao projeto Matemática&lt;1}
...
## <a name="iteratively-augment-the-tests-and-make-them-pass"></a>{1&gt;Multiplicar os testes iterativamente e fazê-los passar&lt;1}
...
2. Execute o teste **RangeTest** e verifique se ele falha.
   ...
   > [!TIP]
   > Imediatamente depois de escrever um teste, execute-o para verificar se ele falha. Isso ajuda a evitar o erro comum de escrever um teste que nunca falha.

3. {1&gt;&lt;1}
  Aprimore o código em teste para que o novo teste seja aprovado. Altere a função **SquareRoot** em *Rooter.cs* para:
...
## <a name="refactor-the-code"></a>{1&gt;Refatorar o código&lt;1}
