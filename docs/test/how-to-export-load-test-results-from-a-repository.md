...
description: Saiba como exportar informações do repositório de Resultados de Teste de carga usando a caixa de diálogo abrir e gerenciar Resultados de Teste de carregamento.
