---
title: Ferramentas de teste de unidade & tarefas
...
|-|-----------------------|
|**Guias de início rápido e orientações:** Saiba mais sobre os testes de unidade no Visual Studio nos exemplos de código.|- [Walkthrough: criar e executar testes de unidade para código .NET](../test/walkthrough-creating-and-running-unit-tests-for-managed-code.md)<br />- [Walkthrough: desenvolvimento controlado por testes com o Gerenciador de testes](../test/quick-start-test-driven-development-with-test-explorer.md)<br />- [Como: Adicionar testes de unidade a aplicativos C++](../test/how-to-use-microsoft-test-framework-for-cpp.md)|
...
|**Isolamento de testes de unidade**|- [Isole o código .NET sob teste com falsificações da Microsoft](../test/isolating-code-under-test-with-microsoft-fakes.md)|
|**Executar análise de estresse e desempenho usando testes de carga:** Saiba como criar testes de carga para ajudar a isolar problemas de desempenho e estresse em seu aplicativo (preterido).|- [Início rápido: criar um projeto de teste de carga](../test/quickstart-create-a-load-test-project.md)<br />- [Teste de carga (Azure Test Plans e TFS)](/azure/devops/test/load-test/index?view=vsts&preserve-view=true)|
