...
description: Saiba como especificar se deseja que o log de teste seja salvo se um teste falhar em um teste de carga, alterando a propriedade salvar log em falha de teste.
