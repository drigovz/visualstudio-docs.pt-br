---
title: Testes de unidade para métodos genéricos
description: Saiba como gerar testes de unidade para métodos genéricos usando essas informações e exemplos de criação de testes de unidade para métodos genéricos.
