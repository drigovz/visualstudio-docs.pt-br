...
| Silverlight | Sem suporte.<br /><br /> Para visual Studo 2013, no entanto, você pode baixar o [plugin de teste de ilic codificado do Microsoft Visual Studio 2013 para Silverlight](https://marketplace.visualstudio.com/items?itemName=PrachiBoraMSFT.MicrosoftVisualStudio2013CodedUITestPluginforSilve) na Visual Studio Gallery. |
...
| WPF 3.5 e posterior | Suporte total.<br /><br /> **Nota** Os controles NetFx são totalmente suportados, mas nem todos os controles de terceiros são suportados. |
...
| Cliente do Dynamics (Ax) 2012 | A gravação e reprodução de ações têm suporte parcial. Consulte o suporte a [gravações de ui/ação codificadas do Visual Studio 10 para obter detalhes](https://blogs.msdn.microsoft.com/dave_froslie/2011/09/01/visual-studio-10-coded-ui-action-recordings-support-for-microsoft-dynamics-ax-2012/) sobre a Microsoft Dynamics. |
| SAP | Sem suporte. |
