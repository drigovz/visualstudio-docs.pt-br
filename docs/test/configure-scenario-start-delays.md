...
description: Saiba como especificar um atraso antes de um cenário iniciar em um teste de carga usando o Editor de Teste de Carga e o janela Propriedades.
