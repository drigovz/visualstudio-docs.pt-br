...
description: Saiba como criar um adaptador de dados de diagnóstico criando uma biblioteca de classes usando o Visual Studio e adicionando APIs de adaptador de dados de diagnóstico.
