...
3. Em **Digite um nome de controlador para encontrar resultados de testes de carga**, selecione um controlador. Selecione>** \<locais** para acessar os resultados armazenados localmente.
