...
description: Saiba como gerar relatórios de teste de carga do Excel com base em dois ou mais resultados de teste, incluindo a execução de relatórios de comparação e relatórios de tendências.
