...
description: Saiba mais sobre os requisitos do Test Controller e do Test Agent para testes de carga. O Visual Studio dá suporte a vários tipos de teste.
