...
description: Saiba como especificar agentes para usar em um cenário definindo os agentes para usar a propriedade no janela Propriedades do Editor de Teste de Carga.
