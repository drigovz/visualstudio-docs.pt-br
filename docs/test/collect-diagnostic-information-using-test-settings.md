...
|Adaptador de dados de diagnóstico usado na configuração de teste|Teste manuais no computador local|Testes Automatizados|Teste manuais: coletando dados usando um conjunto de funções e um ambiente|Anotações|
|-|-|-|-|-|
