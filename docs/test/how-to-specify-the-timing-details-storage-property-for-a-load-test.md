...
description: Saiba como editar a propriedade de armazenamento de detalhes de tempo para uma configuração de execução. Os valores válidos são todos os detalhes individuais, somente nenhum e estatísticas.
