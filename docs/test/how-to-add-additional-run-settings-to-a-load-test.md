...
description: Aprenda a usar configurações adicionais para um teste de carga, incluindo a duração do teste, nível de detalhe da coleta de resultados e os conjuntos de contadores que são coletados.
