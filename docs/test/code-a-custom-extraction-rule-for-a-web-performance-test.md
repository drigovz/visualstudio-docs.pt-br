---
title: Codificar uma regra de extração Personalizada (teste de perf da Web)
description: Saiba como criar suas próprias regras de extração, derivadas de uma classe de regra de extração, ExtractionRule.
