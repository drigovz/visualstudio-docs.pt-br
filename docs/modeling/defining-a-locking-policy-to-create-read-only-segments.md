...
description: Saiba como você pode definir uma política para um programa bloquear parte ou todo um modelo de DSL (linguagem específica de domínio) para que ele possa ser lido, mas não alterado.
