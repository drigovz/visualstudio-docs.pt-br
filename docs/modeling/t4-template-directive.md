...
## <a name="culture-attribute"></a>Atributo culture
 ...
 Os valores válidos: "", a cultura invariável, que é o padrão.
...
```
 ...
 Os valores válidos: `true, false`. O padrão é false.
...
```
 ...
 Os valores válidos: `true, false, trueFromBase`. O padrão é false.
...
## <a name="linepragmas-attribute"></a>Atributo LinePragmas
 ...
 Os valores válidos: `true` (padrão)
...
## <a name="visibility-attribute"></a>Atributo visibility
 ...
 Os valores válidos: `public` (padrão)
