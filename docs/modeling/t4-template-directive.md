...
description: Saiba que um modelo de texto T4 do Visual Studio geralmente começa com uma diretiva de modelo, que especifica como o modelo deve ser processado.
