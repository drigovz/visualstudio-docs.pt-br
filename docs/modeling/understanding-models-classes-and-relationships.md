...
## <a name="the-dsl-definition"></a>A definição de DSL
 Quando você abre `Dsl\DslDefinition.dsl`, a imagem a seguir é semelhante a janela do Visual Studio.
...
## <a name="roles"></a>Funções
 ...
 ![As funções e propriedades.](../modeling/media/propertycode.png)
