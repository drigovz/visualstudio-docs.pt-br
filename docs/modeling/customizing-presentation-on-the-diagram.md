---
title: Personalizando a apresentação no diagrama
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
ms.locfileid: "62994680"
---
# <a name="customize-presentation-on-the-diagram"></a>Personalizar a apresentação no diagrama

O diagrama é a principal área de apresentação de um designer de linguagem específica do domínio. Geralmente, os usuários usam o diagrama para construir seus modelos. Você pode personalizar o diagrama, conforme descrito nos seguintes artigos:
