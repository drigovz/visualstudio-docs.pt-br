...
- Uma solução que tem um projeto de modelagem com um diagrama de dependência. Esse diagrama de dependência deve ser vinculado a artefatos em C# ou Visual Basic projetos que você deseja validar. Confira [criar diagramas de dependência do seu código](../modeling/create-layer-diagrams-from-your-code.md).
...
* Há suporte para a validação dinâmica em C# e Visual Basic.
