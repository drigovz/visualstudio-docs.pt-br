...
## <a name="ManageLargeGraphs"></a>Introdução ao trabalho com mapas de código
...
- Examine os clusters de dependência natural no código. Na barra de ferramentas do mapa, escolha **layout**, **clusters rápidos** ![Quick botão clusters na barra de ferramentas do grafo ](../modeling/media/quickclustersicon.gif). Consulte [alterar o layout do mapa](#Selecting).

     ![Layout de &#45; clusters rápidos de grafo de dependência](../modeling/media/dependencygraph_quickclusters.png)
...
|-|-|
|Organize o fluxo de dependência para todo o mapa em uma direção específica. Isso pode ajudá-lo a ver camadas arquitetônicas no código.|Na barra de ferramentas do mapa, escolha **layout**e, em seguida:<br /><br /> -    de**cima para baixo** ![Top botão de gráfico inferior ](../modeling/media/topbottomgraphbutton.gif)<br />-    de**baixo para cima** ![Bottom botão de gráfico superior ](../modeling/media/bottomtopgraphbutton.gif)<br />-    da**esquerda para a direita** ![Left botão de layout à direita ](../modeling/media/leftrightgraphbutton.gif)<br />-    da**direita para a esquerda** ![Right botão de gráfico à esquerda ](../modeling/media/rightleftgraphbutton.gif)|
|Consulte clusters de dependência natural no código com os nós mais dependentes no centro dos clusters e os nós menos dependentes, fora desses clusters.|Na barra de ferramentas do mapa, escolha **layout**e, em seguida, **clusters rápidos** ![Quick botão clusters na barra de ferramentas do grafo ](../modeling/media/quickclustersicon.gif).|
...
|**To**|**Execute estas etapas**|
|-|-|
|Examine o mapa.|Arraste o mapa em qualquer direção usando o mouse.<br /><br /> - ou -<br /><br /> Mantenha **Shift** e gire a roda do mouse para rolar horizontalmente. Mantenha **SHIFT**  + **Ctrl** e gire a roda do mouse para rolar horizontalmente.|
...
## <a name="Inspect"></a>Examinar nós e links
...
|Mostrar nós ocultos.|-Para mostrar todos os nós ocultos dentro de um grupo, primeiro verifique se o grupo está expandido. Abra o menu de atalho e escolha **selecionar**, **Reexibir filhos**.<br />     - ou -<br />     Clique no ícone **Reexibir** filhos ![Unhide filho ](../modeling/media/dependencygraph_filtericon_hiddennodes.gif) ícone no canto superior esquerdo do grupo (isso só é visível quando há nós filho ocultos).<br />-Para mostrar todos os nós ocultos, abra o menu de atalho para o mapa ou um nó e escolha **selecionar**, **Reexibir tudo**.|

### <a name="to-hide-or-show-links"></a>Para ocultar ou mostrar links

|**To**|**Na barra de ferramentas do mapa, escolha layout, avançado e, em seguida, escolha**|
|-|-|
...
|Mostrar somente links entre grupos para os nós selecionados.|**Mostrar links entre grupos em nós selecionados**|
...
|Alterar o layout dentro de um grupo.|Selecione o grupo, abra o menu de atalho, escolha **layout**e selecione o estilo de layout desejado.<br /><br /> - ou -<br /><br /> 1. Selecione o grupo e verifique se ele está expandido.<br />2. Clique no cabeçalho do grupo novamente e a barra de ferramentas do grupo será exibida.<br />     ![Dependency barra &#45; de ferramentas do grupo de gráficos ](../modeling/media/dependencygraph_group.png)<br />3. Abra a lista **alterar o estilo de layout do grupo** ![Dependency layout &#45; da barra &#45; de ferramentas do grupo de gráficos ](../modeling/media/dependencygraph_grouptoolbar.gif) e escolha o estilo de layout desejado.<br /><br /> A **exibição de lista** reorganiza os membros do grupo na lista. O **grafo padrão** redefine o layout do grupo para o layout padrão do mapa. Para outras opções, consulte [alterar o layout do mapa](#Selecting).|
...
|Adicione um novo nó do mesmo tipo e vinculado a um nó existente.|1. Selecione o elemento de código. Uma barra de ferramentas pop-up aparece acima dela.<br />     barra de ferramentas ![Dependency Graph ](../modeling/media/depedencygraph_toolbar.png)<br />2. na barra de ferramentas, escolha o segundo ícone **criar um nó com a mesma categoria deste nó e adicionar um novo link a ele**.<br />3. escolha um local no mapa para colocar o novo elemento de código e clique no botão esquerdo do mouse.<br />4. Digite o nome do novo nó e pressione **Return**.|
|Adicione um novo nó genérico que esteja vinculado a partir de um elemento de código existente que tenha foco.|1. usando o teclado, pressione **Tab** até que o elemento de código a ser vinculado tenha o foco (retângulo pontilhado).<br />2. Pressione **Alt** +**Inserir**.<br />3. Digite o nome do novo nó e pressione **Return**.|
|Adicione um novo nó genérico que se vincule a um elemento de código existente que tenha foco.|1. usando o teclado, pressione **Tab** até que o elemento de código para vincular tenha o foco (retângulo pontilhado).<br />2. Pressione **Alt** +**Shift** +**Inserir**.<br />3. Digite o nome do novo nó e pressione **Return**.|
...
1. Abra o menu de atalho e escolha Editar**Propriedades**de  > .
...
2. Se o elemento ou link fizer parte de um grupo, o botão **rebuscar filhos** ![Refetch ícone de filhos ](../modeling/media/dependencygraph_deletednodesicon.png) aparecerá dentro do grupo. Clique aqui para recuperar elementos e links ausentes.
...
2. Abra o menu de atalho e escolha Editar**sinalizador de  >  para acompanhamento**.
