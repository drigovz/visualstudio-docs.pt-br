...
- [Check-in restrito do TFVC](/azure/devops/pipelines/build/triggers#gated)
...
- [Criar sua pendência e tarefas usando o projeto](/azure/devops/boards/backlogs/office/create-your-backlog-tasks-using-project)

### <a name="TestValidateCheckInCode"></a>Testar, validar e fazer check-in de código
...
### <a name="DescribeLayers"></a>Descrever a arquitetura lógica: diagramas de dependência
