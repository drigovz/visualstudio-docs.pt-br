...
description: Saiba como a exibição IPs de dados de amostragem lista dados de desempenho para as instruções de assembly que estavam sendo executadas diretamente quando as amostras foram coletadas.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
