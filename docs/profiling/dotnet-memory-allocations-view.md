...
description: Saiba mais sobre a exibição alocações de memória do .NET, que lista os tipos que foram criados durante a execução da criação de perfil.
