...
description: Coletar dados de contenção de recursos e dados de atividade de thread usando o método de simultaneidade do Visual Studio Ferramentas de Criação de Perfil.
