...
description: Saiba como a ferramenta VSPerfCLREnv é usada para definir variáveis de ambiente que são necessárias para criar o perfil de um aplicativo .NET Framework.
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
