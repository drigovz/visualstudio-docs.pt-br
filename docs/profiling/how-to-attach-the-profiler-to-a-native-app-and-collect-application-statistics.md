...
## <a name="control-data-collection"></a>Controlar a coleta de dados
 Quando o aplicativo de destino estiver em execução, você pode usar opções *VSPerfCmd.exe* para iniciar e interromper a escrita de dados no arquivo de dados do profiler. Controlar a coleta de dados permite coletar dados de uma parte específica da execução do programa, como o início ou o desligamento do aplicativo.
...
- Os seguintes pares de opções **VSPerfCmd** iniciam e param a coleta de dados. Especifique cada opção em uma linha de comando separada. É possível ativar e desativar a coleta de dados várias vezes.
    ...
    |[/anexar:](../profiling/attach.md) **:** `PID` [/desapego](../profiling/detach.md)|**/attach** começa a coletar dados do processo especificado por `PID`. **/detach** interrompe a coleta de dados para todos os processos.|
