...
description: Saiba como a escolha do Visual Studio Ferramentas de Criação de Perfil ferramentas e opções de linha de comando depende de fatores como o tipo de aplicativo para o qual você está criando perfis.
ms.date: 11/04/2016
ms.topic: conceptual
