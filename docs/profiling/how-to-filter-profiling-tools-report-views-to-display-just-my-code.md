---
title: Filtrar exibições de relatório de criação de perfil para mostrar Apenas Meu Código
description: Use a opção Apenas Meu Código do Visual Studio para restringir relatórios de desempenho para mostrar apenas o código que você implementou (selecione as opções no menu Depurar).
