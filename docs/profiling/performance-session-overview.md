...
description: Saiba como usar as ferramentas de desempenho para se tornar produtivos rapidamente e aumentar o desempenho do código Kindling.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
- [Walkthrough: identificar problemas de desempenho](beginners-guide-to-cpu-sampling.md)
