...
description: Use o criador de perfil de consumo de energia do Visual Studio para analisar demandas de energia e energia de aplicativos UWP em execução em dispositivos conectados à bateria.
...
1. No menu **Depurar**, escolha **Iniciar Diagnóstico Sem Depurar**.
     ...
     ![Escolha consumo de energia no criador de perfil de desempenho](../profiling/media/energyprof_diagnosticshub.png "ENERGYPROF_DiagnosticsHub")
...
3. Escolha **consumo de energia** na página criador de perfil de desempenho.
...
## <a name="optimize-energy-use"></a>Otimizar o uso de energia
 ...
 ![&#40;de recursos no painel&#47;off&#41;](../profiling/media/energyprof_resources.png "ENERGYPROF_Resources")
