...
ms.locfileid: "71128192"
---
# <a name="quickstart-analyze-cpu-usage-data-in-visual-studio-c-visual-basic"></a>Início Rápido: Analisar dados de uso da CPU no VisualC#Studio (, Visual Basic)
