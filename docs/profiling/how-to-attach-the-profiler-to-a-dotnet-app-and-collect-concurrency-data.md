...
description: Saiba como obter dados de simultaneidade de processo e thread usando o Visual Studio Ferramentas de Criação de Perfil ferramentas de linha de comando para anexar o criador de perfil a um aplicativo .NET Framework em execução.
