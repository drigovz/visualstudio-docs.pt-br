...
description: Leia as descrições de colunas de dados de criação de perfil na exibição de relatório do functions, que lista os dados de criação de perfil por nome de função.
