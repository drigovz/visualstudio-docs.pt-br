...
description: Saiba como as exibições de arquivos de dados de criação de perfil são exibidas no environmentIDE de desenvolvimento integrado do Visual Studio.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
