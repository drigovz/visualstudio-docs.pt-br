 ...
 **VSPerfReport** `VSPFile` **/Resumo:**`ReportType`[,`ReportType`...] Gera os tipos de relatório especificados.
...
|**Mark**|Marcas de criação de perfil coletadas na execução de criação de perfil.|-   [Exibição de marcas](../profiling/marks-view.md)|
...
|**Processo**|Lista dados de criação de perfil para processos.|-   [Exibição de processos](../profiling/process-view.md)<br />-   [Dados de contenção](../profiling/process-view-contention-data.md)|
|**Thread**|Lista dados de criação de perfil para threads.|-   [Exibição de processos](../profiling/process-view.md)|
