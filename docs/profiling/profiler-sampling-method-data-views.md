...
description: Saiba mais sobre os modos de exibição e relatórios de arquivos de dados do profiler que foram gerados usando o método de amostragem.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
- [Exibição do chamador/receptor-dados de amostragem](../profiling/caller-callee-view-sampling-data.md)
