...
description: Saiba como a exibição de linhas para dados de criação de perfil de alocação de memória do .NET lista as instruções que alocaram a memória durante a execução da criação de perfil.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- Lines view
