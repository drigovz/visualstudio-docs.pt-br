...
description: Consulte informações de referência sobre o método de simultaneidade do Visual Studio Ferramentas de Criação de Perfil, que permite que você colete dados de contenção de recursos.
...
### <a name="profile-aspnet-applications"></a>Criar perfil de aplicativos ASP.NET
