---
title: Definir a sessão atual | Microsoft Docs
description: Saiba como abrir várias sessões de desempenho no Gerenciador de Desempenho e selecione uma das sessões de desempenho visíveis a serem definidas como a sessão atual.
ms.date: 11/04/2016
ms.topic: how-to
helpviewer_keywords:
