...
description: Aprenda a função StopProfile e como ela define o contador como 0 (desativado) para o nível de criação de perfil especificado.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- StopProfile
