...
description: Saiba como a janela de Gerenciador de Desempenho no IDE do Visual Studio permite configurar sessões de desempenho usando o Ferramentas de Criação de Perfil do Visual Studio.
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
