...
description: Use as configurações avançadas no Visualizador de simultaneidade para controlar o conteúdo do rastreamento. Há guias para símbolos, Apenas Meu Código, buffer e muito mais.
