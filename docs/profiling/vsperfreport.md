...
description: Saiba que a ferramenta de linha de comando VSPerfReport é usada para criar relatórios usando o Visual Studio Ferramentas de Criação de Perfil arquivos de dados de criação de perfil.
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
