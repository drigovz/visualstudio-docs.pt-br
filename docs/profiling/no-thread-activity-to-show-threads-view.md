---
title: Nenhuma Atividade de Thread a ser Mostrada (Exibição de Threads) | Microsoft Docs
description: Saiba mais sobre a exibição threads em que não há atividade para mostrar no intervalo de tempo visível no momento.
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
