...
description: Leia sobre a exibição de árvore de chamadas de dados de instrumentação de alocação de memória do .NET no Gerenciador de Desempenho.
