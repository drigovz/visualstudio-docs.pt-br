...
description: No Visualizador de simultaneidade do Visual Studio, entenda o motivo pelo qual uma seção de uma linha do tempo pode estar vazia (tem um plano de fundo branco) para um tipo de canal.
