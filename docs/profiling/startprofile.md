...
description: Saiba mais sobre a função StartProfile e como ela define o contador como 1 (ativado) para o nível de criação de perfil especificado.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- StartProfile
