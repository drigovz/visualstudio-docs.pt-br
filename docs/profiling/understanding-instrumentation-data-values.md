...
[Analisar dados](../profiling/analyzing-performance-tools-data.md) 
 de ferramentas de desempenho [Como: escolher métodos de coleção](../profiling/how-to-choose-collection-methods.md)
