---
title: 'Linha de comando do criador de perfil: Instrument estática ASP.NET app, obter dados de memória'
ms.date: 11/04/2016
ms.topic: conceptual
...
6. {2&gt;Inicie o criador de perfil.&lt;2} Em uma janela de prompt de comando, digite:
