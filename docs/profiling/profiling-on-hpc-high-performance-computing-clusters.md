...
description: Saiba como você pode criar um perfil em nós de computação de clusters HPC do Microsoft Windows usando o método de amostragem do Ferramentas de Criação de Perfil do Visual Studio.
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
