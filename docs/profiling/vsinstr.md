...
|**Path de saída**`:path`|Especifica um diretório de destino para a imagem instrumentada. Se um caminho de saída não for especificado, o binário original será renomeado acrescentando "Orig" ao nome do arquivo no mesmo diretório e uma cópia do binário será instrumentada.|
...
- [Visualizações do relatório de desempenho](../profiling/performance-report-views.md)
