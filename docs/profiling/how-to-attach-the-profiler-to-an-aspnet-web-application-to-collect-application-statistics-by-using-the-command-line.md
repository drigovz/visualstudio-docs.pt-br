---
title: Anexar o criador de perfil no aplicativo web ASP.NET para obter estatísticas de aplicativo
ms.custom: seodec18
ms.date: 11/04/2016
ms.topic: conceptual
...
4. Inicie o criador de perfil. Tipo:**VSPerfCmd** [/start](../profiling/start.md)**:sample** `Options` [/output](../profiling/output.md)**:**`OutputFile`[ ]
...
6. Anexe o criador de perfil ao processo de trabalho do ASP.NET. Tipo:**VSPerfCmd** [/attach](../profiling/attach.md) `ProcName`**:**`Sample Event`{`PID`&#124;} [[[ / /targetclr](../profiling/targetclr.md)**:**`Version`]
