...
|**Rastreamento**|Inicia o monitor de desempenho para criação de perfil instrumentada.|
|**Amostra**|Inicia o monitor de desempenho para criação de perfil de amostragem.|
|**Cobertura**|Inicia o monitor de desempenho para coleta de dados de cobertura de código.|
|**Simultaneidade**|Inicia o monitor de desempenho para criação de perfil de contenção de recursos.|
