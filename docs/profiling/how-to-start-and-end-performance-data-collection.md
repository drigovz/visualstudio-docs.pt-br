---
title: Iniciar e terminar a coleta de dados de desempenho | Microsoft Docs
description: Saiba como você pode adicionar o binário de destino que deseja criar o perfil para a sessão de desempenho antes de iniciar a criação de perfil.
ms.date: 11/04/2016
ms.topic: how-to
f1_keywords:
