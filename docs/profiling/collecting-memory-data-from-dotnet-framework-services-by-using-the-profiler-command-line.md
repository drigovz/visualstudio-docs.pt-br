...
description: Saiba como usar o método de amostragem da linha de comando para coletar dados de alocação de memória e de tempo de vida de objeto para um serviço de .NET Framework.
