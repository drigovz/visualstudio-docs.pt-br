...
1. No **Gerenciador de Desempenho**, clique com o botão direito do mouse na sessão de desempenho, clique em **Propriedades** e, em seguida, clique em **Avançado**.
     ...
     A caixa de listagem **Versão do CLR de Destino** exibe **Automático** e as versões do tempo de execução do .NET Framework que estão instaladas no computador.
