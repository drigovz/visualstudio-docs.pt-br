...
description: Saiba como os aplicativos podem ser compostos de módulos criados com o uso de versões diferentes do .NET Framework tempo de execução.
ms.date: 11/04/2016
ms.topic: how-to
helpviewer_keywords:
