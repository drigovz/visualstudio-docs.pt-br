...
description: Saiba como o método ResumeProfile Decrementa o contador suspender/retomar para o nível de criação de perfil especificado.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- ResumeProfile
