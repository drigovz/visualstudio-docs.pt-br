...
description: Use a ferramenta de banco de dados para registrar as consultas de banco de dados do aplicativo e analisá-las para encontrar maneiras de melhorar o desempenho.
