...
- **Sincronização** O relatório **Sincronização** mostra as chamadas responsáveis por blocos de sincronização, junto com os tempos de bloqueio totais de cada pilha de chamadas. Para obter mais informações, confira [Tempo de sincronização](../profiling/synchronization-time.md).
...
- **Suspensão** O relatório **Suspensão** mostra as chamadas responsáveis por blocos de suspensão, junto com os tempos de bloqueio totais de cada pilha de chamadas. Para saber mais, confira [Tempo de suspensão](../profiling/sleep-time.md).
...
- **Processamento de interface do usuário** O relatório **Processamento de interface do usuário** mostra as chamadas responsáveis por blocos de processamento de interface do usuário, junto com os tempos de bloqueio totais de cada pilha de chamadas. Para saber mais, confira [Tempo de processamento de interface do usuário](../profiling/ui-processing-time.md).
