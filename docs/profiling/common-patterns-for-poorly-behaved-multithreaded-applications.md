...
![Contenção de bloqueio que resulta em execução serializada](../profiling/media/lockcontention_serialized.png "LockContention_Serialized")
...
![Carga de trabalho não uniforme](../profiling/media/unevenworkload_1.png "UnevenWorkLoad_1")
...
![Carga de trabalho não uniforme](../profiling/media/unevenworkload_2.png "UnevenWorkload_2")
