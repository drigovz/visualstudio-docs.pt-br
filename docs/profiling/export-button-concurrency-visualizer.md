---
title: Botão Exportar (Visualização Simultânea) | Microsoft Docs
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
ms.locfileid: "62969895"
---
# <a name="export-button-concurrency-visualizer"></a>Botão Exportar (Visualização Simultânea)
