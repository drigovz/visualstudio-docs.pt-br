...
description: Saiba mais sobre o Managed Extensibility Framework, que permite que você crie seus próprios componentes para estender o editor no SDK do Visual Studio.
