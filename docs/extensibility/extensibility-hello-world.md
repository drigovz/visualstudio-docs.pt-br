...
ms.locfileid: "75404133"
---
# <a name="create-your-first-extension-hello-world"></a>Crie sua primeira extensão: Olá, Mundo
...
Para este exemplo, você usará o C# Visual para adicionar um botão de menu personalizado chamado "Diga Olá, mundo!" Isso se parece com este:
...
Etapa 2. Na caixa de pesquisa no canto superior direito, digite "VSIX" e selecione o C# **projeto VSIX**Visual. Digite "HelloWorld" para o **nome** na parte inferior da caixa de diálogo e selecione **OK**.
...
Etapa 1. No menu **Arquivo**, selecione **Novo** > **Projeto**. Pesquise por "VSIX" e selecione o C# **projeto VSIX** visual e, em seguida, **Avançar**.
...
Etapa 2. Altere o parâmetro `ButtonText` para `Say Hello World!`.
...
Etapa 3. Volte para **Gerenciador de soluções** e localize o arquivo *Command.cs* . No método `Execute`, altere a cadeia de caracteres `message` de `string.Format(..)` para `Hello World!`.
...
Você deve ver a saída do seu novo comando personalizado, neste caso, a caixa de diálogo no centro da tela que fornece a **Olá, mundo!** preferida...".
