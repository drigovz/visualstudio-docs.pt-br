...
|Cadeias de caracteres|Obrigatório. Consulte [elemento Strings](../extensibility/strings-element.md). O `ButtonText` elemento filho deve ser definido.|
