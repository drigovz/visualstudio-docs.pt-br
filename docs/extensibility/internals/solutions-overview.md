...
description: Saiba mais sobre os internos de uma solução para os desenvolvedores de extensão que desejam trabalhar com soluções nas extensões do Visual Studio.
