...
## <a name="command-menu-access"></a>Acesso ao menu de comando
 O caminho de menu [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] ambiente de desenvolvimento integrado a seguir é usado nos casos de teste.
