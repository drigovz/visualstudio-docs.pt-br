...
> [!NOTE]
> O serviço de coloração de sintaxe é separado do mecanismo geral do Visual Studio para colorir o texto. Para obter mais informações sobre o [!INCLUDE[vsipsdk](../../extensibility/includes/vsipsdk_md.md)] mecanismo geral que dá suporte à coloração, consulte [usando fontes e cores](/visualstudio/extensibility/using-fonts-and-colors?view=vs-2015).
