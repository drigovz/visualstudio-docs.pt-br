...
description: Saiba como usar o manifesto da ferramenta de código que usa um arquivo. imagemanifest para uso com o serviço de imagem do Visual Studio.
