...
```
 ...
 Para obter um exemplo, confira [Passo a passo: Salvando as configurações do usuário em uma página Iniciar](../extensibility/walkthrough-saving-user-settings-on-a-start-page.md).
