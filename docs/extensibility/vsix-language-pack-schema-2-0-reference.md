...
description: O esquema do pacote de idiomas do VSIX fornece informações de instalação localizadas para pacotes VSIX. A versão 2,0 dá suporte a elementos de localização adicionais.
