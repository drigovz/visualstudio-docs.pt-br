...
description: Saiba mais sobre a indexação de espaço de trabalho, que é a coleção e o armazenamento persistente de dados para dar suporte a recursos avançados de IDE para um espaço de trabalho de pasta aberta.
