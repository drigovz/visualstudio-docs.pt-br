...
ms.locfileid: "80710492"
---
# <a name="ide-guids"></a>GUIDs do IDE

A <xref:Microsoft.VisualStudio.VSConstants> classe publica GUIDs de algumas partes do ambiente de desenvolvimento integrado (IDE) conforme listado na tabela abaixo.

## <a name="core-systems"></a>Sistemas centrais
...
## <a name="broadly-visible-components"></a>Componentes amplamente visíveis
...
## <a name="ui-contexts"></a>Contextos de Interface do U
...
## <a name="command-sets-and-properties"></a>Conjuntos de comandos e propriedades
...
|Constante|GUID|
|--------------|----------|
|<xref:Microsoft.VisualStudio.VSConstants.IID_IUnknown>|00000000-0000-C000-000000000000046|

## <a name="task-list-guids"></a>GUIDs da lista de tarefas
...
## <a name="component-selector-page-guids"></a>GUIDs da página do seletor de componentes
...
## <a name="miscellaneous-shell-guids"></a>GUIDs de concha sumana

|Constantes|GUID|
|---------------|----------|
|<xref:Microsoft.VisualStudio.VSConstants.CLSID.VsCfgProviderEventsHelper_guid>|99913f1f-1ee3-11d1-8a6e-00c04f682e21|
|<xref:Microsoft.VisualStudio.VSConstants.VsPackageGuid.VsDocOutlinePackage_guid>|21af45b0-ffa5-11d0-b63f-00a0c92e851|
|Microsoft.VisualStudio.VSConstants.SID_SVsToolboxActiveXDataProvider|35222106-bb44-11d0-8c46-00c04fc2aae2|

## <a name="see-also"></a>Confira também

- [Com constantes em código gerenciado](../extensibility/com-constants-in-managed-code.md)
- [Constantes de IDE](../extensibility/ide-constants.md)
- [Comandos definidos pelo IDE para estender as hastes do projeto](../extensibility/internals/ide-defined-commands-for-extending-project-systems.md)
