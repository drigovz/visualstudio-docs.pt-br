...
description: Saiba mais sobre o extensor que fornece dados de contexto de arquivo e indexados para um espaço de trabalho para dar suporte a um cenário de pasta aberta.
