---
title: Elemento botões | Microsoft Docs
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
---
# <a name="buttons-element"></a>Elemento botões
Grupos [Elementos de botão,](../extensibility/button-element.md) que representam comandos individuais.
...
|[Elemento de botão](../extensibility/button-element.md)|Define um comando com o qual o usuário pode interagir.|
