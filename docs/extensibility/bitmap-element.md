...
|Atributo|Descrição|
|---------------|-----------------|
|guid|Obrigatório. GUID do identificador de comando GUID/ID.<br /><br /> O atributo GUID de um bitmap não está associado a nenhum VSPackage ou outro grupo de comandos.  Ele deve ser exclusivo para a definição de bitmap e não deve ser usado para nenhuma outra finalidade.|
