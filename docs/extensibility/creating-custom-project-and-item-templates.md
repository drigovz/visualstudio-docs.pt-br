...
1. Crie um projeto de modelo de projeto. Você pode encontrar o modelo de projeto na **novo projeto** caixa de diálogo, procurando "modelo de projeto" e selecionando o C# ou a versão do Visual Basic.
