...
O Gerenciador de depuração de processos (PDM) é um componente do Visual Studio que gerencia programas e processos, disponibilizando-os para o Gerenciador de depuração de sessão e os mecanismos de depuração.
 ...
 O PDM gerencia todos os processos que podem ser depurados. Para ser depurado, um programa deve ser registrado com o PDM. Esse registro é feito no momento em que o programa é iniciado, seja por uma porta ou um mecanismo de depuração.
