...
description: Saiba mais sobre as interfaces com as quais você deve estar familiarizado ao escrever um avaliador de expressão, juntamente com o contexto de avaliação.
