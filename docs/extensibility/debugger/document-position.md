...
- Fornece uma abstração de uma posição em um arquivo de origem conhecido pelo IDE. Para a maioria dos idiomas hoje, uma posição de documento pode ser considerada como uma posição em um arquivo de origem.
