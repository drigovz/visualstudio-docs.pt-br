...
ms.locfileid: "80715062"
---
# <a name="intercept_exception_action"></a>INTERCEPT_EXCEPTION_ACTION
Especifica quais ações tomar ao interceptar exceções.
...
`IEA_INTERCEPT`\
Permite interceptar a exceção atual. Este é o único valor suportado no momento e deve ser especificado.
