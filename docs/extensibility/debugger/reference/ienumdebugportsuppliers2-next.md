---
title: IEnumDebugPortSuppliers2::Próximo | Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[dentro, fora] Matriz de elementos [IDebugPortSupplier2](../../../extensibility/debugger/reference/idebugportsupplier2.md) a serem preenchidos.
