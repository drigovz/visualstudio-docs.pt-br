...
`pAddress`\
[em] Endereço que representa função.

`dwLine`\
[em] Deslocamento de linha desde o início da função.

`ppNewAddress`\
[fora] Novo endereço que representa deslocamento de linha desde o início da função.
