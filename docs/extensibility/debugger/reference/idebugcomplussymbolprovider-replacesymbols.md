---
title: IDebugComPlusSymbolProvider::Substituir símbolos | Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
- ReplaceSymbols
...
ms.locfileid: "80733607"
---
# <a name="idebugcomplussymbolproviderreplacesymbols"></a>IDebugComPlusSymbolProvider::ReplaceSymbols
Substitui os símbolos de depuração atuais pelos do fluxo de dados especificado.
...
`pStream`\
[em] Fluxo de dados que contém os novos símbolos.
