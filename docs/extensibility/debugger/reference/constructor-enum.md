...
ms.locfileid: "80737619"
---
# <a name="constructor_enum"></a>CONSTRUCTOR_ENUM
Seleciona diferentes tipos de construtores.
...
Passou como um argumento para o método [EnumConstructors.](../../../extensibility/debugger/reference/idebugclassfield-enumconstructors.md)
