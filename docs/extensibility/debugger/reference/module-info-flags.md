...
## <a name="remarks"></a>Comentários
 Esse valor é retornado pelo método [GetSymbolSearchInfo](../../../extensibility/debugger/reference/idebugsymbolsearchevent2-getsymbolsearchinfo.md) .
