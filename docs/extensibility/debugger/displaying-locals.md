...
## <a name="in-this-section"></a>Nesta seção
 [Exemplo de implementação de locals](../../extensibility/debugger/sample-implementation-of-locals.md) usa exemplos para percorrer o processo de implementação de locals.

## <a name="related-sections"></a>Seções relacionadas
 [Contexto de avaliação](../../extensibility/debugger/evaluation-context.md) explica que, quando o mecanismo de depuração (DES) chama o avaliador de expressão (EE), ele passa três argumentos.
