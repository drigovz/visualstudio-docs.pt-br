...
ms.locfileid: "62843872"
---
# <a name="access-stored-font-and-color-settings"></a>Configurações de fonte e cor armazenados do Access

O Visual Studio armazena o ambiente de desenvolvimento integrado (IDE) modificado as configurações de fontes e cores no registro. Você pode usar o <xref:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage> interface para acessar essas configurações.
