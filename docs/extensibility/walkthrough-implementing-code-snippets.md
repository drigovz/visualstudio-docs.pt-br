...
5. Selecione o projeto CompletionTest e, no janela Propriedades definir **gerar arquivo pkgdef** como **verdadeiro**. Salvar o projeto.

6. Adicione uma classe de `SnippetUtilities` estática ao projeto.

     [!code-csharp[VSSDKCompletionTest#22](../extensibility/codesnippet/CSharp/walkthrough-implementing-code-snippets_1.cs)]
     [!code-vb[VSSDKCompletionTest#22](../extensibility/codesnippet/VisualBasic/walkthrough-implementing-code-snippets_1.vb)]

7. Na classe SnippetUtilities, defina um GUID e dê a ele o valor que você usou no arquivo *SnippetsIndex. xml* .

     [!code-csharp[VSSDKCompletionTest#23](../extensibility/codesnippet/CSharp/walkthrough-implementing-code-snippets_2.cs)]
     [!code-vb[VSSDKCompletionTest#23](../extensibility/codesnippet/VisualBasic/walkthrough-implementing-code-snippets_2.vb)]

8. Adicione o <xref:Microsoft.VisualStudio.Shell.ProvideLanguageCodeExpansionAttribute> à classe `TestCompletionHandler`. Esse atributo pode ser adicionado a qualquer classe pública ou interna (não estática) no projeto. (Talvez você precise adicionar uma diretiva de `using` para o namespace Microsoft. VisualStudio. Shell.)
...
## <a name="implement-snippet-expansion-in-the-snippet-picker-ui"></a>Implementar a expansão de trecho na interface do usuário do seletor de trecho
 ...
 Para exibir a interface do usuário do seletor de trecho e para habilitar a aceitação do trecho de navegação e de pós-implantação, use o método <xref:Microsoft.VisualStudio.OLE.Interop.IOleCommandTarget.Exec%2A>. A própria inserção é manipulada pelo método <xref:Microsoft.VisualStudio.TextManager.Interop.IVsExpansionClient.OnItemChosen%2A>.

 A implementação da expansão do trecho de código usa interfaces <xref:Microsoft.VisualStudio.TextManager.Interop> herdadas. Quando você traduz das classes de editor atuais para o código herdado, lembre-se de que as interfaces herdadas usam uma combinação de números de linha e números de coluna para especificar locais em um buffer de texto, mas as classes atuais usam um índice. Portanto, se um buffer tiver três linhas, cada uma delas tem 10 caracteres (mais uma linha nova, que conta como um caractere), o quarto caractere na terceira linha estará na posição 27 na implementação atual, mas está na linha 2, posição 3 na implementação antiga.

#### <a name="to-implement-snippet-expansion"></a>Para implementar a expansão de trecho

1. Para o arquivo que contém a classe `TestCompletionCommandHandler`, adicione as seguintes diretivas `using`.

     [!code-csharp[VSSDKCompletionTest#26](../extensibility/codesnippet/CSharp/walkthrough-implementing-code-snippets_5.cs)]
     [!code-vb[VSSDKCompletionTest#26](../extensibility/codesnippet/VisualBasic/walkthrough-implementing-code-snippets_5.vb)]

2. Faça com que a classe de `TestCompletionCommandHandler` implemente a interface <xref:Microsoft.VisualStudio.TextManager.Interop.IVsExpansionClient>.

     [!code-csharp[VSSDKCompletionTest#27](../extensibility/codesnippet/CSharp/walkthrough-implementing-code-snippets_6.cs)]
     [!code-vb[VSSDKCompletionTest#27](../extensibility/codesnippet/VisualBasic/walkthrough-implementing-code-snippets_6.vb)]

3. Na classe `TestCompletionCommandHandlerProvider`, importe o <xref:Microsoft.VisualStudio.Text.Operations.ITextStructureNavigatorSelectorService>.
