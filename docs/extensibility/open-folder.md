...
description: Saiba mais sobre a extensibilidade para o recurso abrir pasta, que permite aos usuários abrir uma base de código no Visual Studio sem arquivos de projeto ou de solução.
