...
1. Crie um C# projeto VSIX. (Na caixa de diálogo **novo projeto** , **selecione C# Visual/extensibilidade**e, em seguida, **projeto VSIX**.) Nomeie a solução `QuickInfoTest`.
...
4. Declare uma classe que implemente <xref:Microsoft.VisualStudio.Language.Intellisense.IQuickInfoSource>e nomeie-a `TestQuickInfoSource`.

     [!code-vb[VSSDKQuickInfoTest#2](../extensibility/codesnippet/VisualBasic/walkthrough-displaying-quickinfo-tooltips_2.vb)]
     [!code-csharp[VSSDKQuickInfoTest#2](../extensibility/codesnippet/CSharp/walkthrough-displaying-quickinfo-tooltips_2.cs)]

5. Adicione campos para o provedor de origem QuickInfo, o buffer de texto e um conjunto de nomes de método e assinaturas de método. Neste exemplo, os nomes de método e as assinaturas são inicializados no construtor de `TestQuickInfoSource`.
...
8. Você também deve implementar um método Dispose (), já que <xref:Microsoft.VisualStudio.Language.Intellisense.IQuickInfoSource> implementa <xref:System.IDisposable>:
...
1. Declare um provedor de origem QuickInfo chamado `TestQuickInfoSourceProvider` que implementa <xref:Microsoft.VisualStudio.Language.Intellisense.IQuickInfoSourceProvider>e exporte-o com uma <xref:Microsoft.VisualStudio.Utilities.NameAttribute> de "ToolTip QuickInfo Source", um <xref:Microsoft.VisualStudio.Utilities.OrderAttribute> de Before = "default" e um <xref:Microsoft.VisualStudio.Utilities.ContentTypeAttribute> de "text".
...
1. Declare uma classe que implemente <xref:Microsoft.VisualStudio.Language.Intellisense.IIntellisenseController>e nomeie-a `TestQuickInfoController`.
...
5. Implemente o método <xref:Microsoft.VisualStudio.Language.Intellisense.IIntellisenseController.Detach%2A> para que ele remova o manipulador de eventos de foco do mouse quando o controlador for desanexado da exibição de texto.

     [!code-vb[VSSDKQuickInfoTest#14](../extensibility/codesnippet/VisualBasic/walkthrough-displaying-quickinfo-tooltips_14.vb)]
     [!code-csharp[VSSDKQuickInfoTest#14](../extensibility/codesnippet/CSharp/walkthrough-displaying-quickinfo-tooltips_14.cs)]

6. Implemente o método <xref:Microsoft.VisualStudio.Language.Intellisense.IIntellisenseController.ConnectSubjectBuffer%2A> e o método <xref:Microsoft.VisualStudio.Language.Intellisense.IIntellisenseController.DisconnectSubjectBuffer%2A> como métodos vazios para este exemplo.
...
1. Declare uma classe chamada `TestQuickInfoControllerProvider` que implementa <xref:Microsoft.VisualStudio.Language.Intellisense.IIntellisenseControllerProvider>e exporte-a com uma <xref:Microsoft.VisualStudio.Utilities.NameAttribute> de "controlador de QuickInfo de dica de ferramenta" e uma <xref:Microsoft.VisualStudio.Utilities.ContentTypeAttribute> de "texto":
...
3. Implemente o método <xref:Microsoft.VisualStudio.Language.Intellisense.IIntellisenseControllerProvider.TryCreateIntellisenseController%2A> instanciando o controlador QuickInfo.
...
4. Mova o ponteiro sobre uma das ocorrências de "Adicionar". A assinatura e a descrição do método de `add` devem ser exibidas.
