...
|[SccPopulateList](../extensibility/sccpopulatelist-function.md)|Examina a lista de arquivos em busca de seu status atual. Além disso, o usa a função `pfnPopulate` para notificar o chamador quando um arquivo não corresponde aos critérios para o `nCommand`.|
