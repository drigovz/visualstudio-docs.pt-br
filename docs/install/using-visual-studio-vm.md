...
|:------------------------------------------------------------:|:----------------------------:|:-----------------------:|
| Visual Studio 2017: mais recente (versão 15.8)                    |    Enterprise, Community     |      Versão 15.8.7     |
| Visual Studio 2017: versão prévia mais recente (Versão 15.9, versão prévia 5) |    Enterprise, Community     |      Versão 15.9       |
