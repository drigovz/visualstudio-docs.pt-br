...
|:------------------------------------------------------------:|:----------------------------:|:-----------------------:|
| Visual Studio 2017: mais recente (versão 15.8)                    |    Enterprise, Community     |      Versão 15.8.4     |
| Visual Studio 2017: última Versão Prévia (Versão 15.9, Versão Prévia 2) |    Enterprise, Community     |      Versão 15.9       |
