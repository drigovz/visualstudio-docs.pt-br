...
description: Encontre links para perguntas frequentes (FAQs) e respostas sobre a depuração de código nativo no Visual Studio.
...
- [Como posso descobrir quem está passando um valor de parâmetro errado?](../debugger/how-can-i-find-out-who-is-passing-a-wrong-parameter-value-q.md)
...
- [Onde posso pesquisar códigos de erro do Win32?](../debugger/where-can-i-look-up-win32-error-codes-q.md)

- [Como posso manter o foco ao percorrer meu programa?](../debugger/how-can-i-keep-focus-when-stepping-through-my-program-q.md)

- [Como posso usar as janelas do depurador ao depurar um programa em primeiro plano?](../debugger/how-can-i-use-debugger-windows-while-debugging-a-foreground-program-q.md)
