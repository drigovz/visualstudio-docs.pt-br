...
description: Saiba mais sobre a caixa de diálogo Propriedades do thread na ferramenta de depuração Spy + +. Use essa caixa de diálogo para saber mais sobre um thread específico.
