...
**Usar herdado C# e os avaliadores de expressão de VB**: O depurador usará o Visual Studio 2013 C# ou avaliadores de expressão do Visual Basic em vez dos avaliadores de expressão baseada em Roslyn de 2015 do Visual Studio.
