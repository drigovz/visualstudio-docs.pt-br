---
title: Configurações de Propriedade do depurador C#recomendadas para o, VB | Microsoft Docs
ms.custom: seodec18
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
