...
description: Configure seu computador para que você possa executar o processo de trabalho do ASP.NET (aspnet_wp.exe ou w3wp.exe) em uma conta de usuário no Visual Studio.
