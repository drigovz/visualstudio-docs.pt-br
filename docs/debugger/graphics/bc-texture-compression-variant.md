...
description: Use a variante de compactação de textura BC para permitir a compactação de bloco (BC) em texturas com um formato de pixel que seja uma variação de B8G8R8X8, B8G8R8A8 ou R8G8B8A8.
