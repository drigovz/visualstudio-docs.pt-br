...
description: Solucionar problemas de renderização, vendo o histórico de um pixel específico. O histórico de pixels de gráficos mostra os efeitos dos eventos do Direct3D.
