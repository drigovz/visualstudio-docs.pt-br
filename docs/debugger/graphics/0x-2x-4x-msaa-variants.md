...
description: Saiba como substituir as configurações de MSAA (suavização de multiamostragem) em todos os destinos de renderização e cadeias de troca usando as variantes de MSAA 0x, 2x ou 4x.
