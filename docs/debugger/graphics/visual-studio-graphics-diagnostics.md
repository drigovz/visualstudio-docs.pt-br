...
description: O Visual Studio Diagnóstico de Gráficos é um conjunto de ferramentas para registrar em log e analisar a atividade do Direct3D. Use-os para solucionar problemas de desempenho e renderização.
