...
5. Exiba e modifique elementos DOM e estilos CSS em tempo real, conforme descrito em [depurar estilos CSS usando o explorador do dom](/visualstudio/debugger/quickstart-debug-html-and-css).
