...
1. No Visual Studio, abra **Tools**  >  **Opções**ferramentas  >  **Debugging**  >  **símbolos** de depuração (ou símbolos de opções de **depuração**  >  **Options**  >  **Symbols**).
