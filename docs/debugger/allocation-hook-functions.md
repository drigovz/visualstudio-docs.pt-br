...
description: Saiba mais sobre como usar as funções de gancho de alocação, que são instaladas usando _CrtSetAllocHook, quando você precisa fazer a depuração do CRT (tempo de execução em C) no Visual Studio.
