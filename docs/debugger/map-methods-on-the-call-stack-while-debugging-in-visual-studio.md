...
Agora que você tem um mapa, no C# ou Visual Basic, você pode adicionar itens como campos, propriedades e outros métodos para controlar o que está acontecendo no código.
