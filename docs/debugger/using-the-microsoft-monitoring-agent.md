...
#### <a name="blogs"></a>Blogs
 [Introdução ao Microsoft Monitoring Agent](https://devblogs.microsoft.com/devops/introducing-microsoft-monitoring-agent/)
