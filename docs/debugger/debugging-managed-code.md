...
ms.locfileid: "99872658"
---
# <a name="debug-managed-code-c-visual-basic-f-ccli"></a>Depurar código gerenciado (C#, Visual Basic, F #, C++/CLI)

Esta seção aborda problemas comuns de depuração e técnicas para aplicativos gerenciados ou aplicativos escritos em linguagens que visam o Common Language Runtime, como Visual Basic, C# e C++/CLI. As técnicas descritas aqui são técnicas de alto nível. [Primeiro, veja o depurador](../debugger/debugger-feature-tour.md).

## <a name="in-this-section"></a>Nesta seção

[Mensagens de diagnóstico no Janela de Saída](../debugger/diagnostic-messages-in-the-output-window.md)\
...
[Walkthrough: Depurando um Windows Form](../debugger/walkthrough-debugging-a-windows-form.md)\
...
[Depurando o método OnStart](../debugger/how-to-debug-the-onstart-method.md)\
...
[Depuração de aplicativos de serviço do Windows](/dotnet/framework/windows-services/how-to-debug-windows-service-applications)\
