...
description: Consulte atalhos de teclado para depurar aplicativos UWP que usam HTML e JavaScript. Há atalhos para a janela do console do JavaScript e para o explorador do DOM.
