...
description: Saiba como verificar as configurações de Propriedade do IIS que você definiu para um aplicativo Web usando a ferramenta de administração do IIS.
