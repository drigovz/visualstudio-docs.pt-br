...
Para obter mais informações sobre configurações de projeto do C++, consulte [páginas de propriedade (Visual C++)](/cpp/build/reference/property-pages-visual-cpp).
