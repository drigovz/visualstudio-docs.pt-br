...
description: Explore a caixa de diálogo parar depuração em andamento, que aparece quando o depurador tenta interromper uma sessão de depuração, mas parar a sessão levará tempo.
