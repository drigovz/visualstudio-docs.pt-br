...
description: Examine como disparar eventos de suspensão, retomada e segundo plano durante a depuração de aplicativos Plataforma Universal do Windows (UWP) no Visual Studio.
