...
Description: Saiba como configurar para que o depurador Pare as exceções sem tratamento em seu aplicativo ASP.NET. Você pode garantir que a interrupção ocorra em código que não seja do sistema.
