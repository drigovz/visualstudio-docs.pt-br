...
|--------------|---------------|-----------------|
|[IDiaSymbol::get_access](../../debugger/debug-interface-access/idiasymbol-get-access.md)|`DWORD`|Modificador de acesso aplicado a esta classe base. Um dos valores de [Enumeração CV_access_e](../../debugger/debug-interface-access/cv-access-e.md) .|
...
|[IDiaSymbol::get_scoped](../../debugger/debug-interface-access/idiasymbol-get-scoped.md)|`BOOL`|`TRUE` se a classe base aparece em um escopo não global.|
