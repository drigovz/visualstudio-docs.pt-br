...
description: Obtenha informações de referência sobre o tipo de enumeração CV_CPU_TYPE_e, que especifica o processador de destino no SDK de acesso à interface de depuração.
...
ms.locfileid: "97728565"
---
# <a name="cv_cpu_type_e"></a>CV_CPU_TYPE_e
Especifica o processador de destino.

> [!NOTE]
> O processador é identificado no elemento Enumeration após o `CV_CFL_*` prefixo.
