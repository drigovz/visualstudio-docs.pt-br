...
titleSuffix: ''
description: Converta entre os tipos de sistema de projeto do SharePoint e outros tipos de projeto do Visual Studio. Consulte uma lista que detalha os tipos que podem ser convertidos.
