...
## <a name="elements-of-a-sharepoint-project"></a>Elementos de um projeto do SharePoint
 Os nós em um projeto do SharePoint são conhecidos como *itens do SharePoint*. Os itens do SharePoint também podem conter um ou mais subarquivos, conhecidos como *arquivos de item do SharePoint*, como arquivos de [!INCLUDE[TLA2#tla_xml](../sharepoint/includes/tla2sharptla-xml-md.md)] configuração, formulários. aspx e muito mais.
...
## <a name="sharepoint-project-and-project-item-properties"></a>Projeto do SharePoint e propriedades de item do projeto
 Projetos do SharePoint, assim como [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] outros projetos, exibem propriedades no janela Propriedades e na página Propriedades. As propriedades exibidas dependem do nó selecionado.
...
|Cancelar automaticamente após a depuração|Especifica se a solução implantada automaticamente cancela do SharePoint após a execução do aplicativo no modo de [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)]depuração no. Quando selecionada, a solução cancela quando o IDE volta para o modo de exibição de design após a depuração. Quando desmarcada, a solução não é removida. Para obter mais informações, consulte [cancelando uma solução](/previous-versions/office/developer/sharepoint-2010/aa543958(v=office.14)).|
...
|Ferramenta personalizada|Especifica o nome de uma ferramenta, se houver, que transforma o arquivo em tempo de design e coloca a saída da transformação em outro arquivo. Por exemplo, um arquivo de conjunto[!INCLUDE[TLA2#tla_xsd](../sharepoint/includes/tla2sharptla-xsd-md.md)]de um (.) tem uma ferramenta personalizada padrão. Para obter mais informações, consulte [Propriedades do arquivo](/previous-versions/visualstudio/visual-studio-2010/0c6xyb66\(v\=vs.100\)).|
...
|Caminho de implantação|O caminho relativo do arquivo no arquivo do SharePoint Server, como Workflow1\\. O caminho totalmente qualificado para o arquivo é criado concatenando o valor do *caminho de implantação* no final do valor *raiz da implantação* .<br /><br /> A seleção de um valor de *RootFile* para a propriedade do *tipo de implantação* altera a \<propriedade raiz \\da *implantação* para SharePointRoot>, resultando em \<um caminho totalmente\\qualificado de SharePointRoot> \Workflow1. Para obter mais informações, consulte [empacotando e implantando soluções do SharePoint](../sharepoint/packaging-and-deploying-sharepoint-solutions.md).|
...
|Tipo de implantação|O tipo de implantação do arquivo, que determina seu valor de *raiz de implantação* . Pode ser um dos seguintes valores:<br /><br /> NoDeployment: * \<nenhum valor>*<br /><br /> ElementManifest: * \<SharePointRoot> \Template\Features\\\<FeatureName>*\\<br /><br /> Elementofile: * \<SharePointRoot> \Template\Features\\\<do FeatureName>\\*<br /><br /> Modelofile: * \<SharePointRoot> \Template\\*<br /><br /> RootFile: * \<SharePointRoot>\\*<br /><br /> GlobalResource: * \<SharePointRoot> \resources\\*<br /><br /> ClassResource: * \<ClassResourcePath>\\*<br /><br /> Para obter mais informações, consulte <xref:Microsoft.VisualStudio.SharePoint.DeploymentType>.|
...
|Title|Descrição|
|-----------|-----------------|
|[SharePoint Modelos de projeto e de item de projeto](../sharepoint/sharepoint-project-and-project-item-templates.md)|Descreve o projeto do SharePoint e os modelos de item de projeto [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)]disponíveis no.|
...
|[Segurança das soluções do SharePoint](../sharepoint/security-for-sharepoint-solutions.md)|Descreve as considerações de segurança para o desenvolvimento [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)]de soluções do SharePoint no.|
