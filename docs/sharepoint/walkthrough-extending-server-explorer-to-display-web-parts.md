...
2. Na caixa de diálogo **novo projeto** , expanda o nó  **C# Visual** ou **Visual Basic** nó e, em seguida, o nó escolher **Windows** .
...
2. Na caixa de diálogo **novo projeto** , expanda o nó  **C# Visual** ou **Visual Basic** nó e, em seguida, escolha o nó **Windows** .
...
2. No projeto WebPartNodeExtension, abra o arquivo de código SiteNodeExtension e, em seguida, adicione um ponto de interrupção à primeira linha de código no `NodeChildrenRequested` e `CreateWebPartNodes` métodos.
...
4. Verifique se o código na outra instância do [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] é interrompido no ponto de interrupção que você definiu anteriormente no método `NodeChildrenRequested` e, em seguida, escolha **F5** para continuar a depurar o projeto.
