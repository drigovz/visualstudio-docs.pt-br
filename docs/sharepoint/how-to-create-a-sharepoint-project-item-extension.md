...
description: Examine como criar uma extensão de item de projeto quando desejar adicionar funcionalidade a um item de projeto do SharePoint que já está instalado no Visual Studio.
