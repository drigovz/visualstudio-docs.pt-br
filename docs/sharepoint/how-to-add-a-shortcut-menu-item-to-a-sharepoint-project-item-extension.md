...
titleSuffix: ''
description: Adicione um item de menu de atalho a um item de projeto existente do SharePoint usando uma extensão de item de projeto no Visual Studio.
