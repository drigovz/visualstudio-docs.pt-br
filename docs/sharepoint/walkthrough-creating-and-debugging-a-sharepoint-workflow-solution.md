...
- Para saber mais sobre Windows Workflow Foundation atividades, consulte [namespace System. Workflow. Activities](/dotnet/api/system.workflow.activities&view=netframework-4.8).
