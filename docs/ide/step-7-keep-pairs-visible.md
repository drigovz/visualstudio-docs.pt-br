...
description: Saiba como adicionar uma instrução If para que, quando o Player selecionar um par correspondente de ícones, os ícones fiquem visíveis.
