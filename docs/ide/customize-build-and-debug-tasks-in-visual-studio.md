---
title: Personalizar tarefas de depuração de compilação com arquivos JSON
description: Saiba como personalizar tarefas para fornecer alguns detalhes de configuração para executar e depurar uma base de código que o Visual Studio não reconhece.
