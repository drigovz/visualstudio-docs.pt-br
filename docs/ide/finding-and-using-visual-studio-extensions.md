...
- Escolha **Desabilitar esta extensão**. O Visual Studio desabilita a extensão e permite que você saiba se precisa reiniciar o sistema para a desabilitação entrar em vigor. Você pode reabilitar a extensão na caixa de diálogo **extensões**  >  **gerenciar extensões** , se desejar.
