...
Para uma primeira introdução à construção dentro do IDE, consulte [Passo a Passo: Construindo um aplicativo](walkthrough-building-an-application.md).
...
| CMake | - Construir projetos usando a ferramenta CMake<br />- Use o mesmo sistema de compilação em plataformas Linux e Windows. |
...
- [Gerenciar propriedades de projeto e solução.](managing-project-and-solution-properties.md)
...
- [Projetos CMake no Visual Studio](/cpp/build/cmake-projects-in-visual-studio)
