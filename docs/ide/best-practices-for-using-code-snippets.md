...
description: Saiba mais sobre trechos de código, qual é a intenção de um trecho de código e como melhor usá-los para se adequar ao seu aplicativo.
