...
description: Saiba como o Visual Studio permite que você configure seus aplicativos para direcionar diferentes plataformas, incluindo plataformas de 64 bits.
