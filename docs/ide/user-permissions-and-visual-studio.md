...
|Ferramentas de desempenho|Anexação a um aplicativo com privilégios elevados.|[Guia de iniciantes para criação de perfil de desempenho](../profiling/beginners-guide-to-performance-profiling.md)|
