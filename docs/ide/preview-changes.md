...
description: Saiba como usar a janela Visualizar alterações para passar pelas modificações que serão feitas ao seu projeto antes de aceitá-las.
