...
|Reencaixar janela flutuante|**Ctrl** + **clique duas vezes** na barra de título|
...
|Substituição Rápida – Substituir Tudo|**ALT** + **Um**|
...
|Pontos de inserção múltiplos com vários cursores|**Ctrl** + **ALT** + **clique em**|
...
|Menu de navegação contextual|**Pressionando**+**`**|
...
|Modo de comando de janela imediato|Escreva **>**|
