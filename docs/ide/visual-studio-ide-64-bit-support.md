...
[Implantar pré-requisitos para aplicativos de 64 bits](../deployment/deploying-prerequisites-for-64-bit-applications.md) lista redistribuíveis que você pode usar como pré-requisitos para a instalação de um aplicativo de 64 bits.
...
- [Usar arquivos de despejo](../debugger/using-dump-files.md)