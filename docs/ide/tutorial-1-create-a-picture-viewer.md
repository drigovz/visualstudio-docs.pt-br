...
|[Etapa 8: Escrever o código do manipulador de eventos do botão Mostrar uma Imagem](../ide/step-8-write-code-for-the-show-a-picture-button-event-handler.md)|Escreva o código usando a ferramenta IntelliSense.|
...
|[Etapa 11: Execute seu aplicativo e tente outros recursos](../ide/step-11-run-your-program-and-try-other-features.md)|Execute seu aplicativo e defina a cor do plano de fundo. Tente outros recursos, como alterar cores, fontes, e bordas.|
