---
title: Adicionar ou remover namespaces importados (Visual Basic)
description: Saiba como adicionar ou remover namespaces importados e adicionar ou remover importações de usuário.
