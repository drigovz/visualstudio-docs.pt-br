...
description: Saiba como o Visual Studio ajuda você a desenvolver aplicativos usando uma variedade de linguagens de programação.
ms.date: 01/01/2018
layout: LandingPage
author: gewarren
ms.author: gewarren
...
ms.locfileid: "53027270"
---
# <a name="visual-studio-documentation"></a>Documentação do Visual Studio

Saiba como o Visual Studio ajuda você a desenvolver aplicativos usando uma variedade de linguagens de programação.
Tutoriais, vídeos e outras documentações mostram maneiras de criar código e aplicativos usando o Visual Studio.
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Saiba como instalar e configurar o Visual Studio</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Obtenha uma visão geral do Visual Studio</h3>
                        </div>
                    </div>
                </div>
            </div>
...
## <a name="experience-visual-studio-with-5-minute-quickstarts"></a>Experimente o Visual Studio com "Guias de Início Rápido" de 5 minutos
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Obtenha orientações sobre o IDE (ambiente de desenvolvimento integrado)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre projetos e soluções</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Usar o editor de códigos</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Personalizar tema e cores do texto</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar um aplicativo Web com o C#</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar um aplicativo de console com o Visual Basic</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar um aplicativo de console com o C++</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar um aplicativo Web com o Python</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar um aplicativo Web com o Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="go-deeper-with-tutorials"></a>Aprofundar-se com os tutoriais
...
src="https://docs.microsoft.com/media/common/i_debug.svg"><span>Depuração</span></a></div>