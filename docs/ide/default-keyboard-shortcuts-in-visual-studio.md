...
|OtherContextMenus.MicrosoftDataEntityDesignContext.MoveProperties.ToTop|**Alt + página inicial**|
...
|ArchitectureContextMenus.DirectedGraphContextMenu.Advanced.Select.OutgoingDependencies|**Minúscula**|
