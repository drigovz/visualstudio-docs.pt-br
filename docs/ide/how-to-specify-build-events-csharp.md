...
description: Saiba como usar eventos de compilação para especificar comandos que são executados antes do início da compilação ou após a conclusão da compilação.
