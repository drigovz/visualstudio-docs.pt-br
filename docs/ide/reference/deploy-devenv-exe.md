...
As informações de resumo para compilações, incluindo erros, podem ser exibidas na janela **Comando** ou em qualquer arquivo de registro especificado com o switch [/Out.](out-devenv-exe.md)
