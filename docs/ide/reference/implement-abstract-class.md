...
description: Saiba como usar o menu ações rápidas e refatoração para gerar imediatamente o código necessário para implementar uma classe abstrata.
