...
description: Saiba mais sobre o comando Localizar e como ele pesquisa arquivos usando algumas das opções disponíveis na guia localizar nos arquivos da janela Localizar e substituir.
