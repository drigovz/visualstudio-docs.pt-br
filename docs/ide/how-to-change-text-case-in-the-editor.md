...
2. Para converter o texto em todas as letras maiúsculas, escolha **Editar**  >  **avançado**  >  **tornar maiúsculas** ou pressione **Ctrl** + **Shift** + **U**.

   Para converter texto em todas as letras minúsculas, escolha **Editar**  >  **avançado**  >  **tornar minúsculas** ou pressione **Ctrl** + **U**. (Se você tem a carga de trabalho de desenvolvimento do C++ instalada, essa associação de teclas pode ser usada por um comando diferente.)
