...
description: Saiba como configurar manualmente seu projeto C++ para que o IntelliSense funcione corretamente usando o IDE do Visual Studio para ajudá-lo a identificar e corrigir problemas do IntelliSense.
...
Para ver os valores atuais para a compilação de macros, como **VC_IncludePath**, selecione a linha de Diretórios de Inclusão e clique na lista suspensa à direita. Em seguida, escolha **\<Edit>** e clique no botão **macros** .
...
Saiba mais sobre a variável de ambiente TRACEDESIGNTIME em [Roslyn](https://github.com/dotnet/roslyn/blob/master/docs/wiki/Diagnosing-Project-System-Build-Errors.md) e [Common Project System](https://github.com/dotnet/project-system/blob/master/docs/design-time-builds.md). As informações neste artigo são relevantes para projetos do C++.
