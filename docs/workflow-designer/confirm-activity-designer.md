...
description: Saiba como confirmar o designer de atividade e como você pode usar esse designer para criar e configurar uma atividade de confirmação.
