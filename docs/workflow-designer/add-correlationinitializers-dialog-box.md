...
description: Saiba como você pode usar a caixa de diálogo Adicionar inicializadores de correlação para configurar as propriedades de CorrelationInitializers das atividades enviar, receber e SendReply.
