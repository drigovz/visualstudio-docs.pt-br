---
title: Procurar e selecione uma caixa de diálogo de tipo do .NET
description: Saiba como você pode usar a caixa de diálogo Procurar e selecionar um tipo .NET para escolher um tipo de um modo de exibição de árvore de assemblies e projetos no Designer de Fluxo de Trabalho.
