...
|Tarefa|Procedimento|
|----------|---------------|
|Crie uma tabela, aplique um estilo e acesse a tabela no código.|[Como: criar tabelas do Word programaticamente](../vsto/how-to-programmatically-create-word-tables.md)|
|Crie uma tabela, formate-a e insira dados nas células.|[Como: preencher programaticamente tabelas do Word com propriedades do documento](../vsto/how-to-programmatically-populate-word-tables-with-document-properties.md)|
