---
title: 'Como: criar programaticamente um item de email'
ms.date: 02/02/2017
ms.topic: how-to
dev_langs:
- VB
...
ms.locfileid: "85546036"
---
# <a name="how-to-programmatically-create-an-email-item"></a>Como: criar programaticamente um item de email
