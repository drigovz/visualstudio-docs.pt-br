...
description: Saiba como você pode mapear um esquema XML para uma planilha Microsoft Office Excel enquanto a planilha está aberta no Visual Studio.
titleSuffix: ''
