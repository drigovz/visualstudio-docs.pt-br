...
description: Saiba como você pode agrupar programaticamente uma ou mais linhas inteiras no Microsoft Excel usando um controle NamedRange ou um objeto Range do Excel nativo.
