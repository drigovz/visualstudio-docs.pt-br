...
- [Ferramentas do Visual Studio para artigos técnicos do Office e Visual instruções](http://go.microsoft.com/fwlink/?LinkID=106640) contém links para vídeos e artigos técnicos sobre soluções do Office criadas usando o Visual Studio.
