...
6.  Adicione o seguinte código para o `ThisAddIn` classe. Esse código declara as instâncias de `MyUserControl` e <xref:Microsoft.Office.Tools.CustomTaskPane> como membros do `ThisAddIn` classe.  
