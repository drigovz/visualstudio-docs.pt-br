...
- [Como as personalizações funcionam com Microsoft Office aplicativos](#HowCustomizationsWork)
  ...
  Para obter informações gerais sobre como criar personalizações em nível de documento, consulte [visão &#40;geral&#41;do desenvolvimento de soluções do Office VSTO](../vsto/office-solutions-development-overview-vsto.md), introdução [à programação de personalizações em nível de documento para o Word](../vsto/getting-started-programming-document-level-customizations-for-word.md)e [introdução Programando personalizações em nível de documento para o Excel](../vsto/getting-started-programming-document-level-customizations-for-excel.md).
...
## <a name="UnderstandingCustomizations"></a>Entender as personalizações
 ...
 O assembly se comunica com os componentes COM do aplicativo por meio do assembly de interoperabilidade primário do aplicativo. Para obter mais informações, consulte [Office Primary Interop Assemblies](../vsto/office-primary-interop-assemblies.md) e [Office Solutions &#40;Development&#41;Overview](../vsto/office-solutions-development-overview-vsto.md).
...
1. O desenvolvedor cria um projeto de nível de documento [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)]no. O projeto inclui o documento e o assembly que é executado atrás do documento. O documento pode já existir (criado por um designer) ou um novo documento pode ser criado junto com o projeto.
...
### <a name="supported-document-formats-for-document-level-customizations"></a>Formatos de documento com suporte para personalizações em nível de documento
 Ao criar um projeto de personalização, você pode escolher o formato do documento que deseja usar no projeto. Para obter mais informações, confira [Como: Crie projetos do Office no Visual](../vsto/how-to-create-office-projects-in-visual-studio.md)Studio.
...
## <a name="HowCustomizationsWork"></a>Como as personalizações funcionam com Microsoft Office aplicativos
...
6. Se a personalização for confiável para ser executada, [!INCLUDE[vsto_runtime](../vsto/includes/vsto-runtime-md.md)] o usará o manifesto de implantação e o manifesto do aplicativo para verificar se há atualizações de assembly. Se uma nova versão do assembly estiver disponível, o tempo de execução baixará a nova versão do assembly para [!INCLUDE[ndptecclick](../vsto/includes/ndptecclick-md.md)] o cache no computador cliente. Para obter mais informações, consulte [implantar uma solução do Office](../vsto/deploying-an-office-solution.md).
