...
## <a name="targeted-net-framework"></a>.NET Framework de destino
 Quando você atualiza um projeto para Visual Studio 2013, o Visual Studio modifica o projeto para direcionar o [!INCLUDE[net_v45](../vsto/includes/net-v45-md.md)] ou o [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)]. A versão do .NET Framework direcionada ao projeto depende de qual versão do Office está instalada em seu computador. Se [!INCLUDE[Office_15_short](../vsto/includes/office-15-short-md.md)] o estiver instalado, o Visual Studio modificará o projeto para [!INCLUDE[net_v45](../vsto/includes/net-v45-md.md)]direcionar o. Caso contrário, o Visual Studio modificará o projeto para [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)]o destino.
...
## <a name="targeted-office-application"></a>Aplicativo do Office de destino
 ...
 Os projetos do Office no Visual Studio 2013 [!INCLUDE[Office_15_short](../vsto/includes/office-15-short-md.md)] podem [!INCLUDE[office14_long](../vsto/includes/office14-long-md.md)] ter como destino e aplicativos. O Visual Studio modifica o projeto para direcionar a versão mais recente do Office que você instalou. Se nenhuma dessas versões do Office estiver instalada, o Visual Studio não atualizará o projeto.
