...
description: Saiba como você pode excluir programaticamente qualquer planilha em uma pasta de trabalho do Microsoft Excel usando o item de host de planilha, por exemplo.
