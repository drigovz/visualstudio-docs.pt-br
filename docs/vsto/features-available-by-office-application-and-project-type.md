...
description: Saiba como o Visual Studio tem vários tipos de modelos de projeto que dão suporte a diferentes cenários de negócios para Microsoft Office aplicativos.
