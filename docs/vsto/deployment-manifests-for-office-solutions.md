...
# <a name="deployment-manifests-for-office-solutions"></a>Manifestos de implantação para soluções do Office
 ...
 O desenvolvimento do Office no Visual Studio usa o [!INCLUDE[ndptecclick](../vsto/includes/ndptecclick-md.md)] esquema de manifesto de implantação definido na [manifesto de implantação do ClickOnce](/visualstudio/deployment/clickonce-deployment-manifest) referência.  
