...
description: Saiba mais sobre o desenvolvimento do Office no Visual Studio e quais elementos da interface do usuário fazem parte dos projetos do Office.
