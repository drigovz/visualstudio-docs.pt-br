...
### <a name="excel-add-in-programming-model"></a>Modelo de programação de suplemento do Excel
 ...
 Para obter mais informações sobre a classe `ThisAddIn` e outros recursos do Visual Studio que você pode usar em um suplemento do VSTO, consulte [programar suplementos do VSTO](../vsto/programming-vsto-add-ins.md).
