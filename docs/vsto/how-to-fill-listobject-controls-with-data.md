...
2. Adicione colunas de exemplo e dados no `Startup` manipulador `Sheet1` de eventos da classe (em um projeto de nível de documento) `ThisAddIn` ou classe (em um projeto de nível de aplicativo).
