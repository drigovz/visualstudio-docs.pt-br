...
description: Saiba o que você precisa saber para começar a criar personalizações em nível de documento para Microsoft Office Word usando o Visual Studio.
