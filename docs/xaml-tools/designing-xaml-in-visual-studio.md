...
| {1&gt;Tarefa&lt;1} | Visual Studio | Blend for Visual Studio | Mais informações |
| - | - | - | - |
...
- [Visão geral de Blend para Visual Studio](creating-a-ui-by-using-blend-for-visual-studio.md)
