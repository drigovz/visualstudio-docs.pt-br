...
description: Saiba mais sobre atalhos de teclado usando chaves modificadoras em Blend para Visual Studio para modificar ações na prancheta, como zoom, redimensionamento e panorâmica.
...
|Aumentar o zoom no artboard|Mantenha a barra de espaços **Ctrl** pressionada +  enquanto clica em qualquer lugar na prancheta|
|Reduzir o zoom no artboard|Mantenha pressionada a barra de espaços **Ctrl** + **ALT** +  enquanto clica em qualquer lugar na prancheta|
...
|Abra o painel **Ativos**|Pressione o + **ponto** CTRL|
