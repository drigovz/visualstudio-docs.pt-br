...
description: Saiba mais sobre atalhos de teclado na ferramenta Seleção Direta no Blend para Visual Studio que você pode usar para modificar a forma de um caminho existente.
