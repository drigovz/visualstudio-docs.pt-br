---
title: '{1&gt;{2&gt;CA1001: Tipos que possuem campos descartáveis devem ser descartáveis&lt;2}&lt;1}'
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1001
...
ms.locfileid: "75572826"
---
# <a name="ca1001-types-that-own-disposable-fields-should-be-disposable"></a>{1&gt;{2&gt;CA1001: Tipos que possuem campos descartáveis devem ser descartáveis&lt;2}&lt;1}
...
Uma classe declara e implementa um campo de instância que é um tipo de <xref:System.IDisposable?displayProperty=fullName> e a classe não implementa <xref:System.IDisposable>.

## <a name="rule-description"></a>Descrição da regra
Uma classe implementa a interface <xref:System.IDisposable> para descartar os recursos não gerenciados que ele possui. Um campo de instância que é um tipo de <xref:System.IDisposable> indica que o campo possui um recurso não gerenciado. Uma classe que declara um campo <xref:System.IDisposable> é indiretamente proprietário de um recurso não gerenciado e deve implementar a interface <xref:System.IDisposable>. Se a classe não possui diretamente nenhum recurso não gerenciado, ela não deve implementar um finalizador.

Começando com os analisadores do FxCop 3. x, essa regra respeita os tipos que implementam <xref:System.IAsyncDisposable?displayProperty=fullName> como tipos descartáveis. 
