...
ms.locfileid: "72449628"
---
# <a name="c6318"></a>C6318
Aviso C6318: __try/@no__t indefinido mal-Su-0 _except: uso da constante EXCEPTION_CONTINUE_SEARCH ou outra constante que é avaliada como zero na expressão de filtro de exceção. O código no bloco do manipulador de exceção não foi executado
