...
| [CA1504: examinar nomes de campo confusos](../code-quality/ca1504-review-misleading-field-names.md) | O nome de um campo de instância começa com "s_" ou o nome de um campo estático (compartilhado no [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]) começa com "M_". |
