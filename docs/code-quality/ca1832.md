---
title: 'CA1832: usar asspan ou asmemory em vez de indexadores baseados em intervalo para obter a parte ReadOnlySpan ou ReadOnlyMemory de uma matriz'
ms.date: 06/04/2020
ms.topic: reference
f1_keywords:
