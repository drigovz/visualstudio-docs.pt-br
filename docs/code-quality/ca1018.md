...
Para corrigir uma violação dessa regra, especifique os destinos para o atributo usando <xref:System.AttributeUsageAttribute>. Consulte o exemplo a seguir.
