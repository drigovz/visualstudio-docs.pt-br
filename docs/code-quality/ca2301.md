...
Um método de desserialização <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> foi chamado ou referenciado sem a propriedade <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> definida.
