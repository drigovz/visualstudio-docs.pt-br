...
ms.date: 09/01/2020
description: Familiarize-se com a análise de código-fonte no Visual Studio. Saiba mais sobre correções de código e os diferentes tipos de analisadores e níveis de severidade.
