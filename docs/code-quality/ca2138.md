...
Para corrigir uma violação dessa regra, remova o atributo <xref:System.Security.SuppressUnmanagedCodeSecurityAttribute> e marque o método com o <xref:System.Security.SecurityCriticalAttribute> ou o atributo <xref:System.Security.SecuritySafeCriticalAttribute>.
