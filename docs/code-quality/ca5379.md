---
title: 'CA5379: não usar algoritmo de função de derivação de chave fraca'
...
ms.locfileid: "84185535"
---
# <a name="ca5379-do-not-use-weak-key-derivation-function-algorithm"></a>CA5379: não usar algoritmo de função de derivação de chave fraca
