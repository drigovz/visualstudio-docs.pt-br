...
ms.locfileid: "72013463"
---
# <a name="c6262"></a>C6262

C6262 de aviso: A função usa \<constant > bytes de pilha: excede/ANALYZE: stacksize @ no__t-1constant 2 >. Considere mover alguns dados para o heap
...
O código a seguir gera esse aviso porque `char buffer` aloca 16.382 bytes, e a variável de inteiro local `i` aloca outros 4 bytes, que juntos excedem o limite de tamanho de pilha padrão de 16 KB.
