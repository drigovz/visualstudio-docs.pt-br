...
## <a name="see-also"></a>Consulte também
 [/Stack (alocações da pilha)](/cpp/build/reference/stack-stack-allocations) [resetstkoflw](/cpp/c-runtime-library/reference/resetstkoflw) [como: usar verificações de tempo de execução nativas](../debugger/how-to-use-native-run-time-checks.md)