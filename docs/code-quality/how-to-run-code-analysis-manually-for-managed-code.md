...
ms.date: 09/02/2020
description: Saiba como executar manualmente a análise de código no Visual Studio 2019 versão 16,5 ou versões posteriores. Veja como executar analisadores Roslyn em C# ou Visual Basic código.
