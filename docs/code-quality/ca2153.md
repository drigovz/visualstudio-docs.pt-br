...
- Remover o atributo <xref:System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptionsAttribute>. Isso reverte para o comportamento de tempo de execução padrão em que CSEs não são passados para manipuladores catch.
