...
ms.locfileid: "72009006"
---
# <a name="c6200"></a>C6200
Aviso C6200: o índice \<name > está fora do intervalo de índice válido \<min > ao @no__t >-2max para o buffer sem pilha \<variable >
...
## <a name="example"></a>Exemplo
 O código a seguir gera este aviso porque o loop `for` excede o intervalo de índice:
