...
ms.date: 09/06/2018
description: Entenda a diferença entre analisadores de FxCop e FxCop herdados no Visual Studio. Consulte as respostas para perguntas sobre como usar esses analisadores.
...
- [Migrar para os analisadores FxCop](migrate-from-legacy-analysis-to-fxcop-analyzers.md)
