...
ms.locfileid: "72009142"
---
# <a name="c6067"></a>C6067
aviso C6067: o parâmetro \<number > na chamada para \<Function > deve ser o endereço da cadeia de caracteres

 Esse aviso indica uma incompatibilidade entre o especificador de formato e o parâmetro de função. Embora o aviso sugira usar o endereço da cadeia de caracteres, você deve verificar o tipo de parâmetro que uma função espera antes de corrigir o problema. Por exemplo, uma especificação `%s` para `printf` requer um argumento de cadeia de caracteres, mas uma especificação `%s` no `scanf` requer um endereço da cadeia de caracteres.
