...
Suprimir um aviso desta regra somente se o tipo for projetado para ser herdado. A ausência do modificador de `static` sugere que o tipo é útil como um tipo base.
...
O exemplo a seguir mostra como corrigir uma violação dessa regra marcando o tipo com o modificador de `static` C#em:
