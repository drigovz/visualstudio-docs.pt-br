...
- O tipo não é lacrado e o tipo implementa um método <xref:System.Runtime.Serialization.ISerializable.GetObjectData%2A> que não é visível externamente e substituível.
