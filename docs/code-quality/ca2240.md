...
Um tipo visível externamente é atribuível à interface de <xref:System.Runtime.Serialization.ISerializable?displayProperty=fullName> e uma das seguintes condições é verdadeira:
