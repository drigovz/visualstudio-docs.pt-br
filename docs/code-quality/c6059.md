...
ms.locfileid: "72009187"
---
# <a name="c6059"></a>C6059
C6059 de aviso: Parâmetro de comprimento incorreto na chamada para \<function >. Passe o número de caracteres restantes, não o tamanho do buffer de \<variable >
