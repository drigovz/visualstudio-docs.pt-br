---
title: 'CA1831: Usar AsSpan em vez de indexadores baseados em intervalo na cadeia de caracteres quando apropriado'
ms.date: 06/04/2020
ms.topic: reference
f1_keywords:
...
É seguro suprimir uma violação dessa regra se a criação de uma cópia for destinada. Além das [maneiras usuais de suprimir avisos de análise de código](in-source-suppression-overview.md), você também pode adicionar uma conversão explícita para evitar o aviso.
