...
O código a seguir corrige a violação anterior, <xref:System.ValueType.Equals%2A?displayProperty=fullName> substituindo e implementando os operadores de igualdade (= =,! =):
