...
|||
|-|-|
|NomeDoTipo|JsonNetTypeNameHandling|
|CheckId|CA2326|
...
- Um valor de enumeração [Newtonsoft. JSON. TypeNameHandling](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_TypeNameHandling.htm) , diferente `None`de, é referenciado.
