...
[ES.84: Não (tente) declare uma variável local sem nome](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#Res-noname)
...
## <a name="example-ignored-call-result"></a>Exemplo: Ignorado o resultado da chamada
