...
ms.locfileid: "72017322"
---
# <a name="c6400"></a>C6400
C6400 de aviso: Usar o nome de \<function > para executar uma comparação de maiúsculas e minúsculas à cadeia de caracteres constante @no__t nome do 1string >. Produz resultados inesperados em localidades não inglesas
