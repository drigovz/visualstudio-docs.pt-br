...
Para alterar a estrutura de destino de um projeto, consulte [como: destino de uma versão do .net](../ide/how-to-target-a-version-of-the-dotnet-framework.md).
