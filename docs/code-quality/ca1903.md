...
Para alterar a estrutura de destino de um projeto, consulte [How para: Definir uma versão do .NET como destino](../ide/how-to-target-a-version-of-the-dotnet-framework.md).
