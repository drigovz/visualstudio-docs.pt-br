...
[C. 128: As funções virtuais devem especificar exatamente um de virtual, Override ou final](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md)
