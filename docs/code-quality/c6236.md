...
## <a name="example"></a>Exemplo
 Esse código mostra como o aviso C6236 pode aparecer. Como `INPUT_TYPE` não é 0, a expressão `n || INPUT_TYPE` é sempre diferente de zero e a cláusula `else` nunca é executada. No entanto, `INPUT_TYPE` é uma constante com um valor diferente de um, o que sugere que ele é destinado como um valor para comparação:
