...
ms.locfileid: "72015484"
---
# <a name="c26449-no_span_from_temporary"></a>C26449 NO_SPAN_FROM_TEMPORARY

`gsl::span` ou `std::string_view` criado de um temporário será inválido quando o temporário for invalidado.

C++Principais diretrizes: [GSL. View: Exibições @ no__t-0.
