---
title: 'CA5364: Não use protocolos de segurança preteridos'
...
- Um <xref:System.Net.SecurityProtocolType?displayProperty=nameWithType> valor preterido foi referenciado.
- Um valor inteiro que representa um valor preterido foi atribuído <xref:System.Net.SecurityProtocolType> a uma variável.
