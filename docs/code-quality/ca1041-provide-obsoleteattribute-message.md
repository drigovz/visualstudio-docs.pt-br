...
Não suprimir um aviso desta regra porque a propriedade <xref:System.ObsoleteAttribute.Message%2A> fornece informações críticas sobre o tipo ou o membro obsoleto.
