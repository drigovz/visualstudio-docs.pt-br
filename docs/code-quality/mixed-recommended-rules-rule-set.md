...
ms.date: 11/04/2016
description: Saiba mais sobre a regra de regras recomendada mista definida no Visual Studio. Consulte descrições de regras para projetos C++ que dão suporte ao Common Language Runtime.
