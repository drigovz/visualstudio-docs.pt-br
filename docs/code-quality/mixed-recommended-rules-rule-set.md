...
ms.locfileid: "81649333"
---
# <a name="mixed-recommended-rules-rule-set"></a>Conjunto de regras recomendadas misto

As regras recomendadas mistas da Microsoft se concentram nos problemas mais comuns e críticos em seus projetos C++ que suportam o Tempo de Execução do Idioma Comum, incluindo possíveis falhas de segurança, falhas de aplicativos e outros erros importantes de lógica e design. Este conjunto de regras inclui todas as regras do conjunto de [regras mínimas mistas.](mixed-minimum-rules-rule-set.md)
