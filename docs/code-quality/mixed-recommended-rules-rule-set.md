...
|[C28023](../code-quality/c28023.md)|A função que está sendo atribuída ou passada deve ter uma \_ \_ \_ anotação de classe de função para pelo menos uma das classes|
