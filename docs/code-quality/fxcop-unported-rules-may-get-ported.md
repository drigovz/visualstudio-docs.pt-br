---
title: Regras não portadas que podem ser portadas
ms.date: 05/21/2019
ms.topic: reference
helpviewer_keywords:
- fxcop rules
...
ms.locfileid: "89511072"
---
# <a name="unported-rules-that-may-be-ported"></a>Regras não portadas que podem ser portadas
