...
ms.locfileid: "72746282"
---
# <a name="c6331"></a>C6331
aviso C6331: parâmetro inválido: a passagem de MEM_RELEASE e MEM_DECOMMIT em conjunto para \<function > não é permitida. Isso resulta na falha dessa chamada
...
```
 ...
 Para corrigir esse aviso, não transmita o valor de MEM_DECOMMIT para a chamada VirtualFree, conforme mostrado no código a seguir:
