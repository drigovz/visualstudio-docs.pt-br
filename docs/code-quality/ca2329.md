...
Essa regra é acionada quando as duas condições a seguir são verdadeiras para uma instância do [ OnserializadorNewtonsoft.Json.Js](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm) :
