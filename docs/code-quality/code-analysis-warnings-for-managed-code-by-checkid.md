...
| CA1003 | [CA1003: usar instâncias do manipulador de eventos genéricos](../code-quality/ca1003.md) |Um tipo contém um delegado que retorna void, cuja assinatura contém dois parâmetros (o primeiro objeto e o segundo tipo que pode ser atribuído a EventArgs) e o assembly que o contém tem como destino Microsoft .NET Framework 2,0. |
...
| CA1406 |[CA1406: evitar argumentos Int64 para clientes do Visual Basic 6](../code-quality/ca1406.md) | Os clientes COM Visual Basic 6 não podem acessar os inteiros de 64 bits. |
...
| CA1504 | [CA1504: examinar nomes de campo confusos](../code-quality/ca1504.md) | O nome de um campo de instância começa com "s_" ou o nome de um campo estático (compartilhado no Visual Basic) começa com "M_". |
