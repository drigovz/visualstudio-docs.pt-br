...
`LosFormatter`Não é seguro e não pode se tornar seguro. Para obter mais informações, consulte o [Guia de segurança do BinaryFormatter](/dotnet/standard/serialization/binaryformatter-security-guide).
