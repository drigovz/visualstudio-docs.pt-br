...
ms.date: 11/04/2016
description: Saiba mais sobre o conjunto de regras básicas de regras de correção no Visual Studio, que se concentra em erros lógicos e erros comuns da API de estrutura. Consulte descrições de regra.
