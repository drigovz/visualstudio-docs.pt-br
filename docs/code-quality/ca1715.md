...
Você pode configurar quais partes do seu código são analisadas por essa regra. Para obter mais informações, consulte [Configurar analisadores de qualidade de código .net](configure-fxcop-analyzers.md).
