...
> [!NOTE]
> os projetos [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] que usam a estrutura de aplicativo não precisam marcar o método **Main** com STAThread. O compilador [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] faz isso automaticamente.
