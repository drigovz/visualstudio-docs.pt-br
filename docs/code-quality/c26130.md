...
ms.locfileid: "74879159"
---
# <a name="c26130"></a>C26130
aviso C26130: a anotação ausente \_requer bloqueio de\_\_mantido\_(\<Lock >) ou \_no\_\_de thread\_ na função \<Func >. Caso contrário, isso poderia ser uma condição de corrida. A variável \<var > deve ser protegida por bloqueio \<bloqueio >.
