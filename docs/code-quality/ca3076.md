...
- Substitua o argumento <xref:System.Xml.XmlResolver> por uma instância de <xref:System.Xml.XmlSecureResolver> ou nula.
...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>Violação&mdash;função de documento e execução de script não desabilitada
...
### <a name="solutionmdashdisable-document-function-and-script-execution"></a>Solução&mdash;desabilitar a execução de script e a função de documento
