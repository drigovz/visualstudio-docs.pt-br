---
title: 'CA5396: Definir HttpOnly como true para HttpCookie'
...
<xref:System.Web.HttpCookie.HttpOnly?displayProperty=fullName> é definido como `false`. Observe que o valor padrão dessa propriedade é `false` .
