...
ms.date: 11/04/2016
description: Saiba mais sobre o conjunto de regras de regras mínimas nativas no Visual Studio. Veja descrições de regras de segurança, robustez e outros problemas críticos no código nativo.
