...
**C++ Principais diretrizes**: R. 30: Pegar ponteiros inteligentes como parâmetros apenas para expressar semânticas de tempo de vida explicitamente
