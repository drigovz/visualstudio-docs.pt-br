---
title: 'CA3011: Examine o código para vulnerabilidades de injeção de DLL'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
---
# <a name="ca3011-review-code-for-dll-injection-vulnerabilities"></a>CA3011: Examine o código para vulnerabilidades de injeção de DLL
