---
title: 'CA3003: examinar o código para vulnerabilidades de injeção de caminho de arquivo'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809928"
---
# <a name="ca3003-review-code-for-file-path-injection-vulnerabilities"></a>CA3003: examinar o código para vulnerabilidades de injeção de caminho de arquivo
