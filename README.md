...
A documentação do Visual Basic e do Visual C# está localizada em um repositório separado em [http://github.com/dotnet/core-docs](http://github.com/dotnet/core-docs) e a documentação do Visual C++ está localizada no repositório em [http://github.com/MicrosoftDocs/cpp-docs](http://github.com/MicrosoftDocs/cpp-docs).

## <a name="contributing-to-the-documentation"></a>Contribuindo para a documentação

Para contribuir com essa documentação, consulte o [Guia de contribuição](https://github.com/MicrosoftDocs/visualstudio-docs/blob/master/CONTRIBUTING.md).
