...
Bem-vindo! Esse repositório contém arquivos de origem da documentação técnica do Visual Studio. Os tópicos são publicados em [docs.microsoft.com](https://docs.microsoft.com/visualstudio).
