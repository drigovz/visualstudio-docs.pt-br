...
description: Instruções de correção ao ver o erro "Erro ao recuperar informações de atualização". no Visual Studio 2017 para Mac
author: asb3993
ms.author: amburns
ms.date: 04/13/2019
...
- Reinicie o IDE.
- Se você continuar a ver essa mensagem de erro, também é possível tentar atualizar usando o instalador do Visual Studio 2017 para Mac se o **.dmg** ainda estiver no seu computador ou baixe-o em [my.visualstudio.com](https://my.visualstudio.com/Downloads?q=Visual%20Studio%20for%20Mac)
