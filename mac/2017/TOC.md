...
# [Implantação do aplicativo Web](/visualstudio/mac/web-app-deployment)
## [Publicar no Serviço de Aplicativo do Azure](/visualstudio/mac/publish-app-svc)
## [Publicar na pasta](/visualstudio/mac/publish-folder)
