...
Com o projeto aberto no Visual Studio para Mac, clique com o botão direito do mouse na pasta **pacotes** na **painel de soluções** e selecione **adicionar pacotes**:
