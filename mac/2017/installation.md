...
ms.locfileid: "98719910"
---
# <a name="install-visual-studio-2017-for-mac"></a>Instalar o Visual Studio 2017 para Mac

> [!NOTE]
> O Visual Studio 2019 para Mac [já está disponível](installation.md?view=vsmac-2019&preserve-view=true). Para versões mais antigas do Visual Studio para Mac, confira a [página de downloads](https://my.visualstudio.com/Downloads?q=Visual%20Studio%202017%20for%20Mac) do Visual Studio.
