...
- ASP.NET Core aplicativos Web com C#o F#, o e o suporte para páginas Razor, JavaScript e TypeScript
...
Independentemente de se você estiver escrevendo C#, XAML ou JavaScript, o editor de código compartilhará os mesmos componentes principais com o Windows do Visual Studio, com uma interface de usuário totalmente nativa.
...
Para obter mais informações sobre como usar o editor de origem no Visual Studio para Mac, consulte a documentação do [Editor de origem](/visualstudio/mac/source-editor) .
