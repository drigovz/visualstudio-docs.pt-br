...
Há duas opções a serem consideradas ao começar a trabalhar com o Razor no Visual Studio para Mac: Razor Pages no ASP.NET Core e no ASP.NET Core MVC. Para ver tutoriais e obter mais informações sobre essas duas opções, visite os guias a seguir:
