...
1. Na caixa de diálogo **novo projeto** , vá para **.NET Core** > **aplicativo** > **aplicativo Web** e selecione **Avançar**:
...
Esta pasta contém as páginas da Web de um projeto, juntamente com o code-behind para cada uma:
   ...
   - Um arquivo *\*. cshtml.cs* para seu C# código-behind para manipular eventos de página.
