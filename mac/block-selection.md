...
ms.locfileid: "67692859"
---
# <a name="block-selection"></a>Bloquear seleção

O Visual Studio para Mac facilita a tarefa de selecionar, recortar, copiar e colar partes do seu código. Blocos retangulares de código podem ser destacados e selecionados usando o comando **Opção + Arrastar** no bloco de código. A formatação nessa seleção de bloco é mantida ao colar o bloco.
