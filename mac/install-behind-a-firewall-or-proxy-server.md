...
- [Instalar e usar o Visual Studio 2017 e os Serviços do Azure atrás de um firewall ou servidor proxy](https://docs.microsoft.com/visualstudio/install/install-and-use-visual-studio-behind-a-firewall-or-proxy-server)
- [Solução de problemas semelhantes no Windows](https://docs.microsoft.com/visualstudio/install/troubleshooting-network-related-errors-in-visual-studio)