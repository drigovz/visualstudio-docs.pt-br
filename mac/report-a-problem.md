...
Use o link **Dar uma sugestão** na página inicial para ser direcionado para a [página Sugerir um Recurso do Visual Studio para Mac](https://developercommunity.visualstudio.com/content/idea/post.html?space=41). Nela você poderá adicionar novas solicitações ou votar em solicitações existentes.
...
- [Sugerir uma funcionalidade para o Visual Studio](/visualstudio/ide/suggest-a-feature)