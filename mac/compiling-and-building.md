...
No Mac, você pode usar um dos métodos a seguir para compilar seu aplicativo: Visual Studio para Mac, ferramentas de linha de comando do MSBuild ou o Azure Pipelines.
