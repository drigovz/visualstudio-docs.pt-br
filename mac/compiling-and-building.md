...
No Mac, você pode usar qualquer um dos seguintes métodos para construir seu aplicativo: Visual Studio para Mac, ferramentas de linha de comando MSBuild ou Pipelines Azure.
