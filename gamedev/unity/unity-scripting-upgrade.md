...
description: Entenda como usar o .NET 4. x no Unity. Habilite o tempo de execução de script do .NET 4. x. Aproveite a compatibilidade com o .NET. Examine novos recursos de sintaxe e linguagem.
author: therealjohn
ms.author: johmil
ms.date: 08/29/2018
ms.topic: how-to
...
1. Clique no botão **baixar** :
    ...
    ![botão download](media/vs/vstu-nuget-download.png)
...
* [Programação assíncrona no Unity, usando co-rotina e TAP](/archive/blogs/appconsult/unity-coroutine-tap-en-us)
