...
#### <a name="parameters"></a>Parâmetros  
 `ppescc`  
 fora Os contextos de código associados a este contexto de documento.  
...
## <a name="remarks"></a>Comentários  
 Um documento é geralmente associado a apenas um contexto de código, a menos que o documento seja um arquivo de inclusão ou um modelo.  
