...
ms.locfileid: "72572108"
---
# <a name="idebugdocumenttextgetpositionofline"></a>IDebugDocumentText::GetPositionOfLine
Retorna a posição do caractere correspondente ao primeiro caractere de uma linha.  
...
#### <a name="parameters"></a>Parâmetros  
 `cLineNumber`  
 no O número da linha.  
  
 `pcCharacterPosition`  
 fora A posição do caractere dentro do documento do início da linha `cLineNumber`.  
