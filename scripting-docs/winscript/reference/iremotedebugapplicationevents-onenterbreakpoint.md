...
#### <a name="parameters"></a>Parâmetros  
 `prdat`  
 [in] O thread do aplicativo que inseriu o ponto de interrupção.  
...
## <a name="remarks"></a>Comentários  
 Esse método manipula um evento para a inserção de um ponto de interrupção.  
