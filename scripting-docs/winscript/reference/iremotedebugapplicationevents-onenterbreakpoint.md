...
#### <a name="parameters"></a>Parâmetros  
 `prdat`  
 no O thread do aplicativo que inseriu o ponto de interrupção.  
...
## <a name="remarks"></a>Comentários  
 Esse método manipula um evento para inserir um ponto de interrupção.  
