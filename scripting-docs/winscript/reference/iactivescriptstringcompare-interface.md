...
|Método|Descrição|  
|------------|-----------------|  
|[IActiveScriptStringCompare::StrComp](../../winscript/reference/iactivescriptstringcompare-strcomp.md)|Define o método de comparação de cadeia de caracteres para o mecanismo de script.|  
