...
> [!IMPORTANT]
> A criação de uma conta de desenvolvedor do Windows requer o uso de uma conta da Microsoft (MSA).  Não há suporte para o uso de contas de Azure Active Directory.  
