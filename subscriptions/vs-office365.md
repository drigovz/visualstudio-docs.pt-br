---
title: Benefício do Office 365 Pro Plus | Microsoft Docs
author: evanwindom
ms.author: lank
manager: lank
ms.date: 08/02/2019
...
> [!NOTE]
> Sua assinatura do Visual Studio lhe dá direito a usar o Office 365 Pro Plus para uso em produção.  

> [!IMPORTANT]
> Estamos cientes de um problema com a obtenção de chaves de produto para o Office 365 Pro Plus.  Estamos trabalhando no problema e forneceremos uma atualização quando o problema for resolvido. 
...
3. Você verá uma lista de downloads em destaque. Na lista do Office, escolha **office 365 Pro Plus**.
   ...
   > ![downloads do Office 365 Pro Plus](_img/vs-office365/vs-office365-downloads.png)
0. Para instalar o Office 365 Pro Plus, você precisará de uma chave do produto (Product Key).  Clique no link **obter chave** na listagem do Office 365 Pro Plus.
   > [!div class="mx-imgBorder"]
   > ![Office 365 Pro Plus obter chave do produto](_img/vs-office365/vs-office365-get-key.png)
0. Uma janela de submenu mostrará a você quaisquer chaves que você já tiver solicitado, bem como aquelas que estejam disponíveis para você.  Para obter uma nova chave, clique em **Solicitar chave** na listagem **Office Professional Plus 2019**.
   > [!div class="mx-imgBorder"]
   > Chave do produto ![Office 365 Pro Plus Claim](_img/vs-office365/vs-office365-claim-key.png)
...
0. Clique no botão **Download**.
   > [!div class="mx-imgBorder"]
   > ![Office 365 Pro Plus, inicie o download](_img/vs-office365/vs-office365-download-button.png)
...
0. Insira a chave do produto (Product Key), o país ou a região e o idioma e clique em **Avançar**.
   > [!div class="mx-imgBorder"]
   > ![Office 365 Pro Plus, insira a chave do produto](_img/vs-office365/vs-office365-enter-key.png)
...
<sup>1</sup>  *inclui: não para revenda (NFR), parceiro do setor do Visual Studio (VSIP), Microsoft Partner Network (MPN), FTE, MCT software & Developer Services, BizSpark, Most VALUABLE Professional (MVP), diretor regional (RD), MCT software & Services, imagine, Microsoft Partner Network.*
