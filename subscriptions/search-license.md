...
2. Insira os critérios que gostaria de usar como a base da pesquisa e selecione **Filtrar** novamente.
   > [!div class="mx-imgBorder"]
   > ![Use os campos disponíveis para filtrar os dados do assinante](media/filter-subscribers.png "Insira valores nos vários campos para limitar os resultados da pesquisa. Por exemplo, você pode procurar por ' @contoso. com ' para retornar uma lista de todos os assinantes com endereços de email @contoso. com.")
