...
Quando você entra no Azure DevOps com a mesma identidade usada para ativar sua assinatura do Visual Studio ou a com sua[identidade alternativa](vs-alternate-identity.md), isso é reconhecido automaticamente.
...
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (Standard, nuvem mensal)   | VL, Azure, Retail, NFR<sup>1</sup> selecionado, FTE  | Azure Boards e Repos (básico), Azure Test Plans, Azure Artifacts, Azure Pipelines (auto-hospedado)       |  Sim          |
...
- [Azure Boards e Repos (básico)](https://visualstudio.microsoft.com/team-services/compare-features/)
