...
Os clientes que possuem Contratos Corporativos (EA) com a Microsoft são elegíveis para comprar uma nova oferta de assinatura que reúne assinaturas padrão do Visual Studio e GitHub Enterprise. É uma maneira fácil e econômica para os assinantes do Visual Studio adquirirem o GitHub Enterprise. 
...
Se sua organização tiver um EA que ainda não pode ser renovado, você poderá comprar o SKU "Step-up" para adicionar o GitHub Enterprise às assinaturas existentes do Visual Studio Enterprise ou do Visual Studio Professional. Então, quando seu contrato for renovado, você pode comprar a oferta.
...
Para saber mais sobre benefícios https://visualstudio.microsoft.com/subscriptions/visual-studio-githube opções, visite . 
...
| Como gerenciar minha conta de usuário e perfil?       | [Configuração e gerenciamento de sua conta de usuário do GitHub](https://help.github.com/en/categories/setting-up-and-managing-your-github-user-account)    |
| Como gerenciar meu acesso ao GitHub?   | [Autenticação no GitHub](https://help.github.com/en/categories/authenticating-to-github)                           |
...
R: O processo de configuração da assinatura do GitHub pode demorar um pouco.  Se você estiver esperando e nada tiver acontecido, entre em contato com seu administrador do GitHub.  É possível que o administrador ainda esteja trabalhando nisso ou optou por não atribuir uma assinatura do GitHub a você. 

### <a name="q--how-do-i-reach-my-github-administrator"></a>P: Como chego ao administrador do GitHub?
R: Se você estiver usando o GitHub Enterprise Server, clique no link **de suporte** visível na parte inferior do cliente para ser conectado ao administrador.

### <a name="q-do-i-get-the-full-visual-studio-subscription-professional-or-enterprise-or-do-i-just-get-the-ide-with-this-offering"></a>P: Recebo a assinatura completa do Visual Studio (Professional ou Enterprise) ou recebo o IDE com essa oferta?
R: Juntamente com uma assinatura do GitHub Enterprise, você recebe uma assinatura completa do Visual Studio.  Você recebe todos os benefícios, como downloads de software, serviços de nuvem, suporte técnico e benefícios de parceiro incluídos nessas assinaturas, exatamente como aconteceria se a assinatura tivesse sido adquirida separadamente.
