---
title: Visual Studio + GitHub Enterprise oferecem | Microsoft Docs
author: evanwindom
ms.author: lank
manager: lank
...
ms.date: 03/17/2020
ms.topic: conceptual
description: Gerenciamento de assinaturas na oferta Visual Studio + GitHub Enterprise
ms.openlocfilehash: d7100c2b9cfdd12579419927fd0bf8885038048b
ms.sourcegitcommit: f8e3715c64255b476520bfa9267ceaf766bde3b0
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 03/21/2020
ms.locfileid: "79508999"
---
...
Quando sua organização compra assinaturas do Visual Studio com o GitHub Enterprise, a parte visual studio das assinaturas é provisionada imediatamente, e as assinaturas estão disponíveis para atribuição e gerenciamento no portal Visual Studio [Subscriptions Administration.](https://manage.visualstudio.com) 

Para obter mais informações sobre como gerenciar assinaturas, confira estes tópicos:
- [Usando o Portal de Admin](using-admin-portal.md)
...
>
> É responsabilidade do cliente garantir que para cada assinatura do GitHub que é atribuída haja um Visual Studio correspondente com assinatura do GitHub atribuída no portal Visual Studio Subscriptions Administration para permanecer em conformidade com o requisitos de licenciamento para esta assinatura.
...
Uma vez que esse processo é mais complexo, pode levar vários dias após a compra de assinaturas para as organizações e os admins serem totalmente configurados.
