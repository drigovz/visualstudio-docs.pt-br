...
R: No momento, não. Seus clientes podem usufruir dos [preços do Azure para Desenvolvimento/Teste](http://aka.ms/azuredevtestpricing), mas não há nada específico para os CSPs.