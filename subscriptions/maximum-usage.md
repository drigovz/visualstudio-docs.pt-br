...
2. Clique no ícone **de uso máximo** que é o terceiro ícone da parte superior no lado esquerdo da grade de assinantes.  
    > [!div class="mx-imgBorder"]
    > ![Menu Uso Máximo](_img/maximum-usage/maximum-usage-menu.png)
3. O "uso máximo de 12 meses" será exibido, e o número máximo de assinaturas que você atribuiu no último ano para cada nível será exibido, juntamente com o mês em que você atingiu esse pico.    
