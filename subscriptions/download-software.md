...
> ![Página de downloads do assinante](_img/subscriber-downloads/subscriber-downloads-resized.png "Os downloads mais populares são exibidos quando você seleciona a folha downloads.")
...
> [!div class="mx-imgBorder"]
> ![Downloads do Visual Studio 2019](_img/subscriber-downloads/vs2019-product-list.png "Quando você seleciona um produto, uma lista de versões disponíveis é exibida.")

Selecione facilmente sua arquitetura, linguagem e tipo de arquivo usando os menus suspensos disponíveis. Escolha suas opções preferenciais e selecione **baixar** para iniciar o download do produto.
...
A seleção do nome do produto ou do link **informações** exibirá os detalhes desse download e fornecerá acesso às notas de versão do produto.
> [!div class="mx-imgBorder"]
> ![Detalhes de download do Visual Studio 2019](_img/subscriber-downloads/vs2019-info.png "A guia informações exibe informações sobre o download e fornece acesso às notas de versão.")

No painel de detalhes, você também pode selecionar a guia **chaves** para verificar o status das chaves do produto.
> [!div class="mx-imgBorder"]
> ![Chaves do produto (Product Keys) do Visual Studio 2019](_img/subscriber-downloads/vs2019-keys.png "A guia chaves mostra quantas chaves você permaneceu e permite que você solicite as chaves disponíveis.")

### <a name="obtaining-product-keys"></a>Obtendo chaves do produto (Product Keys)
Para obter uma chave de produto para o download, você pode selecionar a tecla azul rotulada **obter chave** ou, se você já estiver exibindo o painel de detalhes, selecione **chave de declaração** na guia **chaves** .
> [!div class="mx-imgBorder"]
