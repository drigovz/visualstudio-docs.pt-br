---
title: Qual software está disponível para download? | Microsoft Docs
author: evanwindom
ms.author: v-evwin
manager: lank
...
2. Entre em sua assinatura. (Saiba mais sobre como entrar no portal com sua [Conta Microsoft](sign-in-msa.md), [conta corporativa ou de estudante](sign-in-work.md) ou com as credenciais do [GitHub](sign-in-github.md).)
...
Para localizar produtos rapidamente, use as funções de "pesquisa" na parte superior da página ou selecione os diferentes tipos de produtos à esquerda.

> [!TIP]
> Se você estiver procurando suas chaves de produto, selecione a guia **chaves de produto** na parte superior da página.
