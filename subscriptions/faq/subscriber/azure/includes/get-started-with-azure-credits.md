...
Para saber como configurar seus créditos Azure, confira a seção \'Etapas de ativação\' do nosso [artigo sobre o crédito Azure](https://docs.microsoft.com/visualstudio/subscriptions/vs-azure).
