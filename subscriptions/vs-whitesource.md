...
ms.locfileid: "76114326"
---
# <a name="whitesource-bolt-in-visual-studio-subscriptions"></a>WhiteSource Bolt em assinaturas do Visual Studio

Encontre e corrija vulnerabilidades de software livre e gere relatórios de licença e inventário abrangentes de todos os componentes de software livre em seu build. As assinaturas do Visual Studio Enterprise recebem seis meses de varreduras ilimitadas.

## <a name="activation-steps"></a>Etapas de ativação

1. Para ativar o benefício do WhiteSource Bolt, faça login em [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs) .
