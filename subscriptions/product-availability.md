---
title: Disponibilidade do produto para downloads em assinaturas do Visual Studio | Microsoft Docs
author: evanwindom
ms.author: v-evwin
manager: cabuschl
...
- **O produto está publicamente disponível.** Algumas ferramentas, SDKs, DDKs e service packs estão disponíveis publicamente no [centro de download da Microsoft](https://www.microsoft.com/download). Alguns desses produtos podem não estar publicados nos Downloads.
...
- **O produto não está disponível em seu país/região.** Alguns produtos da Microsoft não estão disponíveis devido a restrições regionais.
...
O número e os tipos de downloads dependem do seu nível de assinatura e das suas associações ao programa.  Os assinantes com assinaturas padrão do Visual Studio Enterprise, por exemplo, podem ter downloads disponíveis diferentes dos de assinantes que obtêm suas assinaturas por meio de uma assinatura do programa Microsoft Partner Network ou BizSpark.  Para saber mais sobre quais downloads estão disponíveis para cada nível de assinatura, baixe a lista de [Produtos por nível de benefício](https://download.microsoft.com/download/1/5/4/15454442-CF17-47B9-A65D-DF84EF88511B/Visual_Studio_by_Subscription_Level.xlsx).
