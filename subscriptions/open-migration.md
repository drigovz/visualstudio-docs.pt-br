...
Isso se aplica a parceiros que já têm acesso ao [Portal de Administração de Assinaturas do Visual Studio,](https://manage.visualstudio.com)mas fizeram um pedido de Licenças Abertas com assinaturas do Visual Studio que eles precisarão gerenciar.  Etapas para que os parceiros adicionem uma nova licença:
...
Isso se aplica a novos parceiros que fazem novas ordens de Licença Aberta, mas que se registram no [VLSC](https://www.microsoft.com/Licensing/servicecenter/default.aspx) através do fluxo de abertura antes de tentar acessar o [Portal de Administração de Assinaturas](https://manage.visualstudio.com)do Visual Studio . Os parceiros devem seguir estas etapas:
...
Esse cenário se aplica a novos parceiros, que já fizeram novos pedidos de Licença Aberta, mas que não se cadastraram no [VLSC](https://www.microsoft.com/Licensing/servicecenter/default.aspx) e vão diretamente para o [Portal de Administração de Assinaturas do Visual Studio.](https://manage.visualstudio.com)  Siga estas etapas:
...
- Precisa de ajuda? Entre em contato com o [suporte de administração e assinaturas do](https://visualstudio.microsoft.com/support/support-overview-vs) Visual Studio
