...
## <a name="2019-q3-june-august"></a>T3 2019 (junho-agosto)

### <a name="contact-my-admin-available-for-subscribers---august-2019"></a>Recurso "Contatar meu Administrador" disponível para assinantes – agosto de 2019
Muitos assinantes do Visual Studio obtêm suas assinaturas por meio do trabalho ou da escola, e essas assinaturas são atribuídas e gerenciadas por administradores.  Em organizações grandes ou complexas, pode ser difícil para um assinante que precisa da ajuda de um administrador saber quem contatar.  Para auxiliar os assinantes, adicionamos um novo recurso "Contatar meu Administrador" ao portal do assinante em https://my.visualstudio.com/subscriptions. Para obter mais informações, confira o artigo [Contatar o administrador](contact-my-admin.md). 

### <a name="agreement-preferences-available-for-super-admins---august-2019"></a>Preferências de contrato disponíveis para superadministradores – agosto de 2019
Um novo recurso no Portal de Administração de Assinaturas agora permite que os superadministradores definam preferências globais para seus contratos.  Isso permite a definição de preferências, a fim de reduzir a quantidade de trabalho necessária para os administradores ao atribuir assinaturas e fornecer um melhor controle sobre os recursos, por exemplo, indicando se um administrador pode criar uma assinatura para os usuários fora da organização.  Para obter mais informações, confira nosso artigo [Definir preferências de contrato](admin-prefs.md). 
