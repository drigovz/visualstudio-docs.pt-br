...
## [O Que Há de Novo](whats-new-in-subscriptions.md)
## Experiências de assinante
### [Usando o Portal do Assinante](using-the-subscriber-portal.md)
...
#### [Centro de Aplicativos do Visual Studio](vs-visual-studio-app-center.md)
...
#### [Comunidade Azure](vs-azure-community.md)
...
#### [Vídeo sobre integração](https://youtu.be/plSu6fpi7UI)
### [Como usar o Portal de Administração](using-admin-portal.md)
...
#### [Pesquisar uma assinatura](search-license.md)
